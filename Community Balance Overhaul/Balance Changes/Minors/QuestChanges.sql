...
-- Send Unit
UPDATE SmallAwards SET Influence = '25' WHERE Type = 'MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT';
UPDATE SmallAwards SET Gold = '60' WHERE Type = 'MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT';
UPDATE SmallAwards SET RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT';
