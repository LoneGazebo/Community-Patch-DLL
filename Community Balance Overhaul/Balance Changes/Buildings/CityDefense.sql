...
UPDATE Buildings SET Defense = '2000' WHERE Type = 'BUILDING_MILITARY_BASE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
UPDATE Buildings SET Defense = '2000' WHERE Type = 'BUILDING_MINEFIELD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
UPDATE Buildings
SET ExtraCityHitPoints = '200'
WHERE Type = 'BUILDING_MINEFIELD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
