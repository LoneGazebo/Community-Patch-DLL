...
UPDATE Improvement_Yields SET Yield = '6' WHERE YieldType = 'YIELD_GOLD' AND ImprovementType = 'IMPROVEMENT_CUSTOMS_HOUSE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_TERRAIN' AND Value= 1 );
