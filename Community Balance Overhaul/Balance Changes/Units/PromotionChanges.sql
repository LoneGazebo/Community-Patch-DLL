...
-- Siege Promotions -- Weaken them slightly
	...
	DELETE FROM UnitPromotions_UnitCombats
	WHERE UnitCombatType = 'UNITCOMBAT_FIGHTER' AND PromotionType = 'PROMOTION_AIR_AMBUSH_1' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );

	DELETE FROM UnitPromotions_UnitCombats
	WHERE UnitCombatType = 'UNITCOMBAT_FIGHTER' AND PromotionType = 'PROMOTION_AIR_AMBUSH_2' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
DELETE FROM UnitPromotions_PostCombatRandomPromotion WHERE NewPromotion = 'PROMOTION_RECRUITMENT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
DELETE FROM UnitPromotions_PostCombatRandomPromotion WHERE NewPromotion = 'PROMOTION_HEROISM' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
