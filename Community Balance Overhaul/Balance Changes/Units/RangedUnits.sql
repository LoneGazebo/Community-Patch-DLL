...
VALUES
	...
	UPDATE Units SET ObsoleteTech = 'TECH_METALLURGY' WHERE Type = 'UNIT_MAYAN_ATLATLIST' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET ObsoleteTech = 'TECH_RIFLING' WHERE Type = 'UNIT_KOREAN_HWACHA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_DEFENSE' AND UnitType = 'UNIT_AUSTRIAN_HUSSAR';
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_DEFENSE' AND UnitType = 'UNIT_BERBER_CAVALRY';
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_DEFENSE' AND UnitType = 'UNIT_CAVALRY';
	DELETE FROM Unit_Flavors WHERE UnitType = 'UNIT_EGYPTIAN_WARCHARIOT' AND FlavorType = 'FLAVOR_DEFENSE';
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_DEFENSE' AND UnitType = 'UNIT_HELICOPTER_GUNSHIP';
	DELETE FROM Unit_Flavors WHERE UnitType = 'UNIT_INDIAN_WARELEPHANT' AND FlavorType = 'FLAVOR_DEFENSE';
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_DEFENSE' AND UnitType = 'UNIT_SHOSHONE_COMANCHE_RIDERS';
	--ranged
	UPDATE Unit_Flavors SET FlavorType = 'FLAVOR_RANGED' WHERE FlavorType = 'FLAVOR_RECON' AND UnitType = 'UNIT_AMERICAN_MINUTEMAN';
	
	INSERT INTO Unit_Flavors (UnitType, FlavorType, Flavor) VALUES
	('UNIT_ANTI_TANK_GUN', 'FLAVOR_RANGED', 12 ),
	('UNIT_OTTOMAN_JANISSARY', 'FLAVOR_RANGED', 12 );
	
	--DefaultUnitAI fixes
	UPDATE Units SET DefaultUnitAI = 'UNITAI_RANGED' WHERE Type = 'UNIT_MACHINE_GUN' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	UPDATE Units SET DefaultUnitAI = 'UNITAI_RANGED' WHERE Type = 'UNIT_BAZOOKA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
