-- RANGED UNITS
	-- Prereq Techs 
	-- Archers
	UPDATE Units SET PrereqTech = 'TECH_TRAPPING', ObsoleteTech = 'TECH_MATHEMATICS'  WHERE Type = 'UNIT_ARCHER';
	UPDATE Units SET PrereqTech = 'TECH_TRAPPING', ObsoleteTech = 'TECH_MACHINERY' WHERE Type = 'UNIT_INCAN_SLINGER';
	UPDATE Units SET PrereqTech = 'TECH_TRAPPING' WHERE Type = 'UNIT_BARBARIAN_ARCHER';

	UPDATE Units SET PrereqTech = 'TECH_MATHEMATICS', ObsoleteTech = 'TECH_MACHINERY'  WHERE Type = 'UNIT_COMPOSITE_BOWMAN';
	UPDATE Units SET PrereqTech = 'TECH_MATHEMATICS', ObsoleteTech = 'TECH_METALLURGY'  WHERE Type = 'UNIT_MAYAN_ATLATLIST';
	UPDATE Units SET PrereqTech = 'TECH_MATHEMATICS', ObsoleteTech = 'TECH_METALLURGY' WHERE Type = 'UNIT_BABYLONIAN_BOWMAN';

	UPDATE Units SET ObsoleteTech = 'TECH_METALLURGY' WHERE Type = 'UNIT_CROSSBOWMAN';
	UPDATE Units SET PrereqTech = 'TECH_MACHINERY', ObsoleteTech = 'TECH_INDUSTRIALIZATION' WHERE Type = 'UNIT_ENGLISH_LONGBOWMAN';
