...
-- LAND
	...
	UPDATE Units SET PrereqTech = 'TECH_RIFLING' WHERE Type = 'UNIT_DANISH_SKI_INFANTRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET PrereqTech = 'TECH_COMBINED_ARMS' WHERE Type = 'UNIT_BRAZILIAN_PRACINHA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET ObsoleteTech = 'TECH_COMBINED_ARMS' WHERE Type = 'UNIT_DANISH_SKI_INFANTRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_PARATROOPER', 'UNITAI_EXPLORE' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_ClassUpgrades (UnitType, UnitClassType) SELECT 'UNIT_MARINE', 'UNITCLASS_XCOM_SQUAD' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	DELETE FROM Unit_AITypes WHERE UnitType = 'UNIT_MARINE' AND UnitAIType = 'UNITAI_ATTACK' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	DELETE FROM Unit_AITypes WHERE UnitType = 'UNIT_MARINE' AND UnitAIType = 'UNITAI_DEFENSE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_MARINE', 'UNITAI_PARADROP' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_XCOM_SQUAD', 'UNITAI_EXPLORE' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_SPEARMAN' , 'UNITAI_ATTACK' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_SPANISH_TERCIO' , 'UNITAI_ATTACK' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	UPDATE Units SET DefaultUnitAI = 'UNITAI_DEFENSE' WHERE Type = 'UNIT_SPANISH_TERCIO' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	INSERT INTO Unit_AITypes (UnitType, UnitAIType) SELECT 'UNIT_BARBARIAN_SPEARMAN' , 'UNITAI_ATTACK' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_FRENCH_FOREIGNLEGION', 'PROMOTION_FORMATION_1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_DANISH_SKI_INFANTRY' , 'PROMOTION_FORMATION_1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET DefaultUnitAI = 'UNITAI_FAST_ATTACK' WHERE Type = 'UNIT_MECH' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_FRENCH_FOREIGNLEGION', 'PROMOTION_FIELD_WORKS_1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_DANISH_SKI_INFANTRY', 'PROMOTION_FIELD_WORKS_1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_GUERILLA', 'PROMOTION_FIELD_WORKS_3' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 ); -- Mercenaries, Entry in NewUnits.sql
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_BRAZILIAN_PRACINHA', 'PROMOTION_FIELD_WORKS_3' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
