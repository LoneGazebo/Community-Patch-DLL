...
-- Mounted Melee & Armor
-- UNITCLASS_HORSEMAN
("UNIT_HORSEMAN", "FLAVOR_OFFENSE", 5),
("UNIT_HORSEMAN", "FLAVOR_DEFENSE", 1),
...
("UNIT_BARBARIAN_HORSEMAN", "FLAVOR_OFFENSE", 5),
("UNIT_BARBARIAN_HORSEMAN", "FLAVOR_DEFENSE", 1),
...
("UNIT_ARCHER", "FLAVOR_RANGED", 4),

("UNIT_INCAN_SLINGER", "FLAVOR_OFFENSE", 5),
("UNIT_INCAN_SLINGER", "FLAVOR_DEFENSE", 5),
("UNIT_INCAN_SLINGER", "FLAVOR_RANGED", 7),

("UNIT_BARBARIAN_ARCHER", "FLAVOR_OFFENSE", 1),
("UNIT_BARBARIAN_ARCHER", "FLAVOR_DEFENSE", 1),
("UNIT_BARBARIAN_ARCHER", "FLAVOR_RANGED", 4),

-- UNITCLASS_COMPOSITE_BOWMAN
("UNIT_COMPOSITE_BOWMAN", "FLAVOR_OFFENSE", 4),
("UNIT_COMPOSITE_BOWMAN", "FLAVOR_DEFENSE", 4),
("UNIT_COMPOSITE_BOWMAN", "FLAVOR_RANGED", 6),

("UNIT_MAYAN_ATLATLIST", "FLAVOR_OFFENSE", 8),
("UNIT_MAYAN_ATLATLIST", "FLAVOR_DEFENSE", 8),
("UNIT_MAYAN_ATLATLIST", "FLAVOR_RANGED", 9),

("UNIT_BABYLONIAN_BOWMAN", "FLAVOR_OFFENSE", 8),
("UNIT_BABYLONIAN_BOWMAN", "FLAVOR_DEFENSE", 8),
("UNIT_BABYLONIAN_BOWMAN", "FLAVOR_RANGED", 9),

-- UNITCLASS_CROSSBOWMAN
("UNIT_CROSSBOWMAN", "FLAVOR_OFFENSE", 7),
("UNIT_CROSSBOWMAN", "FLAVOR_DEFENSE", 7),
("UNIT_CROSSBOWMAN", "FLAVOR_RANGED", 8),

("UNIT_CHINESE_CHUKONU", "FLAVOR_OFFENSE", 12),
("UNIT_CHINESE_CHUKONU", "FLAVOR_DEFENSE", 12),
("UNIT_CHINESE_CHUKONU", "FLAVOR_RANGED", 11),

("UNIT_ENGLISH_LONGBOWMAN", "FLAVOR_OFFENSE", 12),
("UNIT_ENGLISH_LONGBOWMAN", "FLAVOR_DEFENSE", 12),
("UNIT_ENGLISH_LONGBOWMAN", "FLAVOR_RANGED", 11),

-- UNITCLASS_MUSKETMAN
("UNIT_MUSKETMAN", "FLAVOR_OFFENSE", 11),
("UNIT_MUSKETMAN", "FLAVOR_DEFENSE", 11),
("UNIT_MUSKETMAN", "FLAVOR_RANGED", 10),

("UNIT_OTTOMAN_JANISSARY", "FLAVOR_OFFENSE", 14),
("UNIT_OTTOMAN_JANISSARY", "FLAVOR_DEFENSE", 14),
("UNIT_OTTOMAN_JANISSARY", "FLAVOR_RANGED", 13),

("UNIT_AMERICAN_MINUTEMAN", "FLAVOR_OFFENSE", 14),
("UNIT_AMERICAN_MINUTEMAN", "FLAVOR_DEFENSE", 14),
("UNIT_AMERICAN_MINUTEMAN", "FLAVOR_RANGED", 13),

-- UNITCLASS_GATLINGGUN
("UNIT_GATLINGGUN", "FLAVOR_OFFENSE", 13),
("UNIT_GATLINGGUN", "FLAVOR_DEFENSE", 13),
("UNIT_GATLINGGUN", "FLAVOR_RANGED", 12),

-- UNITCLASS_MACHINE_GUN
("UNIT_MACHINE_GUN", "FLAVOR_OFFENSE", 15),
("UNIT_MACHINE_GUN", "FLAVOR_DEFENSE", 15),
...
("UNIT_EGYPTIAN_WARCHARIOT", "FLAVOR_OFFENSE", 5),
("UNIT_EGYPTIAN_WARCHARIOT", "FLAVOR_DEFENSE", 5),
...
("UNIT_MONGOLIAN_KESHIK", "FLAVOR_OFFENSE", 4),
("UNIT_MONGOLIAN_KESHIK", "FLAVOR_DEFENSE", 4),
...
("UNIT_MOUNTED_BOWMAN", "FLAVOR_OFFENSE", 7),
("UNIT_MOUNTED_BOWMAN", "FLAVOR_DEFENSE", 7),
("UNIT_MOUNTED_BOWMAN", "FLAVOR_RANGED", 6),
("UNIT_MOUNTED_BOWMAN", "FLAVOR_MOBILE", 8),

("UNIT_ARABIAN_CAMELARCHER", "FLAVOR_OFFENSE", 12),
("UNIT_ARABIAN_CAMELARCHER", "FLAVOR_DEFENSE", 12),
("UNIT_ARABIAN_CAMELARCHER", "FLAVOR_RANGED", 9),
("UNIT_ARABIAN_CAMELARCHER", "FLAVOR_MOBILE", 11),

-- UNITCLASS_CUIRASSIER
("UNIT_CUIRASSIER", "FLAVOR_OFFENSE", 11),
("UNIT_CUIRASSIER", "FLAVOR_DEFENSE", 11),
("UNIT_CUIRASSIER", "FLAVOR_RANGED", 8),
("UNIT_CUIRASSIER", "FLAVOR_MOBILE", 10),

("UNIT_AUSTRIAN_HUSSAR", "FLAVOR_OFFENSE", 14),
("UNIT_AUSTRIAN_HUSSAR", "FLAVOR_DEFENSE", 14),
...
-- UNITCLASS_CAVALRY
("UNIT_CAVALRY", "FLAVOR_OFFENSE", 13),
("UNIT_CAVALRY", "FLAVOR_DEFENSE", 13),
("UNIT_CAVALRY", "FLAVOR_RANGED", 10),
("UNIT_CAVALRY", "FLAVOR_MOBILE", 12),

("UNIT_BERBER_CAVALRY", "FLAVOR_OFFENSE", 16),
("UNIT_BERBER_CAVALRY", "FLAVOR_DEFENSE", 16),
("UNIT_BERBER_CAVALRY", "FLAVOR_RANGED", 13),
("UNIT_BERBER_CAVALRY", "FLAVOR_MOBILE", 15),

("UNIT_SHOSHONE_COMANCHE_RIDERS", "FLAVOR_OFFENSE", 16),
("UNIT_SHOSHONE_COMANCHE_RIDERS", "FLAVOR_DEFENSE", 16),
("UNIT_SHOSHONE_COMANCHE_RIDERS", "FLAVOR_RANGED", 13),
("UNIT_SHOSHONE_COMANCHE_RIDERS", "FLAVOR_MOBILE", 15),

("UNIT_RUSSIAN_COSSACK", "FLAVOR_OFFENSE", 16),
("UNIT_RUSSIAN_COSSACK", "FLAVOR_DEFENSE", 16),
("UNIT_RUSSIAN_COSSACK", "FLAVOR_RANGED", 13),
("UNIT_RUSSIAN_COSSACK", "FLAVOR_MOBILE", 15),

-- UNITCLASS_LIGHT_TANK
("UNIT_ANTI_TANK_GUN", "FLAVOR_OFFENSE", 15),
...
-- UNITCLASS_CATAPULT
("UNIT_CATAPULT", "FLAVOR_OFFENSE", 5),
("UNIT_CATAPULT", "FLAVOR_DEFENSE", 3),
("UNIT_CATAPULT", "FLAVOR_RANGED", 6),

("UNIT_ROMAN_BALLISTA", "FLAVOR_OFFENSE", 6), -- minor gift
("UNIT_ROMAN_BALLISTA", "FLAVOR_DEFENSE", 4),
("UNIT_ROMAN_BALLISTA", "FLAVOR_RANGED", 7),
...
-- UNITCLASS_TREBUCHET
("UNIT_TREBUCHET", "FLAVOR_OFFENSE", 8),
("UNIT_TREBUCHET", "FLAVOR_DEFENSE", 6),
("UNIT_TREBUCHET", "FLAVOR_RANGED", 8),

("UNIT_KOREAN_HWACHA", "FLAVOR_OFFENSE", 13),
("UNIT_KOREAN_HWACHA", "FLAVOR_DEFENSE", 11),
("UNIT_KOREAN_HWACHA", "FLAVOR_RANGED", 11),

-- UNITCLASS_CANNON
("UNIT_CANNON", "FLAVOR_OFFENSE", 12),
("UNIT_CANNON", "FLAVOR_DEFENSE", 10),
("UNIT_CANNON", "FLAVOR_RANGED", 10),

-- UNITCLASS_FIELD_GUN
("UNIT_FIELD_GUN", "FLAVOR_OFFENSE", 14),
("UNIT_FIELD_GUN", "FLAVOR_DEFENSE", 12),
("UNIT_FIELD_GUN", "FLAVOR_RANGED", 12),

-- UNITCLASS_ARTILLERY
("UNIT_ARTILLERY", "FLAVOR_OFFENSE", 16),
("UNIT_ARTILLERY", "FLAVOR_DEFENSE", 14),
...
("UNIT_BANDEIRANTES", "FLAVOR_OFFENSE", 11),
("UNIT_BANDEIRANTES", "FLAVOR_DEFENSE", 5),
("UNIT_BANDEIRANTES", "FLAVOR_TILE_IMPROVEMENT", 15), -- has tile improvement
...
-- UNITCLASS_FRIGATE
("UNIT_FRIGATE", "FLAVOR_NAVAL", 20),
("UNIT_FRIGATE", "FLAVOR_NAVAL_RECON", 14),

("UNIT_ENGLISH_SHIPOFTHELINE", "FLAVOR_NAVAL", 26),
("UNIT_ENGLISH_SHIPOFTHELINE", "FLAVOR_NAVAL_RECON", 19),

-- UNITCLASS_CRUISER
("UNIT_CRUISER", "FLAVOR_NAVAL", 24),
("UNIT_CRUISER", "FLAVOR_NAVAL_RECON", 18),

-- UNITCLASS_BATTLESHIP
("UNIT_BATTLESHIP", "FLAVOR_NAVAL", 30),
("UNIT_BATTLESHIP", "FLAVOR_NAVAL_RECON", 20),
