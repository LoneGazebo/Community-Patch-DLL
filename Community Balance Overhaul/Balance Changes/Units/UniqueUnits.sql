...
INSERT INTO UnitClasses (Type, Description, DefaultUnit) SELECT 'UNITCLASS_SKIINFANTRY', 'TXT_KEY_UNIT_DANISH_SKI_INFANTRY', 'UNIT_DANISH_SKI_INFANTRY' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
UPDATE Units SET Class = 'UNITCLASS_SKIINFANTRY' WHERE Type = 'UNIT_DANISH_SKI_INFANTRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
UPDATE Unit_FreePromotions SET PromotionType = 'PROMOTION_MOBILITY' WHERE UnitType = 'UNIT_GERMAN_PANZER';
