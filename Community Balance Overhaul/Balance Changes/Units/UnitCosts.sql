...
-- Industrial
	...
	UPDATE Units SET Cost = '600', FaithCost = '600' WHERE Type = 'UNIT_ETHIOPIAN_MEHAL_SEFARI';
	...
	UPDATE Units SET Cost = '800', FaithCost = '600' WHERE Type = 'UNIT_SHOSHONE_COMANCHE_RIDERS';
...
-- Information
	...
	UPDATE Units SET Cost = '7000' WHERE Type = 'UNIT_NUCLEAR_MISSILE';
