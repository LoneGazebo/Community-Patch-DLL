...
-- fixed Ranged Support Fire
	UPDATE Language_en_US
	SET Text = 'Makes a free [COLOR_POSITIVE_TEXT]Ranged Attack[ENDCOLOR] at half [ICON_STRENGTH] Combat Strength before attacking [COLOR_POSITIVE_TEXT]Units[ENDCOLOR]. [COLOR_NEGATIVE_TEXT]Cannot Fortify.[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]Lost on Upgrade.[ENDCOLOR]'
