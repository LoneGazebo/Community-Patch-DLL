...
-- fixed Ranged Support Fire
	UPDATE Language_en_US
	SET Text = 'Makes a free [COLOR_POSITIVE_TEXT]Ranged Strike[ENDCOLOR] at half [ICON_STRENGTH] Combat Strength before attacking [COLOR_POSITIVE_TEXT]Units[ENDCOLOR]. [COLOR_NEGATIVE_TEXT]Cannot Fortify.[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]Lost on Upgrade.[ENDCOLOR]'
	WHERE Tag = 'TXT_KEY_PROMOTION_RANGED_SUPPORT_FIRE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );;

-- fixed spear throw
	UPDATE Language_en_US
	SET Text = '+25% [ICON_STRENGTH] Combat Strength VS [COLOR_POSITIVE_TEXT]Gunpowder Units[ENDCOLOR].[NEWLINE]Makes a free [COLOR_POSITIVE_TEXT]Ranged Strike[ENDCOLOR] at half [ICON_STRENGTH] Combat Strength before attacking [COLOR_POSITIVE_TEXT]Units[ENDCOLOR]. [COLOR_NEGATIVE_TEXT]Cannot Fortify.[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]Lost on upgrade.[ENDCOLOR]'
