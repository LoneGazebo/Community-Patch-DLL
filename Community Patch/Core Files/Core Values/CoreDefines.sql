...
-- Used by the AI to determine when they're not making progress in war and they should stop fighting.
...
INSERT INTO Defines (Name, Value) SELECT 'WAR_PROGRESS_PER_UNHAPPY', '-2';
