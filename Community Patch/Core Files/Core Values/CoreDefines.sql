...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_SPY_SABOTAGE_RATE', '10' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );
...
-- Peace Desire
UPDATE Defines SET Value = '40' WHERE Name = 'REQUEST_PEACE_TURN_THRESHOLD';
