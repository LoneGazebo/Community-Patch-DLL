...
-- Military Threat
UPDATE Defines SET Value = '300' WHERE Name = 'MILITARY_THREAT_CRITICAL_THRESHOLD';
UPDATE Defines SET Value = '200' WHERE Name = 'MILITARY_THREAT_SEVERE_THRESHOLD';
UPDATE Defines SET Value = '125' WHERE Name = 'MILITARY_THREAT_MAJOR_THRESHOLD';
UPDATE Defines SET Value = '33' WHERE Name = 'MILITARY_STRENGTH_CITY_MOD';
UPDATE Defines SET Value = '100' WHERE Name = 'MILITARY_THREAT_PER_MINOR_CONQUERED';
UPDATE Defines SET Value = '200' WHERE Name = 'MILITARY_THREAT_PER_MAJOR_CONQUERED';
UPDATE Defines SET Value = '150' WHERE Name = 'MILITARY_THREAT_NEIGHBORS';
UPDATE Defines SET Value = '100' WHERE Name = 'MILITARY_THREAT_CLOSE';
UPDATE Defines SET Value = '50' WHERE Name = 'MILITARY_THREAT_FAR';
UPDATE Defines SET Value = '25' WHERE Name = 'MILITARY_THREAT_DISTANT';
UPDATE Defines SET Value = '50' WHERE Name = 'MILITARY_THREAT_WAR_STATE_OFFENSIVE';
UPDATE Defines SET Value = '100' WHERE Name = 'MILITARY_THREAT_WAR_STATE_CALM';
UPDATE Defines SET Value = '130' WHERE Name = 'MILITARY_THREAT_WAR_STATE_STALEMATE';
UPDATE Defines SET Value = '180' WHERE Name = 'MILITARY_THREAT_WAR_STATE_DEFENSIVE';
