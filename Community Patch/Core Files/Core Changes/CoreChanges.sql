...
UPDATE TacticalMoves
SET Priority = '23'
WHERE Type = 'TACTICAL_AIR_INTERCEPT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- this is only for remaining idle air units after attacks and interceptors
UPDATE TacticalMoves
SET Priority = '21'
WHERE Type = 'TACTICAL_AIR_SWEEP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
