...
UPDATE Defines
SET Value = '10'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_THEM_MINOR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 
UPDATE Defines
SET Value = '30'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_THEM_MAJOR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 
UPDATE Defines
SET Value = '50'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_THEM_SERIOUS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 
UPDATE Defines
SET Value = '70'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_THEM_CRIPPLED' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 

UPDATE Defines
SET Value = '0'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_THEM_NONE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 

UPDATE Defines
SET Value = '-10'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_US_MINOR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 

UPDATE Defines
SET Value = '-30'
WHERE Name = 'WAR_PROJECTION_WAR_DAMAGE_US_MAJOR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 
