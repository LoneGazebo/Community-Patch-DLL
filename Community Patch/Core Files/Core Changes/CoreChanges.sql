...
UPDATE Defines
SET Value = '2'
WHERE Name = 'MINOR_CIV_DISPUTE_FRIENDS_WEIGHT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- 10
UPDATE Defines
SET Value = '5'
WHERE Name = 'MINOR_CIV_DISPUTE_ALLIES_WEIGHT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
