...
UPDATE Defines
SET Value = '150' 
WHERE Name = 'LAND_DISPUTE_CRAMPED_MULTIPLIER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

-- Expansion

UPDATE Defines
SET Value = '0'
WHERE Name = 'LAND_DISPUTE_EXP_AGGRESSIVE_POSTURE_NONE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '10'
WHERE Name = 'LAND_DISPUTE_EXP_AGGRESSIVE_POSTURE_LOW' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '20'
WHERE Name = 'LAND_DISPUTE_EXP_AGGRESSIVE_POSTURE_MEDIUM' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '30'
WHERE Name = 'LAND_DISPUTE_EXP_AGGRESSIVE_POSTURE_HIGH' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '40'
WHERE Name = 'LAND_DISPUTE_EXP_AGGRESSIVE_POSTURE_INCREDIBLE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '8'
WHERE Name = 'LAND_DISPUTE_FIERCE_THRESHOLD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '4'
WHERE Name = 'LAND_DISPUTE_STRONG_THRESHOLD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '1'
WHERE Name = 'LAND_DISPUTE_WEAK_THRESHOLD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

-- Military Threat
UPDATE Defines
SET Value = '25'
WHERE Name = 'MILITARY_THREAT_PER_MINOR_ATTACKED' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '50'
WHERE Name = 'MILITARY_THREAT_PER_MINOR_CONQUERED' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '25'
WHERE Name = 'MILITARY_THREAT_PER_MAJOR_CONQUERED' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '50'
WHERE Name = 'MILITARY_THREAT_PER_MAJOR_ATTACKED' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '15'
WHERE Name = 'MILITARY_STRENGTH_CITY_MOD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '60'
WHERE Name = 'MILITARY_THREAT_NEIGHBORS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '20'
WHERE Name = 'MILITARY_THREAT_FAR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '0'
WHERE Name = 'MILITARY_THREAT_DISTANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_SETTLER_TWEAKS' AND Value= 1 );
...
UPDATE TacticalMoves
SET Priority = '125'
WHERE Type = 'TACTICAL_CAPTURE_CITY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE TacticalMoves
SET Priority = '2'
WHERE Type = 'TACTICAL_BASTION_2_TURN' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE Defines
Set Value = '20'
WHERE Name = 'TURNS_SINCE_PEACE_WEIGHT_DAMPENER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE Defines
SET Value = '20'
WHERE Name = 'OPINION_WEIGHT_VICTORY_WEAK' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- -6
UPDATE Defines
SET Value = '0'
WHERE Name = 'OPINION_WEIGHT_VICTORY_NONE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE Defines
SET Value = '18'
WHERE Name = 'OPINION_WEIGHT_DENOUNCED_FRIEND' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- -15
UPDATE Defines
SET Value = '-18'
WHERE Name = 'OPINION_WEIGHT_DENOUNCED_ENEMY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE Defines
SET Value = '10'
WHERE Name = 'OPINION_WEIGHT_MADE_DEMAND_OF_US' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- -20
UPDATE Defines
SET Value = '-10'
WHERE Name = 'OPINION_WEIGHT_RETURNED_CIVILIAN' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE Defines
SET Value = '20'
WHERE Name = 'OPINION_WEIGHT_BROKEN_MILITARY_PROMISE_WORLD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- 0
UPDATE Defines
SET Value = '20'
WHERE Name = 'OPINION_WEIGHT_BROKEN_CITY_STATE_PROMISE_WORLD' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
