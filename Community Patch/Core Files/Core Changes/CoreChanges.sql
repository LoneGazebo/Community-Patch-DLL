...
UPDATE Defines
SET Value = '6'
WHERE Name = 'AI_OPERATIONAL_CITY_ATTACK_DEPLOY_RANGE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_CITYSTRATEGY_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '4'
WHERE Name = 'AI_OPERATIONAL_BARBARIAN_CAMP_DEPLOY_RANGE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_CITYSTRATEGY_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '6'
WHERE Name = 'AI_OPERATIONAL_PILLAGE_ENEMY_DEPLOY_RANGE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_CITYSTRATEGY_TWEAKS' AND Value= 1 );

UPDATE Defines
SET Value = '6'
WHERE Name = 'AI_OPERATIONAL_NAVAL_BOMBARDMENT_DEPLOY_RANGE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_CITYSTRATEGY_TWEAKS' AND Value= 1 );
