...
-- don't need this, it's included in offensive posture moves
UPDATE TacticalMoves
SET Priority = '-1'
...
UPDATE TacticalMoves
SET Priority = '-1'
WHERE Type = 'TACTICAL_DESTROY_HIGH_UNIT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- don't need this, it's included in offensive posture moves
UPDATE TacticalMoves
SET Priority = '-1'
WHERE Type = 'TACTICAL_DESTROY_MEDIUM_UNIT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- don't need this, it's included in offensive posture moves
UPDATE TacticalMoves
SET Priority = '-1'
WHERE Type = 'TACTICAL_DESTROY_LOW_UNIT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
UPDATE TacticalMoves
SET Priority = '-1'
WHERE Type = 'TACTICAL_ATTRIT_LOW_UNIT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
