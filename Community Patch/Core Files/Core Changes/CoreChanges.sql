...
UPDATE Defines
SET Value = '90'
WHERE Name = 'APPROACH_WAR_PROJECTION_STALEMATE_PERCENT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );

-- 100
UPDATE Defines
SET Value = '115'
WHERE Name = 'APPROACH_WAR_PROJECTION_UNKNOWN_PERCENT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_MILITARY_TWEAKS' AND Value= 1 );
...
SET RequiresNavalUnitConsistency = 'true'
WHERE Type = 'MUFORMATION_COLONIZATION_PARTY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );
...
UPDATE Defines
SET Value = '90'
WHERE Name = 'OPINION_THRESHOLD_UNFORGIVABLE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );

UPDATE Defines
SET Value = '60'
WHERE Name = 'OPINION_THRESHOLD_ENEMY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );

UPDATE Defines
SET Value = '30'
WHERE Name = 'OPINION_THRESHOLD_COMPETITOR' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );

UPDATE Defines
SET Value = '-30'
WHERE Name = 'OPINION_THRESHOLD_FAVORABLE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );

UPDATE Defines
SET Value = '-60'
WHERE Name = 'OPINION_THRESHOLD_FRIEND' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 );

UPDATE Defines
SET Value = '-90'
WHERE Name = 'OPINION_THRESHOLD_ALLY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE' AND Value= 1 ); 
