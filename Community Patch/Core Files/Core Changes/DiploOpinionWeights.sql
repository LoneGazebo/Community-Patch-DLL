...
UPDATE Defines SET Value = '20' WHERE Name = 'OPINION_WEIGHT_WONDER_FIERCE';
UPDATE Defines SET Value = '15' WHERE Name = 'OPINION_WEIGHT_WONDER_STRONG';
...
-- We have a Diplomat in their capital. (no bonus for capitulated vassals)
...
UPDATE Defines SET Value = '18' WHERE Name = 'OPINION_WEIGHT_DENOUNCED_FRIEND';

-- We have Denounced the same leaders!
UPDATE Defines SET Value = '-18' WHERE Name = 'OPINION_WEIGHT_DENOUNCED_ENEMY';
...
INSERT INTO Defines (Name, Value) SELECT 'OPINION_WEIGHT_PTP_SAME_MINOR_EACH', '-3'; -- opinion bonus per mutual PtP (note: diplomat AIs double the amount of PtPs if you aren't a "City-State troublemaker" to them)
...
UPDATE Defines SET Value = '10' WHERE Name = 'OPINION_WEIGHT_KILLED_MANY_PROTECTED_MINORS'; -- killed more than one
...
UPDATE Defines SET Value = '-18' WHERE Name = 'OPINION_WEIGHT_DOF_WITH_FRIEND';

-- You have made a Declaration of Friendship with one of their enemies!
UPDATE Defines SET Value = '18' WHERE Name = 'OPINION_WEIGHT_DOF_WITH_ENEMY';
...
-- They have opened our borders to us. (no bonus for capitulated vassals)
