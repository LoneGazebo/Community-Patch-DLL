...
INSERT INTO Defines (Name, Value) SELECT 'APPROACH_WAR_PROXIMITY_NEIGHBORS_EARLY_GAME', '300';
INSERT INTO Defines (Name, Value) SELECT 'APPROACH_WAR_PROXIMITY_CLOSE_EARLY_GAME', '225';
