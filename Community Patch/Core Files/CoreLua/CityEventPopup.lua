...
function OnPopup( popupInfo )
	...
	player:AddNotification(NotificationTypes.NOTIFICATION_GENERIC, szHelpString, "[COLOR_POSITIVE_TEXT]City Event[ENDCOLOR]: " .. szTitleString, city:Plot():GetX(), city:Plot():GetY())
