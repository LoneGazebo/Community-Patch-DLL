...
Usage:
    ...
    - Copy "ExportCivilopedia" to your mods folder and start a game with VP and the Export Civilopedia mod loaded
    - When clicking on "Begin your journey", the game data are written to the lua log.
    - in [git-repo]/ExportCivilopedia/ run "python extract_from_log.py", which will create a json file with the game data
...
# Output folder
OUTPUT_FOLDER = "civilopedia_html"
            ...
            <div class="pediapage-content" id="itemContent">
                ...
                {% for group_name, group_items in grouped_items %}
                    ...
                    <div class="article-detail" id="item-{{ item.Type }}" style="display: none;">
                        <section class="welcome">
                            <h2>{{ (item.Name if item.Name else item.Description) | civ5format | safe }}</h2>
                            {% if item.Help %}
                            <div class="summary">
...
def generate_html(json_file, output_dir):
...
if __name__ == '__main__':
    ...
    generate_html(json_file, output_dir)
