...
VALUES
	('BELIEF_CEREMONIAL_BURIAL', 'YIELD_FAITH', 25),
	('BELIEF_CEREMONIAL_BURIAL', 'YIELD_CULTURE', 50);
...
INSERT INTO Belief_YieldFromSpread
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_PILGRIMAGE', 'YIELD_GOLDEN_AGE_POINTS', 25);

INSERT INTO Belief_YieldFromForeignSpread
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_TITHE', 'YIELD_TOURISM', 50);

INSERT INTO Belief_YieldFromConquest
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_INTERFAITH_DIALOGUE', 'YIELD_GOLDEN_AGE_POINTS', 30),
	('BELIEF_INTERFAITH_DIALOGUE', 'YIELD_FAITH', 30);

INSERT INTO Belief_YieldFromPolicyUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_CHURCH_PROPERTY', 'YIELD_FAITH', 50),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_SCIENCE', 50),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_GOLD', 50);

INSERT INTO Belief_YieldFromEraUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_INITIATION_RITES', 'YIELD_FAITH', 300),
	('BELIEF_INITIATION_RITES', 'YIELD_SCIENCE', 300),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLD', 300),
	('BELIEF_INITIATION_RITES', 'YIELD_CULTURE', 300),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLDEN_AGE_POINTS', 300);

INSERT INTO Belief_YieldFromConversion
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_PAPAL_PRIMACY', 'YIELD_SCIENCE', 40);

INSERT INTO Belief_YieldFromWLTKD
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_WORLD_CHURCH', 'YIELD_FAITH', 15),
	('BELIEF_WORLD_CHURCH', 'YIELD_SCIENCE', 15),
