...
VALUES
	...
	('IMPROVEMENT_FEITORIA', 'YIELD_GOLD', 2),
...
UPDATE Improvement_Yields SET Yield = '5' WHERE YieldType = 'YIELD_PRODUCTION' AND ImprovementType = 'IMPROVEMENT_MANUFACTORY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_TERRAIN' AND Value= 1 );
