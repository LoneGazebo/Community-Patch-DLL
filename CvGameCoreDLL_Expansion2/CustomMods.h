...
#define MOD_BALANCE_CORE_SETTLER_MOVE				(MOD_COMMUNITY_PATCH && gCustomMods.isMOD_BALANCE_CORE_SETTLER_MOVE())
#define MOD_BALANCE_CORE_RESOURCE_FLAVORS			(MOD_COMMUNITY_PATCH && gCustomMods.isMOD_BALANCE_CORE_RESOURCE_FLAVORS())
#define MOD_BALANCE_CORE_PURCHASE_COST_INCREASE		(MOD_COMMUNITY_PATCH && gCustomMods.isMOD_BALANCE_CORE_PURCHASE_COST_INCREASE())
#define MOD_BALANCE_CORE_PUPPET_PURCHASE			(MOD_COMMUNITY_PATCH && gCustomMods.isMOD_BALANCE_CORE_PUPPET_PURCHASE())
#endif
...
public:
	...
	MOD_OPT_DECL(MOD_BALANCE_CORE_SETTLER_MOVE);
	MOD_OPT_DECL(MOD_BALANCE_CORE_RESOURCE_FLAVORS);
	MOD_OPT_DECL(MOD_BALANCE_CORE_PURCHASE_COST_INCREASE);
	MOD_OPT_DECL(MOD_BALANCE_CORE_PUPPET_PURCHASE);
