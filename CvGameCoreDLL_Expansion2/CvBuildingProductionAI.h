...
public:
	...
	int CheckBuildingBuildSanity(BuildingTypes eBuilding, int iValue, int iNumLandConnection = 0, int iNumSeaConnection = 0, int iGPT = 0, bool bInterruptBuildings = false, bool bNationalWonderCheck = false, bool bFreeBuilding = false);
#endif
private:
