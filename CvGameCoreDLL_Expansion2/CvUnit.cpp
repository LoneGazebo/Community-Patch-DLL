...
CvUnit::CvUnit() :
	...
	, m_strName("")
	, m_eGreatWork(NO_GREAT_WORK), m_uiLastPathCacheOrigin(), m_uiLastPathCacheDestination(), m_uiLastPathFlags(), m_uiLastPathTurnSlice()
	...
	, m_eInvisibleType()
	, m_eSeeInvisibleType()
	, m_eGreatPeopleDirectiveType(), m_pUnitInfo()
	, m_combatUnit()
	, m_transportUnit()
