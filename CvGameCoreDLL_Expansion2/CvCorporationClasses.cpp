...
void CvPlayerCorporations::ClearCorporationFromForeignCities(bool bMinorsOnly /* = false */, bool bExcludeVassals /* = false */)
{
	if (!HasFoundedCorporation())
		return;
	...
	for (int iPlayerLoop = 0; iPlayerLoop < MAX_CIV_PLAYERS; iPlayerLoop++)
	{
		...
		if (MOD_DIPLOMACY_CIV4_FEATURES && bExcludeVassals)
		{
