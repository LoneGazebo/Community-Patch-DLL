...
enum CLOSED_ENUM CivOpinionTypes
{
	...
	NUM_CIV_OPINIONS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM CivApproachTypes
{
	...
	NUM_CIV_APPROACHES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM WarStateTypes
{
	...
	NUM_WAR_STATES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM StrengthTypes
{
	...
	NUM_STRENGTH_VALUES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM TargetValueTypes
{
	...
	NUM_TARGET_VALUES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM AggressivePostureTypes
{
	...
	NUM_AGGRESSIVE_POSTURE_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM ThreatTypes
{
	...
	NUM_THREAT_VALUES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM DisputeLevelTypes
{
	...
	NUM_DISPUTE_LEVELS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM BlockLevelTypes
{
	...
	NUM_BLOCK_LEVELS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM DoFLevelTypes
{
	...
	NUM_DOF_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM VictoryPursuitTypes
{
	...
	NUM_VICTORY_PURSUITS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM PromiseStates
{
	...
	NUM_PROMISE_STATES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM ModifierTypes
{
	...
	NUM_MODIFIER_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM TheftTypes
{
	...
	NUM_THEFT_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM GuessConfidenceTypes
{
	...
	NUM_GUESS_CONFIDENCE_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM StateAllWars
{
	...
	NUM_STATES_ALL_WARS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM PeaceBlockReasons
{
	...
	NUM_PEACE_BLOCK_REASONS MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM PeaceTreatyTypes
{
	...
	NUM_PEACE_TREATY_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM CoopWarStates
{
	...
	NUM_COOP_WAR_STATES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM PublicDeclarationTypes
{
	...
	NUM_PUBLIC_DECLARATION_TYPES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM DealOfferResponseTypes
{
	...
	NUM_DEAL_RESPONSES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM DemandResponseTypes
{
	...
	NUM_DEMAND_RESPONSES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM ShareOpinionResponseTypes
{
	...
	NUM_SHARE_OPINION_RESPONSES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM MoveTroopsResponseTypes
{
	...
	NUM_MOVE_TROOPS_RESPONSES MAYBE_UNUSED_ENUM,
};
...
enum CLOSED_ENUM VassalTreatmentTypes
{
	...
	NUM_VASSAL_TREATMENT_TYPES MAYBE_UNUSED_ENUM
};
...
enum CLOSED_ENUM MajorCivApproachTypes
{
	...
	NUM_MAJOR_CIV_APPROACHES MAYBE_UNUSED_ENUM,
};
