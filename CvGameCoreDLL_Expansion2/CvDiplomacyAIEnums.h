...
enum CLOSED_ENUM TimedModifierTypes
{
...
enum CLOSED_ENUM ShareApproachResponseTypes
{
	NO_SHARE_APPROACH_RESPONSE = -1,

	SHARE_APPROACH_RESPONSE_ACCEPTED,
	SHARE_APPROACH_RESPONSE_REFUSED,

	NUM_SHARE_APPROACH_RESPONSES ENUM_META_VALUE,
};
