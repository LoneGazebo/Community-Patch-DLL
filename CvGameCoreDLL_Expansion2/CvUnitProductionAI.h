...
public:
	...
	bool CheckUnitBuildSanity(UnitTypes eUnit, bool bForOperation, CvArmyAI* pArmy);
	UnitTypes RecommendUnit(UnitAITypes eUnitAIType, bool bUsesStrategicResource, bool bForOperation, CvArmyAI* pArmy);
#else
