...
int CustomMods::getOption(string sOption, int defValue) {
	if (!m_bInit) {
		...
		MOD_OPT_CACHE(MOD_BALANCE_CORE_HAPPINESS);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_HAPPINESS_MODIFIERS);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_HAPPINESS_NATIONAL);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_HAPPINESS_LUXURY);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_POP_REQ_BUILDINGS);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_SETTLER_RESET_FOOD);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_WONDERS_VARIABLE_REWARD);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_BELIEFS_RESOURCE);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_AFRAID_ANNEX);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_BUILDING_INSTANT_YIELD);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_GRANDSTRATEGY_AI);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_BELIEFS);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_FOLLOWER_POP_WONDER);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_POLICIES);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_BARBARIAN_THEFT);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_SETTLER_MOVE);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_RESOURCE_FLAVORS);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_PURCHASE_COST_INCREASE);
		MOD_OPT_CACHE(MOD_BALANCE_CORE_PUPPET_PURCHASE);
