...
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(CorporationTypes, getCorporationInfo, NO_CORPORATION);
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(ContractTypes, getContractInfo, NO_CONTRACT);
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(EventTypes, getEventInfo, NO_EVENT);
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(EventChoiceTypes, getEventChoiceInfo, NO_EVENT_CHOICE);
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(CityEventTypes, getCityEventInfo, NO_EVENT_CITY);
IMPLEMENT_SERIALIZATION_INFO_TYPE_HELPER(CityEventChoiceTypes, getCityEventChoiceInfo, NO_EVENT_CHOICE_CITY);
#endif
