...
bool CvPromotionEntry::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//UnitPromotions_Terrains
	{
		...
		while(pResults->Step())
		{
			...
			ASSERT(iTerrainID > -1 && iTerrainID < iNumTerrains);
	...
	//UnitPromotions_Features
	{
		...
		while(pResults->Step())
		{
			...
			ASSERT(iFeatureID > -1 && iFeatureID < iNumFeatures);
	...
	//UnitPromotions_UnitClasses
	{
		...
		while(pResults->Step())
		{
			...
			ASSERT(iUnitClassID > -1 && iUnitClassID  < iNumUnitClasses);
	...
	//UnitPromotions_CombatModPerAdjacentUnitCombat
	{
		...
		while(pResults->Step())
		{
			...
			ASSERT(iUnitCombatID > -1 && iUnitCombatID  < iNumUnitCombatClasses);
	...
	//UnitPromotions_Domains
	{
		...
		while(pResults->Step())
		{
			...
			ASSERT(iDomainID > -1 && iDomainID < iNumDomains);
...
bool CvUnitPromotions::HasPromotion(PromotionTypes eIndex) const
{
	...
	ASSERT(eIndex < GC.getNumPromotionInfos(), "eIndex is expected to be within maximum bounds (invalid Index)");
