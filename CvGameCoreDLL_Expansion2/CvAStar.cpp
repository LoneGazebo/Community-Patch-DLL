...
{
	int iKnownCost = 0;
	for (size_t i=0; i<path.vPlots.size()-1; i++)
	{
		CvAStarNode& current = m_ppaaNodes[ path.vPlots[i].first ][ path.vPlots[i].second ];
		CvAStarNode& next = m_ppaaNodes[ path.vPlots[i+1].first ][ path.vPlots[i+1].second ];
