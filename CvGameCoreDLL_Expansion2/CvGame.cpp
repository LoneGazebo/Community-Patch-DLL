...
void CvGame::SpawnArchaeologySitesHistorically()
{
	...
	// Ensure all existing sites have valid artifact data.
	PopulateExistingDigSites(vExistingDigSites, viArtifacts, viEras);
...
void CvGame::PopulateExistingDigSites(vector<CvPlot*>& vExistingDigSites, CvWeightedVector<GreatWorkArtifactClass>& viArtifacts, CvWeightedVector<int>& viEras)
{
