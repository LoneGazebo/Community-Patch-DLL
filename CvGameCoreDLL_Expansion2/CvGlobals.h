...
public:
	...
	GD_INT_MEMBER(QUEST_DISABLED_DISCOVER_PLOT); // VP
	GD_INT_MEMBER(QUEST_DISABLED_BUILD_X_BUILDINGS); // VP
	GD_INT_MEMBER(QUEST_DISABLED_UNIT_STEAL_FROM); // VP
	GD_INT_MEMBER(QUEST_DISABLED_UNIT_COUP_CITY); // VP
	GD_INT_MEMBER(QUEST_DISABLED_UNIT_GET_CITY); // VP
