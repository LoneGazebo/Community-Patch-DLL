...
public:
	...
	inline int getAI_MOSTLY_HAPPY_THRESHOLD()
	{
		return m_iAI_MOSTLY_HAPPY_THRESHOLD;
	}
#endif
	...
	inline int getAI_CITY_VALUE_MULTIPLIER()
	{
		return m_iAI_CITY_VALUE_MULTIPLIER;
	}
	inline int getAI_CAPITAL_VALUE_MULTIPLIER()
	{
		return m_iAI_CAPITAL_VALUE_MULTIPLIER;
	}
	inline int getAI_CITY_HIGH_VALUE_THRESHOLD()
	{
		return m_iAI_CITY_HIGH_VALUE_THRESHOLD;
	}
	inline int getAI_CITY_SOME_VALUE_THRESHOLD()
	{
		return m_iAI_CITY_SOME_VALUE_THRESHOLD;
	}
	inline int getAI_CITY_PUPPET_BONUS_THRESHOLD()
	{
		return m_iAI_CITY_PUPPET_BONUS_THRESHOLD;
	}
	...
	inline int getWARMONGER_THREAT_ATTACKED_SANCTIONED_PLAYER()
	{
		return m_iWARMONGER_THREAT_ATTACKED_SANCTIONED_PLAYER;
	}
...
//Weight for City Target if Liberation Quest Active
	...
	inline int getOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_LOW()
	{
		return m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_LOW;
	}
	inline int getOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_MEDIUM()
	{
		return m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_MEDIUM;
	}
	inline int getOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_HIGH()
	{
		return m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_HIGH;
	}
	inline int getOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_INCREDIBLE()
	{
		return m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_INCREDIBLE;
	}
	...
	inline int getOPINION_WEIGHT_MADE_DEMAND_OF_US_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_MADE_DEMAND_OF_US_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_RETURNED_CIVILIAN()
	{
		return m_iOPINION_WEIGHT_RETURNED_CIVILIAN;
	}
	inline int getOPINION_WEIGHT_RETURNED_CIVILIAN_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_RETURNED_CIVILIAN_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_BUILT_LANDMARK()
	{
		return m_iOPINION_WEIGHT_BUILT_LANDMARK;
	}
	inline int getOPINION_WEIGHT_BUILT_LANDMARK_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_BUILT_LANDMARK_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_RESURRECTED()
	{
		return m_iOPINION_WEIGHT_RESURRECTED;
	}
	inline int getOPINION_WEIGHT_LIBERATOR_CAPTURED_CAPITAL_DIVISOR()
	{
		return m_iOPINION_WEIGHT_LIBERATOR_CAPTURED_CAPITAL_DIVISOR;
	}
	inline int getOPINION_WEIGHT_LIBERATOR_CAPTURED_HOLY_CITY_DIVISOR()
	{
		return m_iOPINION_WEIGHT_LIBERATOR_CAPTURED_HOLY_CITY_DIVISOR;
	}
	...
	inline int getOPINION_WEIGHT_IDEOLOGY_VASSAL_DIVISOR()
	{
		return m_iOPINION_WEIGHT_IDEOLOGY_VASSAL_DIVISOR;
	}
	...
	inline int getOPINION_WEIGHT_DOF_MOST_VALUED_FRIEND()
	{
		return m_iOPINION_WEIGHT_DOF_MOST_VALUED_FRIEND;
	}
	inline int getOPINION_WEIGHT_DOF_TYPE_FRIENDS()
	{
		return m_iOPINION_WEIGHT_DOF_TYPE_FRIENDS;
	}
	inline int getOPINION_WEIGHT_DOF_TYPE_ALLIES()
	{
		return m_iOPINION_WEIGHT_DOF_TYPE_ALLIES;
	}
	inline int getOPINION_WEIGHT_DOF_TYPE_BATTLE_BROTHERS()
	{
		return m_iOPINION_WEIGHT_DOF_TYPE_BATTLE_BROTHERS;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_FRIEND()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_FRIEND;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_FRIEND_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_FRIEND_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_MOST_VALUED_FRIEND()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_MOST_VALUED_FRIEND;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_MOST_VALUED_ALLY()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_MOST_VALUED_ALLY;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_ENEMY()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_ENEMY;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_ENEMY_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_ENEMY_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_BIGGEST_COMPETITOR()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_BIGGEST_COMPETITOR;
	}
	inline int getOPINION_WEIGHT_DOF_WITH_BIGGEST_LEAGUE_RIVAL()
	{
		return m_iOPINION_WEIGHT_DOF_WITH_BIGGEST_LEAGUE_RIVAL;
	}
	inline int getOPINION_WEIGHT_BETRAYED_OUR_FRIEND_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_BETRAYED_OUR_FRIEND_MULTIPLIER;
	}
	...
	inline int getOPINION_WEIGHT_ATTACKED_OWN_VASSAL()
	{
		return m_iOPINION_WEIGHT_ATTACKED_OWN_VASSAL;
	}
	...
	inline int getOPINION_WEIGHT_ATTACKED_RESURRECTED_PLAYER()
	{
		return m_iOPINION_WEIGHT_ATTACKED_RESURRECTED_PLAYER;
	}
	inline int getOPINION_WEIGHT_RESURRECTOR_ATTACKED_US()
	{
		return m_iOPINION_WEIGHT_RESURRECTOR_ATTACKED_US;
	}
	...
	inline int getOPINION_WEIGHT_DENOUNCED_FRIEND_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_FRIEND_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_MOST_VALUED_FRIEND()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_MOST_VALUED_FRIEND;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_MOST_VALUED_ALLY()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_MOST_VALUED_ALLY;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_ENEMY()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_ENEMY;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_ENEMY_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_ENEMY_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_BIGGEST_COMPETITOR()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_BIGGEST_COMPETITOR;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_BIGGEST_LEAGUE_RIVAL()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_BIGGEST_LEAGUE_RIVAL;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DENOUNCED_BY_THEIR_KEY_FRIEND()
	{
		return m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_KEY_FRIEND;
	}
	...
	inline int getCIVILIAN_KILLER_VALUE_PER_OPINION_WEIGHT()
	{
		return m_iCIVILIAN_KILLER_VALUE_PER_OPINION_WEIGHT;
	}
	inline int getCIVILIAN_KILLER_VALUE_PER_TURN_DECAY()
	{
		return m_iCIVILIAN_KILLER_VALUE_PER_TURN_DECAY;
	}
	inline int getOPINION_WEIGHT_CIVILIAN_KILLER_MAX()
	{
		return m_iOPINION_WEIGHT_CIVILIAN_KILLER_MAX;
	}
	inline int getOPINION_WEIGHT_CIVILIAN_KILLER_WORLD_THRESHOLD()
	{
		return m_iOPINION_WEIGHT_CIVILIAN_KILLER_WORLD_THRESHOLD;
	}
	...
	inline int getOPINION_WEIGHT_PTP_SAME_MINOR_DIPLOMAT_MULTIPLIER()
	{
		return m_iOPINION_WEIGHT_PTP_SAME_MINOR_DIPLOMAT_MULTIPLIER;
	}
	inline int getOPINION_WEIGHT_CAPTURED_HOLY_CITY()
	{
		return m_iOPINION_WEIGHT_CAPTURED_HOLY_CITY;
	}
	inline int getOPINION_WEIGHT_CAPTURED_KEY_CITY_RETURNED_DIVISOR()
	{
		return m_iOPINION_WEIGHT_CAPTURED_KEY_CITY_RETURNED_DIVISOR;
	}
	...
	inline int getOPINION_WEIGHT_INTRIGUE_SHARED_BY_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_INTRIGUE_SHARED_BY_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_CAPTURED_CAPITAL()
	{
		return m_iOPINION_WEIGHT_CAPTURED_CAPITAL;
	}
	inline int getOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR()
	{
		return m_iOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR;
	}
	inline int getOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY_DIPLOMAT;
	}
	inline int getOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR_DIPLOMAT()
	{
		return m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR_DIPLOMAT;
	}
	...
	inline int getMAJOR_WAR_MULTIPLIER_TARGET_SOFT()
	{
		return m_iMAJOR_WAR_MULTIPLIER_TARGET_SOFT;
	}
	inline int getMAJOR_WAR_MULTIPLIER_TARGET_FAVORABLE()
	{
		return m_iMAJOR_WAR_MULTIPLIER_TARGET_FAVORABLE;
	}
	inline int getMAJOR_WAR_MULTIPLIER_TARGET_AVERAGE()
	{
		return m_iMAJOR_WAR_MULTIPLIER_TARGET_AVERAGE;
	}
	inline int getMAJOR_WAR_MULTIPLIER_TARGET_BAD()
	{
		return m_iMAJOR_WAR_MULTIPLIER_TARGET_BAD;
	}
	inline int getMAJOR_WAR_MULTIPLIER_TARGET_IMPOSSIBLE()
	{
		return m_iMAJOR_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	}
	...
	inline int getAI_WORLD_LEADER_BASE_WEIGHT_SELF()
	{
		return m_iAI_WORLD_LEADER_BASE_WEIGHT_SELF;
	}
	...
	inline int getMILITARY_RATING_HUMAN_BUFFER_VALUE()
	{
		return m_iMILITARY_RATING_HUMAN_BUFFER_VALUE;
	}
	...
	GD_INT_DEF(WARMONGER_THREAT_USED_NUKE_WEIGHT)
	GD_INT_DEF(WARMONGER_THREAT_CITY_VALUE_MULTIPLIER)
	GD_INT_DEF(WARMONGER_THREAT_CAPITAL_CITY_PERCENT)
	GD_INT_DEF(WARMONGER_THREAT_SHARED_FATE_PERCENT)
	GD_INT_DEF(WARMONGER_THREAT_LIBERATED_TEAM_BONUS_PERCENT)
	...
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_IMMENSE)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_POWERFUL)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_STRONG)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_AVERAGE)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_POOR)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_WEAK)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKER_STRENGTH_PATHETIC)
	GD_INT_DEF(WARMONGER_THREAT_DEFENDER_STRENGTH_IMMENSE)
	GD_INT_DEF(WARMONGER_THREAT_DEFENDER_STRENGTH_POWERFUL)
	GD_INT_DEF(WARMONGER_THREAT_DEFENDER_STRENGTH_STRONG)
	GD_INT_DEF(WARMONGER_THREAT_DEFENDER_STRENGTH_AVERAGE)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_IMMENSE)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_POWERFUL)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_STRONG)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_AVERAGE)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_POOR)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_WEAK)
	GD_INT_DEF(WARMONGER_THREAT_STRENGTH_DECAY_PATHETIC)
	...
	inline int getPLUNDERED_TRADE_ROUTE_TURNS_UNTIL_FORGIVEN()
	{
		return m_iPLUNDERED_TRADE_ROUTE_TURNS_UNTIL_FORGIVEN;
	}
	inline int getRETURNED_CIVILIAN_TURNS_UNTIL_FORGOTTEN()
	{
		return m_iRETURNED_CIVILIAN_TURNS_UNTIL_FORGOTTEN;
	}
	inline int getBUILT_LANDMARK_TURNS_UNTIL_FORGOTTEN()
	{
		return m_iBUILT_LANDMARK_TURNS_UNTIL_FORGOTTEN;
	}
	inline int getLIBERATED_CITY_TURNS_UNTIL_FORGOTTEN()
	{
		return m_iLIBERATED_CITY_TURNS_UNTIL_FORGOTTEN;
	}
	inline int getFORGAVE_FOR_SPYING_TURNS_UNTIL_FORGOTTEN()
	{
		return m_iFORGAVE_FOR_SPYING_TURNS_UNTIL_FORGOTTEN;
	}
	inline int getSHARED_INTRIGUE_TURNS_UNTIL_FORGOTTEN()
	{
		return m_iSHARED_INTRIGUE_TURNS_UNTIL_FORGOTTEN;
	}
	inline int getROBBED_US_TURNS_UNTIL_FORGIVEN()
	{
		return m_iROBBED_US_TURNS_UNTIL_FORGIVEN;
	}
	inline int getPLOTTED_AGAINST_US_TURNS_UNTIL_FORGIVEN()
	{
		return m_iPLOTTED_AGAINST_US_TURNS_UNTIL_FORGIVEN;
	}
	inline int getBEATEN_TO_WONDER_TURNS_UNTIL_FORGIVEN()
	{
		return m_iBEATEN_TO_WONDER_TURNS_UNTIL_FORGIVEN;
	}
	inline int getLOWERED_OUR_INFLUENCE_TURNS_UNTIL_FORGIVEN()
	{
		return m_iLOWERED_OUR_INFLUENCE_TURNS_UNTIL_FORGIVEN;
	}
	inline int getPERFORMED_COUP_TURNS_UNTIL_FORGIVEN()
	{
		return m_iPERFORMED_COUP_TURNS_UNTIL_FORGIVEN;
	}
	inline int getEXCAVATED_ARTIFACT_TURNS_UNTIL_FORGIVEN()
	{
		return m_iEXCAVATED_ARTIFACT_TURNS_UNTIL_FORGIVEN;
	}
	inline int getMADE_DEMAND_TURNS_UNTIL_FORGIVEN()
	{
		return m_iMADE_DEMAND_TURNS_UNTIL_FORGIVEN;
	}
	inline int getRELIGIOUS_CONVERSION_TURNS_UNTIL_FORGIVEN()
	{
		return m_iRELIGIOUS_CONVERSION_TURNS_UNTIL_FORGIVEN;
	}
	...
	GD_INT_DEF(COMBAT_AI_OFFENSE_DAMAGEWEIGHT) //also for defense in fact
	GD_INT_DEF(COMBAT_AI_OFFENSE_DANGERWEIGHT)
	GD_INT_DEF(COMBAT_AI_OFFENSE_SCORE_BIAS)
	GD_INT_DEF(COMBAT_AI_DEFENSE_SCORE_BIAS)

	GD_INT_DEF(MAJORS_CAN_MOVE_STARTING_SETTLER)
	GD_INT_DEF(CS_CAN_MOVE_STARTING_SETTLER)
	...
	GD_INT_DEF(DIPLOAI_DISABLE_VOLUNTARY_VASSALAGE)
	GD_INT_DEF(DIPLOAI_DISABLE_INSULT_MESSAGES)
	GD_INT_DEF(DIPLOAI_DISABLE_COMPLIMENT_MESSAGES)
	GD_INT_DEF(DIPLOAI_NO_FAKE_OPINION_MODIFIERS)
	GD_INT_DEF(DIPLOAI_SHOW_HIDDEN_OPINION_MODIFIERS)
	GD_INT_DEF(DIPLOAI_SHOW_ALL_OPINION_VALUES)
	GD_INT_DEF(DIPLOAI_SHOW_BASE_HUMAN_OPINION)
	GD_INT_DEF(DIPLOAI_HIDE_OPINION_TABLE)
	GD_INT_DEF(DIPLOAI_NO_FLAVOR_RANDOMIZATION)
	GD_INT_DEF(DIPLOAI_ENABLE_LUMP_GOLD_TRADES)
	...
	GD_INT_DEF(DIPLOAI_DISABLE_DEMANDS)
	GD_INT_DEF(DIPLOAI_DISABLE_INDEPENDENCE_REQUESTS)
	...
	GD_INT_DEF(WAR_PROGRESS_INITIAL_VALUE)
	GD_INT_DEF(WAR_PROGRESS_DECAY_VS_STRONGER)
	GD_INT_DEF(WAR_PROGRESS_DECAY_VS_EQUAL)
	GD_INT_DEF(WAR_PROGRESS_DECAY_VS_WEAKER)
	GD_INT_DEF(WAR_PROGRESS_CAPTURED_WORKER)
	GD_INT_DEF(WAR_PROGRESS_CAPTURED_SETTLER)
	GD_INT_DEF(WAR_PROGRESS_PLUNDERED_TRADE_ROUTE)
	GD_INT_DEF(WAR_PROGRESS_PILLAGED_IMPROVEMENT)
	GD_INT_DEF(WAR_PROGRESS_STOLE_TILE)
	GD_INT_DEF(WAR_PROGRESS_HIGH_VALUE_PILLAGE_MULTIPLIER)
	GD_INT_DEF(WAR_PROGRESS_KILLED_UNIT)
	GD_INT_DEF(WAR_PROGRESS_CAPTURED_CITY)
	GD_INT_DEF(WAR_PROGRESS_LOST_WORKER)
	GD_INT_DEF(WAR_PROGRESS_LOST_SETTLER)
	GD_INT_DEF(WAR_PROGRESS_LOST_TRADE_ROUTE)
	GD_INT_DEF(WAR_PROGRESS_LOST_IMPROVEMENT)
	GD_INT_DEF(WAR_PROGRESS_LOST_TILE)
	GD_INT_DEF(WAR_PROGRESS_LOST_UNIT)
	GD_INT_DEF(WAR_PROGRESS_LOST_CITY)
	GD_INT_DEF(WAR_PROGRESS_PER_STRATEGIC_DEFICIT)
	GD_INT_DEF(WAR_PROGRESS_PER_UNHAPPY)
	GD_INT_DEF(WAR_PROGRESS_CAPITAL_MULTIPLIER)
	GD_INT_DEF(WAR_PROGRESS_HOLY_CITY_MULTIPLIER)
	...
	inline int getOPINION_WEIGHT_RA_SCIENTIFIC_MOD()
	{
		return m_iOPINION_WEIGHT_RA_SCIENTIFIC_MOD;
	}
	inline int getOPINION_WEIGHT_DP()
	{
		return m_iOPINION_WEIGHT_DP;
	}
	inline int getOPINION_WEIGHT_DP_MOST_VALUED_ALLY()
	{
		return m_iOPINION_WEIGHT_DP_MOST_VALUED_ALLY;
	}
	inline int getOPINION_WEIGHT_DP_WITH_FRIEND()
	{
		return m_iOPINION_WEIGHT_DP_WITH_FRIEND;
	}
	inline int getOPINION_WEIGHT_DP_WITH_FRIEND_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DP_WITH_FRIEND_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DP_WITH_MOST_VALUED_ALLY()
	{
		return m_iOPINION_WEIGHT_DP_WITH_MOST_VALUED_ALLY;
	}
	inline int getOPINION_WEIGHT_DP_WITH_MOST_VALUED_FRIEND()
	{
		return m_iOPINION_WEIGHT_DP_WITH_MOST_VALUED_FRIEND;
	}
	inline int getOPINION_WEIGHT_DP_WITH_ENEMY()
	{
		return m_iOPINION_WEIGHT_DP_WITH_ENEMY;
	}
	inline int getOPINION_WEIGHT_DP_WITH_ENEMY_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_DP_WITH_ENEMY_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_DP_WITH_BIGGEST_COMPETITOR()
	{
		return m_iOPINION_WEIGHT_DP_WITH_BIGGEST_COMPETITOR;
	}
	inline int getOPINION_WEIGHT_DP_WITH_BIGGEST_LEAGUE_RIVAL()
	{
		return m_iOPINION_WEIGHT_DP_WITH_BIGGEST_LEAGUE_RIVAL;
	}
	...
	inline int getOPINION_WEIGHT_PLOTTED_AGAINST_US_SUBSEQUENT()
	{
		return m_iOPINION_WEIGHT_PLOTTED_AGAINST_US_SUBSEQUENT;
	}
	inline int getOPINION_WEIGHT_PERFORMED_COUP()
	{
		return m_iOPINION_WEIGHT_PERFORMED_COUP;
	}
	inline int getOPINION_WEIGHT_EXCAVATED_ARTIFACT()
	{
		return m_iOPINION_WEIGHT_EXCAVATED_ARTIFACT;
	}
	...
	inline int getMOD_BALANCE_CORE_MINIMUM_RANKING_PTP()
	{
		return m_iMOD_BALANCE_CORE_MINIMUM_RANKING_PTP;
	}
	...
	inline int getESPIONAGE_GATHERING_INTEL_COST_DIVISOR()
	{
		return m_iESPIONAGE_GATHERING_INTEL_COST_DIVISOR;
	}
	...
	inline int getMINIMUM_TOURISM_BLAST_STRENGTH()
	{
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iAI_MOSTLY_HAPPY_THRESHOLD;
#endif
	...
	int m_iAI_CITY_VALUE_MULTIPLIER;
	int m_iAI_CAPITAL_VALUE_MULTIPLIER;
	int m_iAI_CITY_HIGH_VALUE_THRESHOLD;
	int m_iAI_CITY_SOME_VALUE_THRESHOLD;
	int m_iAI_CITY_PUPPET_BONUS_THRESHOLD;
	...
	int m_iWARMONGER_THREAT_ATTACKED_SANCTIONED_PLAYER;
	...
	int m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_LOW;
	int m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_MEDIUM;
	int m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_HIGH;
	int m_iOPINION_WEIGHT_MILITARY_AGGRESSIVE_POSTURE_INCREDIBLE;
	...
	int m_iOPINION_WEIGHT_MADE_DEMAND_OF_US_SUBSEQUENT;
	int m_iOPINION_WEIGHT_RETURNED_CIVILIAN;
	int m_iOPINION_WEIGHT_RETURNED_CIVILIAN_SUBSEQUENT;
	int m_iOPINION_WEIGHT_BUILT_LANDMARK;
	int m_iOPINION_WEIGHT_BUILT_LANDMARK_SUBSEQUENT;
	int m_iOPINION_WEIGHT_RESURRECTED;
	int m_iOPINION_WEIGHT_LIBERATOR_CAPTURED_CAPITAL_DIVISOR;
	int m_iOPINION_WEIGHT_LIBERATOR_CAPTURED_HOLY_CITY_DIVISOR;
	...
	int m_iOPINION_WEIGHT_IDEOLOGY_VASSAL_DIVISOR;
	...
	int m_iOPINION_WEIGHT_DOF_MOST_VALUED_FRIEND;
	int m_iOPINION_WEIGHT_DOF_TYPE_FRIENDS;
	int m_iOPINION_WEIGHT_DOF_TYPE_ALLIES;
	int m_iOPINION_WEIGHT_DOF_TYPE_BATTLE_BROTHERS;
	int m_iOPINION_WEIGHT_DOF_WITH_FRIEND;
	int m_iOPINION_WEIGHT_DOF_WITH_FRIEND_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DOF_WITH_MOST_VALUED_FRIEND;
	int m_iOPINION_WEIGHT_DOF_WITH_MOST_VALUED_ALLY;
	int m_iOPINION_WEIGHT_DOF_WITH_ENEMY;
	int m_iOPINION_WEIGHT_DOF_WITH_ENEMY_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DOF_WITH_BIGGEST_COMPETITOR;
	int m_iOPINION_WEIGHT_DOF_WITH_BIGGEST_LEAGUE_RIVAL;
	int m_iOPINION_WEIGHT_BETRAYED_OUR_FRIEND_MULTIPLIER;
	...
	int m_iOPINION_WEIGHT_ATTACKED_OWN_VASSAL;
	int m_iOPINION_WEIGHT_WAR_FRIEND_EACH;
	int m_iOPINION_WEIGHT_WAR_ME_FRIENDS;
	int m_iOPINION_WEIGHT_ATTACKED_RESURRECTED_PLAYER;
	int m_iOPINION_WEIGHT_RESURRECTOR_ATTACKED_US;
	...
	int m_iOPINION_WEIGHT_DENOUNCED_FRIEND_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DENOUNCED_MOST_VALUED_FRIEND;
	int m_iOPINION_WEIGHT_DENOUNCED_MOST_VALUED_ALLY;
	int m_iOPINION_WEIGHT_DENOUNCED_ENEMY;
	int m_iOPINION_WEIGHT_DENOUNCED_ENEMY_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DENOUNCED_BIGGEST_COMPETITOR;
	int m_iOPINION_WEIGHT_DENOUNCED_BIGGEST_LEAGUE_RIVAL;
	int m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND;
	int m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_FRIEND_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DENOUNCED_BY_THEIR_KEY_FRIEND;
	...
	int m_iCIVILIAN_KILLER_VALUE_PER_OPINION_WEIGHT;
	int m_iCIVILIAN_KILLER_VALUE_PER_TURN_DECAY;
	int m_iOPINION_WEIGHT_CIVILIAN_KILLER_MAX;
	int m_iOPINION_WEIGHT_CIVILIAN_KILLER_WORLD_THRESHOLD;
	...
	int m_iOPINION_WEIGHT_PTP_SAME_MINOR_DIPLOMAT_MULTIPLIER;
	int m_iOPINION_WEIGHT_CAPTURED_HOLY_CITY;
	int m_iOPINION_WEIGHT_CAPTURED_KEY_CITY_RETURNED_DIVISOR;
	...
	int m_iOPINION_WEIGHT_INTRIGUE_SHARED_BY_SUBSEQUENT;
	int m_iOPINION_WEIGHT_CAPTURED_CAPITAL;
	int m_iOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR;
	int m_iOPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY_DIPLOMAT;
	int m_iOPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR_DIPLOMAT;
	...
	int m_iMAJOR_WAR_MULTIPLIER_TARGET_SOFT;
	int m_iMAJOR_WAR_MULTIPLIER_TARGET_FAVORABLE;
	int m_iMAJOR_WAR_MULTIPLIER_TARGET_AVERAGE;
	int m_iMAJOR_WAR_MULTIPLIER_TARGET_BAD;
	int m_iMAJOR_WAR_MULTIPLIER_TARGET_IMPOSSIBLE;
	...
	int m_iAI_WORLD_LEADER_BASE_WEIGHT_SELF;
	...
	int m_iMILITARY_RATING_HUMAN_BUFFER_VALUE;
	...
	GD_INT_DECL(WARMONGER_THREAT_USED_NUKE_WEIGHT);
	GD_INT_DECL(WARMONGER_THREAT_CITY_VALUE_MULTIPLIER);
	GD_INT_DECL(WARMONGER_THREAT_CAPITAL_CITY_PERCENT);
	GD_INT_DECL(WARMONGER_THREAT_SHARED_FATE_PERCENT);
	GD_INT_DECL(WARMONGER_THREAT_LIBERATED_TEAM_BONUS_PERCENT);
	...
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_IMMENSE);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_POWERFUL);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_STRONG);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_AVERAGE);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_POOR);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_WEAK);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKER_STRENGTH_PATHETIC);
	GD_INT_DECL(WARMONGER_THREAT_DEFENDER_STRENGTH_IMMENSE);
	GD_INT_DECL(WARMONGER_THREAT_DEFENDER_STRENGTH_POWERFUL);
	GD_INT_DECL(WARMONGER_THREAT_DEFENDER_STRENGTH_STRONG);
	GD_INT_DECL(WARMONGER_THREAT_DEFENDER_STRENGTH_AVERAGE);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_IMMENSE);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_POWERFUL);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_STRONG);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_AVERAGE);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_POOR);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_WEAK);
	GD_INT_DECL(WARMONGER_THREAT_STRENGTH_DECAY_PATHETIC);
	...
	int m_iPLUNDERED_TRADE_ROUTE_TURNS_UNTIL_FORGIVEN;
	int m_iRETURNED_CIVILIAN_TURNS_UNTIL_FORGOTTEN;
	int m_iBUILT_LANDMARK_TURNS_UNTIL_FORGOTTEN;
	int m_iLIBERATED_CITY_TURNS_UNTIL_FORGOTTEN;
	int m_iFORGAVE_FOR_SPYING_TURNS_UNTIL_FORGOTTEN;
	int m_iSHARED_INTRIGUE_TURNS_UNTIL_FORGOTTEN;
	int m_iROBBED_US_TURNS_UNTIL_FORGIVEN;
	int m_iPLOTTED_AGAINST_US_TURNS_UNTIL_FORGIVEN;
	int m_iBEATEN_TO_WONDER_TURNS_UNTIL_FORGIVEN;
	int m_iLOWERED_OUR_INFLUENCE_TURNS_UNTIL_FORGIVEN;
	int m_iPERFORMED_COUP_TURNS_UNTIL_FORGIVEN;
	int m_iEXCAVATED_ARTIFACT_TURNS_UNTIL_FORGIVEN;
	int m_iMADE_DEMAND_TURNS_UNTIL_FORGIVEN;
	int m_iRELIGIOUS_CONVERSION_TURNS_UNTIL_FORGIVEN;
	...
	GD_INT_DECL(MAJORS_CAN_MOVE_STARTING_SETTLER);
	GD_INT_DECL(CS_CAN_MOVE_STARTING_SETTLER);
	...
	GD_INT_DECL(DIPLOAI_DISABLE_VOLUNTARY_VASSALAGE);
	GD_INT_DECL(DIPLOAI_DISABLE_INSULT_MESSAGES);
	GD_INT_DECL(DIPLOAI_DISABLE_COMPLIMENT_MESSAGES);
	GD_INT_DECL(DIPLOAI_NO_FAKE_OPINION_MODIFIERS);
	GD_INT_DECL(DIPLOAI_SHOW_HIDDEN_OPINION_MODIFIERS);
	GD_INT_DECL(DIPLOAI_SHOW_ALL_OPINION_VALUES);
	GD_INT_DECL(DIPLOAI_SHOW_BASE_HUMAN_OPINION);
	GD_INT_DECL(DIPLOAI_HIDE_OPINION_TABLE);
	GD_INT_DECL(DIPLOAI_NO_FLAVOR_RANDOMIZATION);
	GD_INT_DECL(DIPLOAI_ENABLE_LUMP_GOLD_TRADES);
	...
	GD_INT_DECL(DIPLOAI_DISABLE_DEMANDS);
	GD_INT_DECL(DIPLOAI_DISABLE_INDEPENDENCE_REQUESTS);
	...
	GD_INT_DECL(WAR_PROGRESS_INITIAL_VALUE);
	GD_INT_DECL(WAR_PROGRESS_DECAY_VS_STRONGER);
	GD_INT_DECL(WAR_PROGRESS_DECAY_VS_EQUAL);
	GD_INT_DECL(WAR_PROGRESS_DECAY_VS_WEAKER);
	GD_INT_DECL(WAR_PROGRESS_CAPTURED_WORKER);
	GD_INT_DECL(WAR_PROGRESS_CAPTURED_SETTLER);
	GD_INT_DECL(WAR_PROGRESS_PLUNDERED_TRADE_ROUTE);
	GD_INT_DECL(WAR_PROGRESS_PILLAGED_IMPROVEMENT);
	GD_INT_DECL(WAR_PROGRESS_STOLE_TILE);
	GD_INT_DECL(WAR_PROGRESS_HIGH_VALUE_PILLAGE_MULTIPLIER);
	GD_INT_DECL(WAR_PROGRESS_KILLED_UNIT);
	GD_INT_DECL(WAR_PROGRESS_CAPTURED_CITY);
	GD_INT_DECL(WAR_PROGRESS_LOST_WORKER);
	GD_INT_DECL(WAR_PROGRESS_LOST_SETTLER);
	GD_INT_DECL(WAR_PROGRESS_LOST_TRADE_ROUTE);
	GD_INT_DECL(WAR_PROGRESS_LOST_IMPROVEMENT);
	GD_INT_DECL(WAR_PROGRESS_LOST_TILE);
	GD_INT_DECL(WAR_PROGRESS_LOST_UNIT);
	GD_INT_DECL(WAR_PROGRESS_LOST_CITY);
	GD_INT_DECL(WAR_PROGRESS_PER_STRATEGIC_DEFICIT);
	GD_INT_DECL(WAR_PROGRESS_PER_UNHAPPY);
	GD_INT_DECL(WAR_PROGRESS_CAPITAL_MULTIPLIER);
	GD_INT_DECL(WAR_PROGRESS_HOLY_CITY_MULTIPLIER);
	...
	int m_iESPIONAGE_GATHERING_INTEL_COST_DIVISOR;
	...
	int m_iOPINION_WEIGHT_RA_SCIENTIFIC_MOD;
	int m_iOPINION_WEIGHT_DP;
	int m_iOPINION_WEIGHT_DP_MOST_VALUED_ALLY;
	int m_iOPINION_WEIGHT_DP_WITH_FRIEND;
	int m_iOPINION_WEIGHT_DP_WITH_FRIEND_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DP_WITH_MOST_VALUED_ALLY;
	int m_iOPINION_WEIGHT_DP_WITH_MOST_VALUED_FRIEND;
	int m_iOPINION_WEIGHT_DP_WITH_ENEMY;
	int m_iOPINION_WEIGHT_DP_WITH_ENEMY_SUBSEQUENT;
	int m_iOPINION_WEIGHT_DP_WITH_BIGGEST_COMPETITOR;
	int m_iOPINION_WEIGHT_DP_WITH_BIGGEST_LEAGUE_RIVAL;
	...
	int m_iOPINION_WEIGHT_PLOTTED_AGAINST_US_SUBSEQUENT;
	int m_iOPINION_WEIGHT_PERFORMED_COUP;
	int m_iOPINION_WEIGHT_EXCAVATED_ARTIFACT;
	...
	int m_iMOD_BALANCE_CORE_MINIMUM_RANKING_PTP;
