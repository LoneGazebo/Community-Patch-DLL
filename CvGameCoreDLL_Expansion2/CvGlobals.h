...
//Weight for City Target if Liberation Quest Active
	...
	inline int getAPPROACH_WAR_PROXIMITY_NEIGHBORS_EARLY_GAME()
	{
		return m_iAPPROACH_WAR_PROXIMITY_NEIGHBORS_EARLY_GAME;
	}
	inline int getAPPROACH_WAR_PROXIMITY_CLOSE()
	{
		return m_iAPPROACH_WAR_PROXIMITY_CLOSE;
	}
	inline int getAPPROACH_WAR_PROXIMITY_CLOSE_EARLY_GAME()
	{
		return m_iAPPROACH_WAR_PROXIMITY_CLOSE_EARLY_GAME;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iAPPROACH_WAR_PROXIMITY_NEIGHBORS_EARLY_GAME;
	int m_iAPPROACH_WAR_PROXIMITY_CLOSE;
	int m_iAPPROACH_WAR_PROXIMITY_CLOSE_EARLY_GAME;
