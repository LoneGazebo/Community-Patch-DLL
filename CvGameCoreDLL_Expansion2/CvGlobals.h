...
//Weight for City Target if Liberation Quest Active
	...
	inline int getOPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR()
	{
		return m_iOPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iOPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR;
