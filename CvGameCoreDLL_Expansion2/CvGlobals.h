...
public:
	...
	GD_INT_MEMBER(ESPIONAGE_SPY_EXPERIENCE_DENOMINATOR);
	GD_INT_MEMBER(ESPIONAGE_DEFENDING_SPY_EXPERIENCE);
	GD_INT_MEMBER(ESPIONAGE_DIPLOMAT_SPY_EXPERIENCE);
	GD_INT_MEMBER(ESPIONAGE_OFFENSIVE_SPY_EXPERIENCE);
