...
public:
	...
	GD_INT_MEMBER(UNHAPPY_SETTLER_PRODUCTION_PENALTY); // VP
	GD_INT_MEMBER(VERY_UNHAPPY_SETTLER_PRODUCTION_PENALTY); // VP
	GD_INT_MEMBER(SUPER_UNHAPPY_SETTLER_PRODUCTION_PENALTY); // VP
	...
	GD_INT_MEMBER(VICTORY_DOMINATION_CONTROL_PERCENT);
