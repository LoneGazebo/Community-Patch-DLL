...
//Weight for City Target if Liberation Quest Active
	...
	inline float getOPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD()
	{
		return m_fOPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	float m_fOPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD;
