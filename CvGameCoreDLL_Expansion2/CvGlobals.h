...
//Weight for City Target if Liberation Quest Active
	...
	inline int getOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT()
	{
		return m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT;
	}
	...
	inline int getAPPROACH_NEUTRAL_BASE_HUMAN()
	{
		return m_iAPPROACH_NEUTRAL_BASE_HUMAN;
	}
	inline int getAPPROACH_FRIENDLY_BASE_HUMAN()
	{
		return m_iAPPROACH_FRIENDLY_BASE_HUMAN;
	}
	inline int getAPPROACH_AFRAID_BASE_HUMAN()
	{
		return m_iAPPROACH_AFRAID_BASE_HUMAN;
	}
	inline int getAPPROACH_GUARDED_BASE_HUMAN()
	{
		return m_iAPPROACH_GUARDED_BASE_HUMAN;
	}
	inline int getAPPROACH_DECEPTIVE_BASE_HUMAN()
	{
		return m_iAPPROACH_DECEPTIVE_BASE_HUMAN;
	}
	inline int getAPPROACH_HOSTILE_BASE_HUMAN()
	{
		return m_iAPPROACH_HOSTILE_BASE_HUMAN;
	}
	inline int getAPPROACH_WAR_BASE_HUMAN()
	{
		return m_iAPPROACH_WAR_BASE_HUMAN;
	}
	inline int getAPPROACH_NEUTRAL_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_NEUTRAL_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_FRIENDLY_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_FRIENDLY_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_AFRAID_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_AFRAID_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_GUARDED_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_GUARDED_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_DECEPTIVE_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_DECEPTIVE_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_HOSTILE_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_HOSTILE_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_WAR_BASE_HUMAN_PERCENT()
	{
		return m_iAPPROACH_WAR_BASE_HUMAN_PERCENT;
	}
	inline int getAPPROACH_NEUTRAL_BASE_AI()
	{
		return m_iAPPROACH_NEUTRAL_BASE_AI;
	}
	inline int getAPPROACH_FRIENDLY_BASE_AI()
	{
		return m_iAPPROACH_FRIENDLY_BASE_AI;
	}
	inline int getAPPROACH_AFRAID_BASE_AI()
	{
		return m_iAPPROACH_AFRAID_BASE_AI;
	}
	inline int getAPPROACH_GUARDED_BASE_AI()
	{
		return m_iAPPROACH_GUARDED_BASE_AI;
	}
	inline int getAPPROACH_DECEPTIVE_BASE_AI()
	{
		return m_iAPPROACH_DECEPTIVE_BASE_AI;
	}
	inline int getAPPROACH_HOSTILE_BASE_AI()
	{
		return m_iAPPROACH_HOSTILE_BASE_AI;
	}
	inline int getAPPROACH_WAR_BASE_AI()
	{
		return m_iAPPROACH_WAR_BASE_AI;
	}
	inline int getAPPROACH_NEUTRAL_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_NEUTRAL_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_FRIENDLY_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_FRIENDLY_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_AFRAID_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_AFRAID_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_GUARDED_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_GUARDED_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_DECEPTIVE_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_DECEPTIVE_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_HOSTILE_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_HOSTILE_BASE_AI_PERCENT;
	}
	inline int getAPPROACH_WAR_BASE_AI_PERCENT()
	{
		return m_iAPPROACH_WAR_BASE_AI_PERCENT;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT;
	...
	int m_iAPPROACH_NEUTRAL_BASE_HUMAN;
	int m_iAPPROACH_FRIENDLY_BASE_HUMAN;
	int m_iAPPROACH_AFRAID_BASE_HUMAN;
	int m_iAPPROACH_GUARDED_BASE_HUMAN;
	int m_iAPPROACH_DECEPTIVE_BASE_HUMAN;
	int m_iAPPROACH_HOSTILE_BASE_HUMAN;
	int m_iAPPROACH_WAR_BASE_HUMAN;
	int m_iAPPROACH_NEUTRAL_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_FRIENDLY_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_AFRAID_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_GUARDED_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_DECEPTIVE_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_HOSTILE_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_WAR_BASE_HUMAN_PERCENT;
	int m_iAPPROACH_NEUTRAL_BASE_AI;
	int m_iAPPROACH_FRIENDLY_BASE_AI;
	int m_iAPPROACH_AFRAID_BASE_AI;
	int m_iAPPROACH_GUARDED_BASE_AI;
	int m_iAPPROACH_DECEPTIVE_BASE_AI;
	int m_iAPPROACH_HOSTILE_BASE_AI;
	int m_iAPPROACH_WAR_BASE_AI;
	int m_iAPPROACH_NEUTRAL_BASE_AI_PERCENT;
	int m_iAPPROACH_FRIENDLY_BASE_AI_PERCENT;
	int m_iAPPROACH_AFRAID_BASE_AI_PERCENT;
	int m_iAPPROACH_GUARDED_BASE_AI_PERCENT;
	int m_iAPPROACH_DECEPTIVE_BASE_AI_PERCENT;
	int m_iAPPROACH_HOSTILE_BASE_AI_PERCENT;
	int m_iAPPROACH_WAR_BASE_AI_PERCENT;
