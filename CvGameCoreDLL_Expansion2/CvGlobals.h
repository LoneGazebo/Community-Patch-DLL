...
//Weight for City Target if Liberation Quest Active
	...
	inline int getBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT()
	{
		return m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT;
	}
	...
	inline int getBALANCE_TECH_RATE_CULTURE_SCIENCE()
	{
		return m_iBALANCE_TECH_RATE_CULTURE_SCIENCE;
	}
	inline int getBALANCE_TECH_RATE_DEFENSE()
	{
		return m_iBALANCE_TECH_RATE_DEFENSE;
	}
	inline int getBALANCE_TECH_RATE_FOOD_GOLD()
	{
		return m_iBALANCE_TECH_RATE_FOOD_GOLD;
	}
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT;
	int m_iBALANCE_UNHAPPY_CITY_BASE_VALUE;
	int m_iBALANCE_HAPPINESS_ERA_MAX_INCREASE;
	int m_iBALANCE_TECH_RATE_CULTURE_SCIENCE;
	int m_iBALANCE_TECH_RATE_DEFENSE;
	int m_iBALANCE_TECH_RATE_FOOD_GOLD;
