...
//Weight for City Target if Liberation Quest Active
	...
	inline float getBALANCE_UNHAPPINESS_PER_GOLD_THRESHOLD()
	{
		return m_fBALANCE_UNHAPPINESS_PER_GOLD_THRESHOLD;
	}
	inline float getBALANCE_UNHAPPINESS_PER_GOLD_RATE()
	{
		return m_fBALANCE_UNHAPPINESS_PER_GOLD_RATE;
	}
	inline float getBALANCE_UNHAPPINESS_PER_DEFENSE_THRESHOLD()
	{
		return m_fBALANCE_UNHAPPINESS_PER_DEFENSE_THRESHOLD;
	}
	inline float getBALANCE_UNHAPPINESS_PER_DEFENSE_RATE()
	{
		return m_fBALANCE_UNHAPPINESS_PER_DEFENSE_RATE;
	}
	inline float getBALANCE_UNHAPPINESS_PER_CULTURE_THRESHOLD()
	{
		return m_fBALANCE_UNHAPPINESS_PER_CULTURE_THRESHOLD;
	}
	...
	inline int getBARBARIAN_CIVILIZATION2()
	{
		return m_iBARBARIAN_CIVILIZATION2;
	}
	inline int getBARBARIAN_CIVILIZATION3()
	{
		return m_iBARBARIAN_CIVILIZATION3;
	}
	inline int getBARBARIAN_CIVILIZATION4()
	{
		return m_iBARBARIAN_CIVILIZATION4;
	}
	inline int getBARBARIAN_CIVILIZATION5()
	{
		return m_iBARBARIAN_CIVILIZATION5;
	}
	inline int getBARBARIAN_CIVILIZATION6()
	{
		return m_iBARBARIAN_CIVILIZATION6;
	}
	inline int getBARBARIAN_CIVILIZATION7()
	{
		return m_iBARBARIAN_CIVILIZATION7;
	}
	inline int getBARBARIAN_CIVILIZATION8()
	{
		return m_iBARBARIAN_CIVILIZATION8;
	}
	inline int getBARBARIAN_CIVILIZATION9()
	{
		return m_iBARBARIAN_CIVILIZATION9;
	}
	inline int getBARBARIAN_CIVILIZATION10()
	{
		return m_iBARBARIAN_CIVILIZATION10;
	}
	inline int getBARBARIAN_CIVILIZATION11()
	{
		return m_iBARBARIAN_CIVILIZATION11;
	}
	inline int getBARBARIAN_CIVILIZATION12()
	{
		return m_iBARBARIAN_CIVILIZATION12;
	}
#endif
...
protected:
	...
	************************************************************************************************************************/
	...
	float m_fBALANCE_UNHAPPINESS_PER_GOLD_THRESHOLD;
	float m_fBALANCE_UNHAPPINESS_PER_GOLD_RATE;
	float m_fBALANCE_UNHAPPINESS_PER_DEFENSE_THRESHOLD;
	float m_fBALANCE_UNHAPPINESS_PER_DEFENSE_RATE;
	float m_fBALANCE_UNHAPPINESS_PER_CULTURE_THRESHOLD;
	...
	int m_iBARBARIAN_CIVILIZATION2;
	int m_iBARBARIAN_CIVILIZATION3;
	int m_iBARBARIAN_CIVILIZATION4;
	int m_iBARBARIAN_CIVILIZATION5;
	int m_iBARBARIAN_CIVILIZATION6;
	int m_iBARBARIAN_CIVILIZATION7;
	int m_iBARBARIAN_CIVILIZATION8;
	int m_iBARBARIAN_CIVILIZATION9;
	int m_iBARBARIAN_CIVILIZATION10;
	int m_iBARBARIAN_CIVILIZATION11;
	int m_iBARBARIAN_CIVILIZATION12;
#endif
