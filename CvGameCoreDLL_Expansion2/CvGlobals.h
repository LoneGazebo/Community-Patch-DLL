...
public:
	...
	GD_INT_MEMBER(AI_CITIZEN_VALUE_GPP);
	...
	GD_INT_MEMBER(DEMAND_LIMIT_MAX_VALUE);
	GD_INT_MEMBER(DEMAND_LIMIT_GAMEPROGRESS_SCALING);
	...
	GD_INT_MEMBER(UNIT_SUPPLY_WAR_WEARINESS_REDUCTION_MAX); // VP
