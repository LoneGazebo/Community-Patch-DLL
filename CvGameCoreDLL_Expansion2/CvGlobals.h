...
public:
	...
	GD_INT_MEMBER(OPINION_WEIGHT_SAME_MAJORITY_RELIGIONS); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_DIFFERENT_MAJORITY_RELIGIONS); // VP
	...
	GD_INT_MEMBER(OPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_PRIME_LEAGUE_COMPETITOR_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_ENEMY_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_HATRED_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_RIVAL_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_FRIEND_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_CONFIDANT_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_ALLY_DIPLOMAT); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR); // VP
	GD_INT_MEMBER(OPINION_WEIGHT_LEAGUE_ALIGNMENT_LIBERATOR_DIPLOMAT); // VP
	...
	GD_INT_MEMBER(OPINION_WEIGHT_VASSAL_SAME_MAJORITY_RELIGION); // VP
	...
	GD_FLOAT_MEMBER(MOD_BALANCE_CORE_CORP_OFFICE_FRANCHISE_CONVERSION); // VP
	GD_FLOAT_MEMBER(MOD_BALANCE_CORE_CORP_OFFICE_TR_CONVERSION); // VP
	...
	GD_INT_MEMBER(INQUISITION_EFFECTIVENESS);
