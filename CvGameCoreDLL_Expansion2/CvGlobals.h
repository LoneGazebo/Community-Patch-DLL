...
public:
	...
	GD_INT_MEMBER(MINOR_CIV_HEAVY_TRIBUTE_THRESHOLD);
	...
	GD_INT_MEMBER(QUEST_DISABLED_DISCOVER_AREA); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_BASE); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_FIND_CITY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_FIND_CITY); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DISCOVER_AREA); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_DISCOVER_AREA); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DISCOVER_AREA); // VP
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_ACQUIRE_CITY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_ACQUIRE_CITY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_ACQUIRE_CITY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_ACQUIRE_CITY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_ACQUIRE_CITY); // VP
	...
	GD_INT_MEMBER(GREAT_MUSICIAN_BLAST_HAPPINESS); // VP
	...
	GD_INT_MEMBER(BALANCE_MARRIAGE_COST_BASE);
	GD_INT_MEMBER(BALANCE_MARRIAGE_COST_INCREASE_PER_PREVIOUS_MARRIAGE);
