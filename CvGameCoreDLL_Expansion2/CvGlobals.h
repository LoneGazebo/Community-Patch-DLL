...
public:
	...
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_BASE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_CULTURED); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MILITARISTIC); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MARITIME); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MERCANTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_RELIGIOUS); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_FRIENDLY); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_NEUTRAL); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_HOSTILE); // VP
	GD_INT_MEMBER(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_IRRATIONAL); // VP
