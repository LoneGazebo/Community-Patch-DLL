...
//------------------------------------------------------------------------------
int CvLeaderHeadInfo::GetReligionCompetitiveness() const
{
	return m_iReligionCompetitiveness;
}
//------------------------------------------------------------------------------
...
bool CvLeaderHeadInfo::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	m_iReligionCompetitiveness					= kResults.GetInt("ReligionCompetitiveness");
