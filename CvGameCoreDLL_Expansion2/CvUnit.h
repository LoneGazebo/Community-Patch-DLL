...
public:
	...
	bool CanClaimGoody() const;
	int GetCanClaimGoodyCount() const;
	void ChangeCanClaimGoodyCount(int iValue);
...
SYNC_ARCHIVE_VAR(int, m_iCanClaimGoodyCount)
