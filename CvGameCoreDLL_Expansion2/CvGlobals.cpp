...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(SQLITE_LOGGING_BATCHED_BUFFER_ROWS_MAX, 1024),
	...
	GD_INT_INIT(POLICY_COST_VISIBLE_DIVISOR, 3),
	GD_INT_INIT(NUM_CITIES_COST_MOD_SCALING, 0),
	...
	GD_INT_INIT(ESPIONAGE_NP_BASE, 50),
	GD_INT_INIT(ESPIONAGE_NP_PER_SPY_RANK, 0),
	GD_INT_INIT(ESPIONAGE_NP_CULTURAL_INFLUENCE, 15),
	GD_INT_INIT(ESPIONAGE_NP_PER_TECHNOLOGY_BEHIND, 0),
	GD_INT_INIT(ESPIONAGE_NP_MAX_NUM_TECH, 10),
	GD_INT_INIT(ESPIONAGE_NP_REDUCTION_PER_SECURITY_POINT, 100),
	GD_INT_INIT(ESPIONAGE_MAX_NUM_SECURITY_POINTS, 100),
	GD_INT_INIT(ESPIONAGE_SECURITY_BASE, 20),
	GD_INT_INIT(ESPIONAGE_SECURITY_NOT_ALL_HAVE_SPIES, 0),
	GD_INT_INIT(ESPIONAGE_SECURITY_PREVIOUS_CITY_MISSIONS, 0),
	GD_INT_INIT(ESPIONAGE_SECURITY_PER_POPULATION, -2),
	GD_INT_INIT(ESPIONAGE_SECURITY_PER_POPULATION_BUILDING_SCALER, 360),
	GD_INT_INIT(ESPIONAGE_SECURITY_PER_TRADE_ROUTE, -5),
	...
	GD_INT_INIT(VASSALAGE_CAPITULATION_BASE_THRESHOLD, 100),
	GD_INT_INIT(VASSALAGE_VOLUNTARY_BASE_THRESHOLD, 100),
	GD_INT_INIT(VASSALAGE_LIBERATION_BASE_THRESHOLD, 100),
	GD_INT_INIT(VASSALAGE_INDEPENDENCE_BASE_THRESHOLD, 100),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(SQLITE_LOGGING_BATCHED_BUFFER_ROWS_MAX);
	...
	GD_INT_CACHE(NUM_CITIES_COST_MOD_SCALING);
	...
	GD_INT_CACHE(VASSALAGE_CAPITULATION_BASE_THRESHOLD);
	GD_INT_CACHE(VASSALAGE_VOLUNTARY_BASE_THRESHOLD);
	GD_INT_CACHE(VASSALAGE_LIBERATION_BASE_THRESHOLD);
	GD_INT_CACHE(VASSALAGE_INDEPENDENCE_BASE_THRESHOLD);
