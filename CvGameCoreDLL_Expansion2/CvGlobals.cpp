...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(QUEST_DISABLED_DISCOVER_AREA, 1),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_BASE, 10),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DISCOVER_AREA, 275),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_DISCOVER_AREA, 200),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DISCOVER_AREA, 50),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_ACQUIRE_CITY, 500),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_ACQUIRE_CITY, 300),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_ACQUIRE_CITY, 200),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_ACQUIRE_CITY, 25),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_ACQUIRE_CITY, 25),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(QUEST_DISABLED_DISCOVER_AREA);
	...
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_BASE);
	...
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_DISCOVER_AREA);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_DISCOVER_AREA);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_DISCOVER_AREA);
	...
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_ACQUIRE_CITY);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_HOSTILE_ACQUIRE_CITY);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_ACQUIRE_CITY);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_ACQUIRE_CITY);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_ACQUIRE_CITY);
