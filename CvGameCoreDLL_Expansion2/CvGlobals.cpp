...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(BALANCE_HAPPINESS_TECH_BASE_MODIFIER, 0),
	GD_INT_INIT(BALANCE_HAPPINESS_TECH_DEVIATION_MODIFIER, 0),
	...
	GD_FLOAT_INIT(BALANCE_UNHAPPINESS_FROM_UNCONNECTED_PER_POP, 0.33f),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(BALANCE_HAPPINESS_TECH_DEVIATION_MODIFIER);
