...
// -- ints --
	...
	m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE(5),
	m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT(5),
	m_iBALANCE_MAX_UNHAPPY_PER_CITY_YIELD(50),
...
void CvGlobals::cacheGlobals()
{
	...
	m_iBALANCE_MAX_UNHAPPY_PER_CITY_YIELD = getDefineINT("BALANCE_MAX_UNHAPPY_PER_CITY_YIELD");
