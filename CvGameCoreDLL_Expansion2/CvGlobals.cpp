...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(QUEST_DISABLED_TOURISM, 1),
	...
	GD_INT_INIT(QUEST_DISABLED_DISCOVER_PLOT, 1),
	GD_INT_INIT(QUEST_DISABLED_BUILD_X_BUILDINGS, 1),
	GD_INT_INIT(QUEST_DISABLED_UNIT_STEAL_FROM, 1),
	GD_INT_INIT(QUEST_DISABLED_UNIT_COUP_CITY, 1),
	GD_INT_INIT(QUEST_DISABLED_UNIT_GET_CITY, 1),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_FIND_CITY, 300),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_FIND_CITY, 200),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(QUEST_DISABLED_DISCOVER_PLOT);
	GD_INT_CACHE(QUEST_DISABLED_BUILD_X_BUILDINGS);
	GD_INT_CACHE(QUEST_DISABLED_UNIT_STEAL_FROM);
	GD_INT_CACHE(QUEST_DISABLED_UNIT_COUP_CITY);
	GD_INT_CACHE(QUEST_DISABLED_UNIT_GET_CITY);
	...
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MARITIME_FIND_CITY);
	GD_INT_CACHE(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MERCANTILE_FIND_CITY);
