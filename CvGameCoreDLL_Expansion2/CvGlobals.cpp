...
// -- ints --
	...
	m_iAI_MOSTLY_HAPPY_THRESHOLD(40),
#endif
	...
	m_iAI_CITY_VALUE_MULTIPLIER(100),
	m_iAI_CAPITAL_VALUE_MULTIPLIER(150),
	m_iAI_CITY_HIGH_VALUE_THRESHOLD(80),
	m_iAI_CITY_SOME_VALUE_THRESHOLD(40),
	m_iAI_CITY_PUPPET_BONUS_THRESHOLD(25),
	...
	GD_INT_INIT(WAR_PROGRESS_PER_UNHAPPY, -2),
...
void CvGlobals::cacheGlobals()
{
	...
	getDatabaseValue("AI_MOSTLY_HAPPY_THRESHOLD", m_iAI_MOSTLY_HAPPY_THRESHOLD);
#endif
	...
	getDatabaseValue("AI_CITY_VALUE_MULTIPLIER", m_iAI_CITY_VALUE_MULTIPLIER);
	getDatabaseValue("AI_CAPITAL_VALUE_MULTIPLIER", m_iAI_CAPITAL_VALUE_MULTIPLIER);
	getDatabaseValue("AI_CITY_HIGH_VALUE_THRESHOLD", m_iAI_CITY_HIGH_VALUE_THRESHOLD);
	getDatabaseValue("AI_CITY_SOME_VALUE_THRESHOLD", m_iAI_CITY_SOME_VALUE_THRESHOLD);
	getDatabaseValue("AI_CITY_PUPPET_BONUS_THRESHOLD", m_iAI_CITY_PUPPET_BONUS_THRESHOLD);
