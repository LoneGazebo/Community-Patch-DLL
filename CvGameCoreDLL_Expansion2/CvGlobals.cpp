...
// -- ints --
	...
	m_iOPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR(200),
...
void CvGlobals::cacheGlobals()
{
	...
	getDatabaseValue("OPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR",m_iOPINION_WEIGHT_WORLD_IDEOLOGY_VASSAL_DIVISOR);
