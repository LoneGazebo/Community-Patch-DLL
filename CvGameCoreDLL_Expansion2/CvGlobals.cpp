...
// -- ints --
	...
	m_iOPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL(-10),
...
void CvGlobals::cacheGlobals()
{
	...
	getDatabaseValue("OPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL",m_iOPINION_WEIGHT_DIPLOMAT_CAPITULATED_VASSAL);
