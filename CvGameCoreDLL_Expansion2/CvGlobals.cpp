...
// -- ints --
	...
	m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT(5),
	m_iBALANCE_UNHAPPY_CITY_BASE_VALUE(3),
	m_iBALANCE_TECH_RATE_CULTURE_SCIENCE(100),
	m_iBALANCE_TECH_RATE_DEFENSE(125),
	m_iBALANCE_TECH_RATE_FOOD_GOLD(150),
...
void CvGlobals::cacheGlobals()
{
	...
	m_iBALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT = getDefineINT("BALANCE_HAPPINESS_ERA_BASE_INCREASE_CITY_COUNT");
	m_iBALANCE_UNHAPPY_CITY_BASE_VALUE = getDefineINT("BALANCE_UNHAPPY_CITY_BASE_VALUE");
	m_iBALANCE_TECH_RATE_CULTURE_SCIENCE = getDefineINT("BALANCE_TECH_RATE_CULTURE_SCIENCE");
	m_iBALANCE_TECH_RATE_DEFENSE = getDefineINT("BALANCE_TECH_RATE_DEFENSE");
	m_iBALANCE_TECH_RATE_FOOD_GOLD = getDefineINT("BALANCE_TECH_RATE_FOOD_GOLD");
