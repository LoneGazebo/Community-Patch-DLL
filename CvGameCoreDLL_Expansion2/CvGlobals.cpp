...
// -- ints --
	...
	m_iOPINION_WEIGHT_DIFFERENT_MAJORITY_RELIGIONS(4),
	...
	m_iOPINION_WEIGHT_WONDER_SPAMMER(30),
	m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT(20),
	...
	m_iAPPROACH_NEUTRAL_BASE_HUMAN(0),
	m_iAPPROACH_FRIENDLY_BASE_HUMAN(0),
	m_iAPPROACH_AFRAID_BASE_HUMAN(0),
	m_iAPPROACH_GUARDED_BASE_HUMAN(0),
	m_iAPPROACH_DECEPTIVE_BASE_HUMAN(0),
	m_iAPPROACH_HOSTILE_BASE_HUMAN(0),
	m_iAPPROACH_WAR_BASE_HUMAN(0),
	m_iAPPROACH_NEUTRAL_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_FRIENDLY_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_AFRAID_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_GUARDED_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_DECEPTIVE_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_HOSTILE_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_WAR_BASE_HUMAN_PERCENT(0),
	m_iAPPROACH_NEUTRAL_BASE_AI(0),
	m_iAPPROACH_FRIENDLY_BASE_AI(0),
	m_iAPPROACH_AFRAID_BASE_AI(0),
	m_iAPPROACH_GUARDED_BASE_AI(0),
	m_iAPPROACH_DECEPTIVE_BASE_AI(0),
	m_iAPPROACH_HOSTILE_BASE_AI(0),
	m_iAPPROACH_WAR_BASE_AI(0),
	m_iAPPROACH_NEUTRAL_BASE_AI_PERCENT(0),
	m_iAPPROACH_FRIENDLY_BASE_AI_PERCENT(0),
	m_iAPPROACH_AFRAID_BASE_AI_PERCENT(0),
	m_iAPPROACH_GUARDED_BASE_AI_PERCENT(0),
	m_iAPPROACH_DECEPTIVE_BASE_AI_PERCENT(0),
	m_iAPPROACH_HOSTILE_BASE_AI_PERCENT(0),
	m_iAPPROACH_WAR_BASE_AI_PERCENT(0),
	...
	GD_INT_INIT(HW_DEBUG_ENABLED, 0),
...
void CvGlobals::cacheGlobals()
{
	...
	m_iOPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT = getDefineINT("OPINION_WEIGHT_WONDER_SPAMMER_STRATEGIC_THREAT");
	...
	m_iAPPROACH_NEUTRAL_BASE_HUMAN = getDefineINT("APPROACH_NEUTRAL_BASE_HUMAN");
	m_iAPPROACH_FRIENDLY_BASE_HUMAN = getDefineINT("APPROACH_FRIENDLY_BASE_HUMAN");
	m_iAPPROACH_AFRAID_BASE_HUMAN = getDefineINT("APPROACH_AFRAID_BASE_HUMAN");
	m_iAPPROACH_GUARDED_BASE_HUMAN = getDefineINT("APPROACH_GUARDED_BASE_HUMAN");
	m_iAPPROACH_DECEPTIVE_BASE_HUMAN = getDefineINT("APPROACH_DECEPTIVE_BASE_HUMAN");
	m_iAPPROACH_HOSTILE_BASE_HUMAN = getDefineINT("APPROACH_HOSTILE_BASE_HUMAN");
	m_iAPPROACH_WAR_BASE_HUMAN = getDefineINT("APPROACH_WAR_BASE_HUMAN");
	m_iAPPROACH_NEUTRAL_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_NEUTRAL_BASE_HUMAN_PERCENT");
	m_iAPPROACH_FRIENDLY_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_FRIENDLY_BASE_HUMAN_PERCENT");
	m_iAPPROACH_AFRAID_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_AFRAID_BASE_HUMAN_PERCENT");
	m_iAPPROACH_GUARDED_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_GUARDED_BASE_HUMAN_PERCENT");
	m_iAPPROACH_DECEPTIVE_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_DECEPTIVE_BASE_HUMAN_PERCENT");
	m_iAPPROACH_HOSTILE_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_HOSTILE_BASE_HUMAN_PERCENT");
	m_iAPPROACH_WAR_BASE_HUMAN_PERCENT = getDefineINT("APPROACH_WAR_BASE_HUMAN_PERCENT");
	m_iAPPROACH_NEUTRAL_BASE_AI = getDefineINT("APPROACH_NEUTRAL_BASE_AI");
	m_iAPPROACH_FRIENDLY_BASE_AI = getDefineINT("APPROACH_FRIENDLY_BASE_AI");
	m_iAPPROACH_AFRAID_BASE_AI = getDefineINT("APPROACH_AFRAID_BASE_AI");
	m_iAPPROACH_GUARDED_BASE_AI = getDefineINT("APPROACH_GUARDED_BASE_AI");
	m_iAPPROACH_DECEPTIVE_BASE_AI = getDefineINT("APPROACH_DECEPTIVE_BASE_AI");
	m_iAPPROACH_HOSTILE_BASE_AI = getDefineINT("APPROACH_HOSTILE_BASE_AI");
	m_iAPPROACH_WAR_BASE_AI = getDefineINT("APPROACH_WAR_BASE_AI");
	m_iAPPROACH_NEUTRAL_BASE_AI_PERCENT = getDefineINT("APPROACH_NEUTRAL_BASE_AI_PERCENT");
	m_iAPPROACH_FRIENDLY_BASE_AI_PERCENT = getDefineINT("APPROACH_FRIENDLY_BASE_AI_PERCENT");
	m_iAPPROACH_AFRAID_BASE_AI_PERCENT = getDefineINT("APPROACH_AFRAID_BASE_AI_PERCENT");
	m_iAPPROACH_GUARDED_BASE_AI_PERCENT = getDefineINT("APPROACH_GUARDED_BASE_AI_PERCENT");
	m_iAPPROACH_DECEPTIVE_BASE_AI_PERCENT = getDefineINT("APPROACH_DECEPTIVE_BASE_AI_PERCENT");
	m_iAPPROACH_HOSTILE_BASE_AI_PERCENT = getDefineINT("APPROACH_HOSTILE_BASE_AI_PERCENT");
	m_iAPPROACH_WAR_BASE_AI_PERCENT = getDefineINT("APPROACH_WAR_BASE_AI_PERCENT");
