...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_BASE, 5),
	GD_INT_INIT(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MILITARISTIC, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MARITIME, 22),
	GD_INT_INIT(MINOR_CIV_QUEST_EXPLORE_AREA_COPIES_MERCANTILE, 15),
	...
	GD_INT_INIT(WAR_MINOR_PEACE_BLOCKED_TURNS, 1),
	...
	GD_INT_INIT(UNIT_SUPPLY_WAR_WEARINESS_PERCENT_REDUCTION, 50),
	GD_INT_INIT(UNIT_SUPPLY_WAR_WEARINESS_REDUCTION_MAX, 75),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(UNIT_SUPPLY_WAR_WEARINESS_REDUCTION_MAX);
