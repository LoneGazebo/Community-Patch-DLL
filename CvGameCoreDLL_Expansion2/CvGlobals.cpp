...
// -- ints --
	...
	GD_INT_INIT(DIPLOAI_PASSIVE_MODE_HUMANS, 0),
	GD_INT_INIT(DIPLOAI_PASSIVE_MODE_GLOBAL, 0),
	GD_INT_INIT(DIPLOAI_AGGRESSIVE_MODE_HUMANS, 0),
	GD_INT_INIT(DIPLOAI_AGGRESSIVE_MODE_GLOBAL, 0),
...
void CvGlobals::cacheGlobals()
{
	...
	m_iCOOP_WAR_DESIRE_THRESHOLD = getDefineINT("COOP_WAR_DESIRE_THRESHOLD");
	...
	m_iVICTORY_BLOCK_FIERCE_THRESHOLD = getDefineINT("VICTORY_BLOCK_FIERCE_THRESHOLD");
	m_iVICTORY_BLOCK_STRONG_THRESHOLD = getDefineINT("VICTORY_BLOCK_STRONG_THRESHOLD");
	m_iVICTORY_BLOCK_WEAK_THRESHOLD = getDefineINT("VICTORY_BLOCK_WEAK_THRESHOLD");
	...
	m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_POSITIVE = getDefineINT("VICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_POSITIVE");
	m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_LIKELY = getDefineINT("VICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_LIKELY");
	m_iVICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_UNSURE = getDefineINT("VICTORY_BLOCK_GRAND_STRATEGY_DIFFERENCE_UNSURE");
	...
	m_iPILLAGED_TILE_BASE_WAR_VALUE = getDefineINT("PILLAGED_TILE_BASE_WAR_VALUE");
	m_iSTOLEN_TILE_BASE_WAR_VALUE = getDefineINT("STOLEN_TILE_BASE_WAR_VALUE");
	...
	GD_INT_CACHE(DIPLOAI_PASSIVE_MODE_HUMANS);
	GD_INT_CACHE(DIPLOAI_PASSIVE_MODE_GLOBAL);
	GD_INT_CACHE(DIPLOAI_AGGRESSIVE_MODE_HUMANS);
	GD_INT_CACHE(DIPLOAI_AGGRESSIVE_MODE_GLOBAL);
