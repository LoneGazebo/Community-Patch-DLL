...
// -- ints --
	...
	m_iMINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_PLEDGE_TO_PROTECT(300),
	 ...
	 m_iCSD_GAME_DIFFICULTY_MULTIPLIER(0),
#endif
	...
	m_iBALANCE_BARARIAN_HEAL_RATE(10),
#endif
...
void CvGlobals::cacheGlobals()
{
	...
	if (MOD_DIPLOMACY_CITYSTATES_QUESTS) {
		...
		m_iSPY_TO_MINOR_RATIO = getDefineINT("SPY_TO_MINOR_RATIO");
		...
		m_iCSD_GAME_DIFFICULTY_MULTIPLIER = getDefineINT("CSD_GAME_DIFFICULTY_MULTIPLIER");
	}
#endif
	...
	m_iBALANCE_BARARIAN_HEAL_RATE = getDefineINT("BALANCE_BARARIAN_HEAL_RATE");
	}
#endif
	// -- floats --
