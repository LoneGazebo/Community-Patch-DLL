...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(MINOR_CIV_QUEST_FIND_CITY_COPIES_MERCANTILE, 10),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_COPIES_BASE, 15),
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_COPIES_CULTURED, 40),
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_COPIES_MILITARISTIC, 70),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_COPIES_HOSTILE, 50),
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_COPIES_IRRATIONAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_BASE, 7),
	GD_INT_INIT(MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER_COPIES_CULTURED, 23),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_BASE, 7),
	GD_INT_INIT(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_MILITARISTIC, 13),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT_COPIES_HOSTILE, 0),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_MARITIME, 1),
	GD_INT_INIT(MINOR_CIV_QUEST_FIND_CITY_STATE_COPIES_MERCANTILE, 2),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_BASE, 5),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_MILITARISTIC, 55),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_MARITIME, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_MERCANTILE, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_RELIGIOUS, 45),
	GD_INT_INIT(MINOR_CIV_QUEST_LIBERATION_COPIES_FRIENDLY, 35),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_BASE, 5),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MILITARISTIC, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MARITIME, 22),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MERCANTILE, 15),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_RELIGIOUS, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_FRIENDLY, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_NEUTRAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_HOSTILE, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_IRRATIONAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_BASE, 15),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_MERCANTILE, 5),
	GD_INT_INIT(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_RELIGIOUS, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_BUILD_X_BUILDINGS_COPIES_FRIENDLY, 5),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_BASE, 7),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_CULTURED, 8),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MILITARISTIC, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MARITIME, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_MERCANTILE, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_RELIGIOUS, -2),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_FRIENDLY, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_NEUTRAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_HOSTILE, 28),
	GD_INT_INIT(MINOR_CIV_QUEST_SPY_ON_MAJOR_COPIES_IRRATIONAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_BASE, 15),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_CULTURED, -8),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_MILITARISTIC, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_MARITIME, 8),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_MERCANTILE, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_RELIGIOUS, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_FRIENDLY, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_NEUTRAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_HOSTILE, 30),
	GD_INT_INIT(MINOR_CIV_QUEST_COUP_COPIES_IRRATIONAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_BASE, 2),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MILITARISTIC, 48),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MARITIME, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_MERCANTILE, 18),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_RELIGIOUS, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_FRIENDLY, -35),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_NEUTRAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ACQUIRE_CITY_COPIES_HOSTILE, 25),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_BASE, 10),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_CULTURED, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MILITARISTIC, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MARITIME, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_MERCANTILE, -5),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_FAITH_COPIES_RELIGIOUS, 10),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_COPIES_BASE, 7),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_COPIES_FRIENDLY, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_COPIES_NEUTRAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_COPIES_HOSTILE, -2),
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_COPIES_IRRATIONAL, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_BASE, 10),
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_CULTURED, 0),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_CONTEST_TOURISM_COPIES_FRIENDLY, 3),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_BASE, 7),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_CULTURED, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MILITARISTIC, 18),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MARITIME, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_MERCANTILE, 0),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_COPIES_RELIGIOUS, 23),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_CIRCUMNAVIGATION_COPIES_MARITIME, 15),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_REBELLION_COPIES_BASE, 70),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_BASE);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_CULTURED);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MILITARISTIC);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MARITIME);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_MERCANTILE);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_RELIGIOUS);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_FRIENDLY);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_NEUTRAL);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_HOSTILE);
	GD_INT_CACHE(MINOR_CIV_QUEST_DISCOVER_AREA_COPIES_IRRATIONAL);
