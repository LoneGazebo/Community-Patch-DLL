...
// -- post defines --
	...
	m_fOPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD(1.5),
...
void CvGlobals::cacheGlobals()
{
	...
	if (MOD_DIPLOMACY_CIV4_FEATURES) {
		...
		m_fOPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD = getDefineFLOAT("OPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD");
