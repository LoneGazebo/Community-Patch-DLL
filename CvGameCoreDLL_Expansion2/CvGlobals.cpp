...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(SUPER_UNHAPPY_GROWTH_PENALTY, -100),
	...
	GD_INT_INIT(UNHAPPY_SETTLER_PRODUCTION_PENALTY, -25),
	GD_INT_INIT(VERY_UNHAPPY_SETTLER_PRODUCTION_PENALTY, -50),
	GD_INT_INIT(SUPER_UNHAPPY_SETTLER_PRODUCTION_PENALTY, -75),
	...
	GD_INT_INIT(CITY_SIZE_NEED_MODIFIER, -100),
	GD_INT_INIT(EMPIRE_SIZE_NEED_MODIFIER_CITIES, 900),
	GD_INT_INIT(EMPIRE_SIZE_NEED_MODIFIER_POP, 100),
	...
	GD_INT_INIT(BARBARIAN_CAMP_MINIMUM_DISTANCE_RECENTLY_CLEARED_CAMP, 3),
	...
	GD_FLOAT_INIT(UNHAPPINESS_PER_ISOLATED_POP, 0.33f),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(SUPER_UNHAPPY_GROWTH_PENALTY);
	...
	GD_INT_CACHE(UNHAPPY_SETTLER_PRODUCTION_PENALTY);
	GD_INT_CACHE(VERY_UNHAPPY_SETTLER_PRODUCTION_PENALTY);
	GD_INT_CACHE(SUPER_UNHAPPY_SETTLER_PRODUCTION_PENALTY);
