...
// -- ints --
	...
	m_iRECKLESS_EXPANDER_THRESHOLD(200),
	...
	m_iOPINION_WEIGHT_WONDER_SPAMMER_PER_WONDER(10),
...
void CvGlobals::cacheGlobals()
{
	...
	m_iRECKLESS_EXPANDER_THRESHOLD = getDefineINT("RECKLESS_EXPANDER_THRESHOLD");
