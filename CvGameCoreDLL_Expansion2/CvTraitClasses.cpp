...
{
	ASSERT(eIndex1 < GC.getNumImprovementInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumTerrainInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumPlotInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT((int)eDomain < NUM_DOMAIN_TYPES, "Index out of bounds");
	ASSERT((int)eDomain > -1, "Index out of bounds");
...
{
	ASSERT((int)eUnitClass < GC.getNumUnitClassInfos(), "Index out of bounds");
	ASSERT((int)eUnitClass > -1, "Index out of bounds");
...
{
	ASSERT(eIndex < NUM_YIELD_TYPES, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumBuildingClassInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumFeatureInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumResourceInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT((int)eYield < NUM_YIELD_TYPES, "Yield type out of bounds");
	ASSERT((int)eYield > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < NUM_DOMAIN_TYPES, "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumSpecialistInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT(eIndex1 < GC.getNumGreatPersonInfos(), "Index out of bounds");
	ASSERT(eIndex1 > -1, "Index out of bounds");
	ASSERT(eIndex2 < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(eIndex2 > -1, "Index out of bounds");
...
{
	ASSERT((int)eGreatPerson < GC.getNumGreatPersonInfos(), "Yield type out of bounds");
	ASSERT((int)eGreatPerson > -1, "Index out of bounds");
...
{
	ASSERT((int)eIndex < GC.getNumGreatPersonInfos(), "Yield type out of bounds");
	ASSERT((int)eIndex > -1, "Index out of bounds");
...
int CvTraitEntry::GetMovesChangeUnitCombat(const int unitCombatID) const
{
	...
	ASSERT((unitCombatID < GC.getNumUnitCombatClassInfos()), "unitCombatID exceeds number of combat classes");
...
int CvTraitEntry::GetMovesChangeUnitClass(const int unitClassID) const
{
	...
	ASSERT((unitClassID < GC.getNumUnitClassInfos()), "unitCombatID exceeds number of combat classes");
...
{
	ASSERT(iYield < NUM_YIELD_TYPES, "Index out of bounds");
	ASSERT(iYield > -1, "Index out of bounds");
...
{
	ASSERT(unitCombatID >= 0, "unitCombatID expected to be >= 0");
	ASSERT(unitCombatID < GC.getNumUnitCombatClassInfos(), "unitCombatID expected to be < GC.getNumUnitCombatInfos()");
...
{
	ASSERT(eDomain >= 0, "domainID expected to be >= 0");
	ASSERT(eDomain < NUM_DOMAIN_TYPES, "domainID expected to be < NUM_DOMAIN_TYPES");
...
//			ASSERT(iUnitCombatID > -1 && iUnitCombatID < iNumUnitClasses);
...
{
	ASSERT(unitCombatID < GC.getNumUnitCombatClassInfos(),  "Invalid unitCombatID parameter in call to CvPlayerTraits::GetMovesChangeUnitCombat()");
...
{
	ASSERT(unitClassID < GC.getNumUnitClassInfos(),  "Invalid unitClassID parameter in call to CvPlayerTraits::GetMovesChangeUnitClass()");
...
{
	ASSERT(unitCombatID < GC.getNumUnitCombatClassInfos(),  "Invalid unitCombatID parameter in call to CvPlayerTraits::GetMaintenanceModifierUnitCombat()");
...
{
	ASSERT(eImprovement < GC.getNumImprovementInfos(),  "Invalid eImprovement parameter in call to CvPlayerTraits::GetImprovementYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetImprovementYieldChange()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(),  "Invalid eImprovement parameter in call to CvPlayerTraits::GetYieldChangeFromTileEarnTerrainType()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTileEarnTerrainType()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(), "Invalid eTerrain parameter in call to CvPlayerTraits::GetYieldChangeFromTilePurchaseTerrainType()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTilePurchaseTerrainType()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(), "Invalid eTerrain parameter in call to CvPlayerTraits::GetYieldChangeFromTileConquest()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTileConquest()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(), "Invalid eTerrain parameter in call to CvPlayerTraits::GetYieldChangeFromTileCultureBomb()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTileCultureBomb()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(), "Invalid eTerrain parameter in call to CvPlayerTraits::GetYieldChangeFromTileStealCultureBomb()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTileStealCultureBomb()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(), "Invalid eTerrain parameter in call to CvPlayerTraits::GetYieldChangeFromTileSettle()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangeFromTileSettle()");
...
{
	ASSERT(eImprovement < GC.getNumImprovementInfos(), "Invalid eImprovement parameter in call to CvPlayerTraits::GetYieldChangePerImprovementBuilt()");
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldChangePerImprovementBuilt()");
...
{
	ASSERT(eYield < NUM_YIELD_TYPES, "Invalid eYield parameter in call to CvPlayerTraits::GetYieldFromBarbarianCampClear()");
...
{
	ASSERT(ePlot < GC.getNumPlotInfos(),  "Invalid ePlot parameter in call to CvPlayerTraits::GetPlotYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetPlotYieldChange()");
...
{
	ASSERT(eBuildingClass < GC.getNumBuildingClassInfos(),  "Invalid eBuildingClass parameter in call to CvPlayerTraits::GetBuildingClassYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetBuildingClassYieldChange()");
...
{
	ASSERT(eFeature < GC.getNumFeatureInfos(),  "Invalid eFeature parameter in call to CvPlayerTraits::GetFeatureYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetFeatureYieldChange()");
...
{
	ASSERT(eResource < GC.getNumResourceInfos(),  "Invalid eResource parameter in call to CvPlayerTraits::GetResourceYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetResourceYieldChange()");
...
{
	ASSERT(eTerrain < GC.getNumTerrainInfos(),  "Invalid eTerrain parameter in call to CvPlayerTraits::GetTerrainYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetTerrainYieldChange()");
...
{
	ASSERT(eDomain < NUM_DOMAIN_TYPES,  "Invalid eDomain parameter in call to CvPlayerTraits::GetDomainYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetDomainYieldChange()");
...
{
	ASSERT(eSpecialist < GC.getNumSpecialistInfos(),  "Invalid eSpecialist parameter in call to CvPlayerTraits::GetSpecialistYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetSpecialistYieldChange()");
...
{
	ASSERT(eGreatPerson < GC.getNumGreatPersonInfos(), "Invalid eGreatPerson parameter in call to CvPlayerTraits::GetGreatPersonExpendedYield()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetGreatPersonExpendedYield()");
...
{
	ASSERT(eGreatPerson < GC.getNumGreatPersonInfos(),  "Invalid eGreatPerson parameter in call to CvPlayerTraits::GetGreatPersonBornYield()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetGreatPersonBornYield()");
...
{
	ASSERT(eFeature < GC.getNumFeatureInfos(),  "Invalid eImprovement parameter in call to CvPlayerTraits::GetCityYieldFromUnimprovedFeature()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetCityYieldFromUnimprovedFeature()");
...
{
	ASSERT(eFeature < GC.getNumFeatureInfos(),  "Invalid eImprovement parameter in call to CvPlayerTraits::GetUnimprovedFeatureYieldChange()");
	ASSERT(eYield < NUM_YIELD_TYPES,  "Invalid eYield parameter in call to CvPlayerTraits::GetUnimprovedFeatureYieldChange()");
...
{
	ASSERT(eUnitCombat >= 0, "unitCombatID expected to be >= 0");
	ASSERT(eUnitCombat < GC.getNumUnitCombatClassInfos(), "unitCombatID expected to be < GC.getNumUnitCombatInfos()");
...
{
	ASSERT(eBuild >= 0, "buildID expected to be >= 0");
	ASSERT(eBuild < GC.getNumBuildInfos(), "buildID expected to be < GC.getNumBuildInfos()");
...
bool CvPlayerTraits::ConvertBarbarianCamp(CvUnit* pByUnit, CvPlot* pPlot)
{
	...
	if (GC.getGame().randRangeInclusive(1, 100, CvSeeder::fromRaw(0x960ab208).mix(pByUnit->GetID()).mix(pPlot->GetPseudoRandomSeed())) <= m_iLandBarbarianConversionPercent)
	{
		...
		ASSERT(m_eCampGuardType < GC.getNumUnitInfos(), "Illegal camp guard unit type");
