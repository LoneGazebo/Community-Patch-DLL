...
bool CvPromotionEntry::CacheResults(Database::Results& kResults, CvDatabaseUtility& kUtility)
{
	...
	//UnitPromotions_Terrains
	{
		...
		CvAssert(pResults); if(!pResults) return false;
...
/// Assigns promotion 1 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
int CvPromotionEntry::GetPrereqOrPromotion1() const
{
	return m_iPrereqOrPromotion1;
}

/// Assigns promotion 2 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
void CvPromotionEntry::SetPrereqOrPromotion1(int i)
{
	m_iPrereqOrPromotion1 = i;
}

/// Accessor: Gets promotion 1 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
int CvPromotionEntry::GetPrereqOrPromotion2() const
{
	return m_iPrereqOrPromotion2;
}

/// Accessor: Gets promotion 2 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
void CvPromotionEntry::SetPrereqOrPromotion2(int i)
{
	m_iPrereqOrPromotion2 = i;
}

/// Assigns promotion 3 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
...
/// Assigns promotion 4 of an either/or promotion prerequisite. A promotion would either need promotion 1 or promotion 2 to get this promotion.
...
bool CvPromotionEntry::IsEmbarkedNotCivilian() const
{
...
bool CvUnitPromotions::GetAllowFeaturePassable(FeatureTypes eFeatureType) const
{
	...
	CvAssert(teamTechs); if(!teamTechs) return false;
