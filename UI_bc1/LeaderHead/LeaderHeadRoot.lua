...
--	local diploCivInfo = GameInfo.Civilizations[ g_diploPlayer:GetCivilizationType() ]
	...
	Controls.MoodText:SetToolTipString( GetMoodInfo(diploPlayerID) )
	-- /Mood
...
print( "Handling LeaderMessage: ", diploPlayerID, diploUIstateID, diploMessage, diploData )
	diploProcess = g_diploProcesses[ diploUIstateID ]
...
print( "AILeaderMessageRestart", isAILeaderMessageNotRestarted, g_diploPlayerID, g_diploUIstateID, message, g_diploData )
...
print( "blank discussion", diploProcess and diploUIstateID ~= g_diploUIstateID and g_canGoBack and diploPlayerID == g_diploPlayerID, diploProcess, diploUIstateID, g_diploUIstateID, g_canGoBack, diploPlayerID, g_diploPlayerID )
		if diploProcess and diploUIstateID ~= g_diploUIstateID and g_canGoBack and diploPlayerID == g_diploPlayerID then
			g_diploProcess = diploProcess
