...
UPDATE Language_en_US
SET Text = '+1 [ICON_PEACE] Faith for every 2 [ICON_CITIZEN] Citizens in the City.[NEWLINE][NEWLINE]Reduces [ICON_HAPPINESS_3] Religious Unrest, doubles Religious Pressure generated by Trade Routes, and generates +25% Religious Pressure.[NEWLINE]Nearby [ICON_RES_INCENSE] Incense: +1 [ICON_CULTURE] Culture, +1 [ICON_PEACE] Faith.[NEWLINE]Nearby [ICON_RES_WINE] Wine: +1 [ICON_CULTURE] Culture, +1 [ICON_PEACE] Faith.[NEWLINE]Nearby [ICON_RES_AMBER] Amber: +1 [ICON_CULTURE] Culture, +1 [ICON_PEACE] Faith.'
...
UPDATE Language_en_US
SET Text = 'Whenever you destroy an enemy unit, produce +5 [ICON_GREAT_GENERAL] Great General points and +5 [ICON_GOLDEN_AGE] Golden Age points. [ICON_CITY_CONNECTED] City Connections produce +2% more [ICON_GOLD] Gold. Reduces [ICON_HAPPINESS_3] Boredom slightly. Barracks, Forge, and Armory in City: +2 [ICON_PRODUCTION] Production.[NEWLINE]Nearby [ICON_RES_PERFUME] Perfume: +2 [ICON_CULTURE] Culture.[NEWLINE]Nearby [ICON_RES_OLIVE] Olives: +1 [ICON_FOOD] Food, +1 [ICON_GOLD] Gold.'
