...
VALUES
	...
	('UNIT_FRENCH_MUSKETEER', 'PROMOTION_NAVAL_MISFIRE'),
	('UNIT_MUSKETMAN', 'PROMOTION_NAVAL_MISFIRE'),
	('UNIT_AMERICAN_MINUTEMAN', 'PROMOTION_ONLY_DEFENSIVE'),
	('UNIT_FRENCH_MUSKETEER', 'PROMOTION_ONLY_DEFENSIVE'),
	...
	UPDATE Units SET PrereqTech = 'TECH_METALLURGY' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET ObsoleteTech = 'TECH_BALLISTICS' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET Range = '2' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET CombatClass = 'UNITCOMBAT_ARCHER' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
