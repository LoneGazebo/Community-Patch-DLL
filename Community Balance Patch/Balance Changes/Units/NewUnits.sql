...
VALUES
	...
	('UNIT_GUERILLA', 'PROMOTION_SNEAK_ATTACK');
...
INSERT INTO Units
	(Class, Type, Combat, Cost, FaithCost, RequiresFaithPurchaseEnabled, Moves, PrereqTech, ObsoleteTech, CombatClass, Domain, NoBadGoodies, DefaultUnitAI, Description, Civilopedia, Strategy, Help, Pillage, MilitarySupport, GoodyHutUpgradeUnitClass, MilitaryProduction, AdvancedStartCost, XPValueAttack, XPValueDefense, UnitArtInfo, UnitFlagAtlas, UnitFlagIconOffset, PortraitIndex, IconAtlas, MoveRate)
VALUES
	('UNITCLASS_EXPLORER', 'UNIT_EXPLORER', 16, 180, 200, 1, 3, 'TECH_COMPASS', 'TECH_STEAM_POWER', 'UNITCOMBAT_RECON', 'DOMAIN_LAND', 1, 'UNITAI_EXPLORE', 'TXT_KEY_UNIT_EXPLORER_CBP', 'TXT_KEY_CIV5_EXPLORER_TEXT_CBP', 'TXT_KEY_UNIT_EXPLORER_STRATEGY_CBP', 'TXT_KEY_UNIT_HELP_EXPLORER_CBP', 1, 1, 'UNITCLASS_ZEPPELIN', 1, 30, 3, 3, 'ART_DEF_UNIT_U_SPANISH_TERCIO', 'EXPANSION2_UNIT_FLAG_ATLAS', 5, 58, 'COMMUNITY_ATLAS', 'WHEELED'),
	('UNITCLASS_ZEPPELIN', 'UNIT_ZEPPELIN', 25, 300, 300, 1, 3, 'TECH_STEAM_POWER', 'TECH_ROCKETRY', 'UNITCOMBAT_RECON', 'DOMAIN_LAND', 1, 'UNITAI_EXPLORE', 'TXT_KEY_UNIT_ZEPPELIN_CBP', 'TXT_KEY_CIV5_ZEPPELIN_TEXT_CBP', 'TXT_KEY_UNIT_ZEPPELIN_STRATEGY_CBP', 'TXT_KEY_UNIT_HELP_ZEPPELIN_CBP', 1, 1, 'UNITCLASS_PARATROOPER', 1, 30, 3, 3, 'ART_DEF_UNIT_SMOKEY_STEAM_AIRSHIP_LEVEL_1', 'EXPANSION_SCEN_UNIT_FLAG_ATLAS', 7, 7, 'EXPANSION_SCEN_UNIT_ATLAS', 'WHEELED');
...
VALUES
	...
	INSERT INTO Units
	(Class, Type, Moves, Capture, CivilianAttackPriority, HurryCostModifier, Domain, DefaultUnitAI, Description, Civilopedia, Strategy, Help, PrereqTech, ObsoleteTech, Food, Found, FoundMid, CombatLimit, UnitArtInfo, UnitArtInfoCulturalVariation, PortraitIndex, IconAtlas)
VALUES
	('UNITCLASS_PIONEER', 'UNIT_PIONEER', 3, 'UNITCLASS_WORKER', 'CIVILIAN_ATTACK_PRIORITY_HIGH_EARLY_GAME_ONLY', -1, 'DOMAIN_LAND', 'UNITAI_SETTLE', 'TXT_KEY_UNIT_PIONEER', 'TXT_KEY_CIV5_PIONEER_TEXT', 'TXT_KEY_UNIT_PIONEER_STRATEGY', 'TXT_KEY_UNIT_HELP_PIONEER', 'TECH_BANKING', 'TECH_BIOLOGY', 1, 1, 1, 0, 'ART_DEF_UNIT__SETTLER', 1, 2, 'COMMUNITY_ATLAS'),
	('UNITCLASS_COLONIST', 'UNIT_COLONIST', 4, 'UNITCLASS_WORKER', 'CIVILIAN_ATTACK_PRIORITY_HIGH_EARLY_GAME_ONLY', -1, 'DOMAIN_LAND', 'UNITAI_SETTLE', 'TXT_KEY_UNIT_COLONIST', 'TXT_KEY_CIV5_COLONIST_TEXT', 'TXT_KEY_UNIT_COLONIST_STRATEGY', 'TXT_KEY_UNIT_HELP_COLONIST', 'TECH_BIOLOGY', NULL, 1, 1, 0, 0, 'ART_DEF_UNIT__SETTLER', 1, 5, 'EXPANSION2_UNIT_ATLAS');
