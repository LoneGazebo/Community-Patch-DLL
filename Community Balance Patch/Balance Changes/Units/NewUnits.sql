...
VALUES
	('UNITCLASS_EXPLORER', 'UNIT_EXPLORER', 16, 	0, 				0, 		180, 	200, 		1, 								3, 		3, 				'TECH_COMPASS', 	'TECH_RAILROAD', 	'UNITCOMBAT_RECON', 'DOMAIN_LAND', 	1, 				'UNITAI_EXPLORE', 		'TXT_KEY_UNIT_EXPLORER_CBP', 	'TXT_KEY_CIV5_EXPLORER_TEXT_CBP', 	'TXT_KEY_UNIT_EXPLORER_STRATEGY_CBP', 	'TXT_KEY_UNIT_HELP_EXPLORER_CBP', 	1, 		1, 					'UNITCLASS_ZEPPELIN', 		1, 					30, 				3, 				3, 				'ART_DEF_UNIT_EXPLORER_CBP', 					'EXPANSION2_UNIT_FLAG_ATLAS', 		5, 					58, 			'COMMUNITY_ATLAS', 				'BIPED'),
