-- NAVAL UNITS
	...
	UPDATE Unit_Flavors SET Flavor = '12' WHERE UnitType = 'UNIT_BYZANTINE_DROMON' AND FlavorType = 'FLAVOR_NAVAL';
	UPDATE Unit_Flavors SET Flavor = '16' WHERE UnitType = 'UNIT_GALLEASS' AND FlavorType = 'FLAVOR_NAVAL';
	UPDATE Unit_Flavors SET Flavor = '25' WHERE UnitType = 'UNIT_FRIGATE' AND FlavorType = 'FLAVOR_NAVAL';
	UPDATE Unit_Flavors SET Flavor = '45' WHERE UnitType = 'UNIT_ENGLISH_SHIPOFTHELINE' AND FlavorType = 'FLAVOR_NAVAL';
	...
	UPDATE Unit_Flavors SET Flavor = '60' WHERE UnitType = 'UNIT_MISSILE_CRUISER' AND FlavorType = 'FLAVOR_NAVAL';
	...
	UPDATE Unit_Flavors SET Flavor = '6' WHERE UnitType = 'UNIT_BYZANTINE_DROMON' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors	SET Flavor = '8' WHERE UnitType = 'UNIT_GALLEASS' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors SET Flavor = '12' WHERE UnitType = 'UNIT_FRIGATE' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors SET Flavor = '20' WHERE UnitType = 'UNIT_ENGLISH_SHIPOFTHELINE' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors SET Flavor = '25' WHERE UnitType = 'UNIT_CRUISER' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors SET Flavor = '30' WHERE UnitType = 'UNIT_MISSILE_CRUISER' AND FlavorType = 'FLAVOR_NAVAL_RECON';
	UPDATE Unit_Flavors SET Flavor = '35' WHERE UnitType = 'UNIT_CARRIER';
