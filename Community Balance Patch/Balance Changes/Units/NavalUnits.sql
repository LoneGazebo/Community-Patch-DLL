-- NAVAL UNITS
	...
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_CRUISER' , 'PROMOTION_NAVAL_RANGE' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_BATTLESHIP' , 'PROMOTION_NAVAL_RANGE' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
	...
	UPDATE Units SET Range = '1' WHERE Type = 'UNIT_BATTLESHIP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
