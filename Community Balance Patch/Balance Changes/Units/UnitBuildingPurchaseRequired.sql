...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_BYZANTINE_CATAPHRACT','BUILDINGCLASS_STABLE'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CHARIOT_ARCHER','BUILDINGCLASS_STABLE'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_GREEK_HOPLITE','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_HORSEMAN','BUILDINGCLASS_STABLE'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_PERSIAN_IMMORTAL','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CELT_PICTISH_WARRIOR','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_ASSYRIAN_SIEGE_TOWER','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_INCAN_SLINGER','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_SPEARMAN','BUILDINGCLASS_BARRACKS'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_EGYPTIAN_WARCHARIOT','BUILDINGCLASS_STABLE'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_ELEPHANT_RIDER','BUILDINGCLASS_STABLE'; 
-- Classical 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_ARABIAN_CAMELARCHER','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CARAVEL','BUILDINGCLASS_HARBOR'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CHINESE_CHUKONU','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_SPANISH_CONQUISTADOR','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CROSSBOWMAN','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_GALLEASS','BUILDINGCLASS_HARBOR'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_KOREAN_HWACHA','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_KNIGHT','BUILDINGCLASS_STABLE'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_KNIGHT','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_LONGSWORDSMAN','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_SONGHAI_MUSLIMCAVALRY','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_MONGOLIAN_KESHIK','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_SIAMESE_WARELEPHANT','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_PIKEMAN','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_JAPANESE_SAMURAI','BUILDINGCLASS_ARMORY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_TREBUCHET','BUILDINGCLASS_ARMORY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_VOLLEY_GUN','BUILDINGCLASS_ARMORY'; 
-- Industrial
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_BERBER_CAVALRY','BUILDINGCLASS_MILITARY_ACADEMY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_SWEDISH_CAROLEAN','BUILDINGCLASS_MILITARY_ACADEMY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_CAVALRY','BUILDINGCLASS_MILITARY_ACADEMY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_RUSSIAN_COSSACK','BUILDINGCLASS_MILITARY_ACADEMY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_RIFLEMAN','BUILDINGCLASS_MILITARY_ACADEMY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_GATLINGGUN','BUILDINGCLASS_MILITARY_ACADEMY'; 
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_AUSTRIAN_HUSSAR','BUILDINGCLASS_MILITARY_ACADEMY'; 
...
INSERT INTO Unit_BuildingClassPurchaseRequireds (UnitType, BuildingClassType) SELECT 'UNIT_ETHIOPIAN_MEHAL_SEFARI','BUILDINGCLASS_MILITARY_ACADEMY'; 
-- Modern
