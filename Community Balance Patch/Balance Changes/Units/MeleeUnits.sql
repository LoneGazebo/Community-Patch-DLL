...
-- LAND
	...
	DELETE FROM UnitFreePromotions WHERE PromotionType = 'PROMOTION_ANTI_MOUNTED_I';
	...
	-- War Elephant
	INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_INDIAN_WARELEPHANT' , 'PROMOTION_ANTI_MOUNTED_I' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
