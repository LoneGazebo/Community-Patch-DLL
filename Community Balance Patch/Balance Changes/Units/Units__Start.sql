...
UPDATE Units SET RangedCombat = ROUND(1.09 * (SELECT RangedCombat FROM Units WHERE Type = 'UNIT_CHARIOT_ARCHER'), 0)
					   WHERE Type IN ('UNIT_EGYPTIAN_WARCHARIOT');
...
UPDATE LoadedFile SET Value=1 WHERE Type='Units__Start.sql';
