...
INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_ROMAN_LEGION', 'PROMOTION_COVER_1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
