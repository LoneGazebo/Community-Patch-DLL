...
DELETE FROM UnitGameplay2DScripts WHERE UnitType = 'UNIT_CARTHAGINIAN_FOREST_ELEPHANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
UPDATE Units SET MinorCivGift = '1' WHERE Type = 'UNIT_DANISH_SKI_INFANTRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );

UPDATE Units SET Cost = '-1' WHERE Type = 'UNIT_DANISH_SKI_INFANTRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
VALUES
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_MELEE', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_MOUNTED', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_RECON', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_ARMOR', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_NAVALMELEE', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_HELICOPTER', 'PROMOTION_DOUBLE_PLUNDER'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_NAVALMELEE', 'PROMOTION_FREE_PILLAGE_MOVES'),
	('TRAIT_VIKING_FURY', 'UNITCOMBAT_HELICOPTER', 'PROMOTION_FREE_PILLAGE_MOVES');
---------------------------
-- England
---------------------------
...
---------------------------
-- Buffed Musketeer
INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_FRENCH_MUSKETEER' , 'PROMOTION_ESPRIT_DE_CORPS' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );

UPDATE Units SET Class = 'UNITCLASS_MUSKETMAN' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Civilization_UnitClassOverrides SET UnitClassType = 'UNITCLASS_MUSKETMAN' WHERE UnitType = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Units SET GoodyHutUpgradeUnitClass = 'UNITCLASS_GATLINGGUN' WHERE Type = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );

UPDATE Unit_ClassUpgrades SET UnitClassType = 'UNITCLASS_GATLINGGUN' WHERE UnitType = 'UNIT_FRENCH_MUSKETEER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
UPDATE Unit_Flavors SET Flavor = '12' WHERE UnitType = 'UNIT_HUN_HORSE_ARCHER';
...
VALUES
	('TRAIT_FIGHT_WELL_DAMAGED', 'UNITCLASS_TRIREME', 'BUILD_FISHING_BOATS'),
	('TRAIT_FIGHT_WELL_DAMAGED', 'UNITCLASS_CARAVEL', 'BUILD_FISHING_BOATS'),
	('TRAIT_FIGHT_WELL_DAMAGED', 'UNITCLASS_IRONCLAD', 'BUILD_FISHING_BOATS'),
	('TRAIT_FIGHT_WELL_DAMAGED', 'UNITCLASS_DESTROYER', 'BUILD_FISHING_BOATS'),
	('TRAIT_FIGHT_WELL_DAMAGED', 'UNITCLASS_PRIVATEER', 'BUILD_FISHING_BOATS');
---------------------------
-- Korea
---------------------------
...
UPDATE Units SET Class = 'UNITCLASS_TERCIO' WHERE Type = 'UNIT_OTTOMAN_JANISSARY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Civilization_UnitClassOverrides Set UnitClassType = 'UNITCLASS_TERCIO' WHERE UnitType = 'UNIT_OTTOMAN_JANISSARY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
DELETE FROM Civilization_UnitClassOverrides WHERE UnitType = 'UNIT_SHOSHONE_COMANCHE_RIDERS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

INSERT INTO UnitClasses (Type, Description, DefaultUnit) SELECT 'UNITCLASS_COMANCHE_RIDERS', 'TXT_KEY_UNIT_SHOSHONE_COMANCHE_RIDERS', 'UNIT_SHOSHONE_COMANCHE_RIDERS' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Units SET MinorCivGift = '1' WHERE Type = 'UNIT_SHOSHONE_COMANCHE_RIDERS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );

UPDATE Units SET Cost = '-1' WHERE Type = 'UNIT_SHOSHONE_COMANCHE_RIDERS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Units SET Class = 'UNITCLASS_COMANCHE_RIDERS' WHERE Type = 'UNIT_SHOSHONE_COMANCHE_RIDERS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
INSERT INTO Unit_ResourceQuantityRequirements (UnitType, ResourceType, Cost) SELECT 'UNIT_SIAMESE_WARELEPHANT', 'RESOURCE_HORSE', '1' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
UPDATE Unit_ClassUpgrades SET UnitClassType = 'UNITCLASS_LANCER' WHERE UnitType = 'UNIT_SONGHAI_MUSLIMCAVALRY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
VALUES
	...
	('UNIT_INCAN_SLINGER', 'PROMOTION_SECOND_ATTACK'),
