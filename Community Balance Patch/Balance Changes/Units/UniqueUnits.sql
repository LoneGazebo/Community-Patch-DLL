...
VALUES		('UNIT_TERCIO_FLAG_ATLAS',	32, 		'tercio_flag2.dds',	1, 				1);

UPDATE Units SET UnitFlagAtlas = 'UNIT_TERCIO_FLAG_ATLAS' WHERE Type = 'UNIT_SPANISH_TERCIO' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
...
UPDATE ArtDefine_StrategicView SET Asset = 'sv_tercio2.dds' WHERE StrategicViewType = 'ART_DEF_UNIT_U_SPANISH_TERCIO' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
