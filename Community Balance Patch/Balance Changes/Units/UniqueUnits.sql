...
INSERT INTO Unit_FreePromotions (UnitType, PromotionType) SELECT 'UNIT_AUSTRIAN_HUSSAR' , 'PROMOTION_EXTRA_SIGHT_I' WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_UNITS' AND Value= 1 );
