...
-- Policies
UPDATE Defines SET Value = '2.16' WHERE Name = 'POLICY_COST_EXPONENT';
...
UPDATE Defines SET Value = '-150' WHERE Name = 'PLOT_INFLUENCE_RESOURCE_COST'; -- should be more than 100 to be able to skip one ring
