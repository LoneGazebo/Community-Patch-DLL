...
-- Puppet Stuff
UPDATE Defines SET Value = '-75' WHERE Name = 'PUPPET_CULTURE_MODIFIER';
UPDATE Defines SET Value = '-75' WHERE Name = 'PUPPET_SCIENCE_MODIFIER';
UPDATE Defines SET Value = '-75' WHERE Name = 'PUPPET_TOURISM_MODIFIER';
UPDATE Defines SET Value = '-75' WHERE Name = 'PUPPET_GOLD_MODIFIER';
UPDATE Defines SET Value = '-25' WHERE Name = 'PUPPET_GROWTH_MODIFIER';
