...
UPDATE Defines SET Value = '500' WHERE Name = 'MAX_CITY_HIT_POINTS';
...
-- Policies
UPDATE Defines SET Value = '2.12' WHERE Name = 'POLICY_COST_EXPONENT';
UPDATE Defines SET Value = '4' WHERE Name = 'POLICY_COST_INCREASE_TO_BE_EXPONENTED';

-- Religion
UPDATE Defines SET Value = '30' WHERE Name = 'RELIGION_MIN_FAITH_FIRST_PANTHEON';
...
UPDATE Defines SET Value = '600' WHERE Name = 'RELIGION_FAITH_DELTA_NEXT_PROPHET';
...
UPDATE Defines SET Value = '40' WHERE Name = 'TECH_COST_TOTAL_KNOWN_TEAM_MODIFIER';

-- Trade Routes
UPDATE Defines SET Value = '50' WHERE Name = 'TRADE_ROUTE_BASE_GOLD';
UPDATE Defines SET Value = '8' WHERE Name = 'TRADE_ROUTE_CAPITAL_POP_GOLD_MULTIPLIER';
UPDATE Defines SET Value = '60' WHERE Name = 'TRADE_ROUTE_CITY_POP_GOLD_MULTIPLIER';
UPDATE Defines SET Value = '60' WHERE Name = 'INTERNATIONAL_TRADE_CITY_GPT_DIVISOR';
...
UPDATE Defines SET Value = '2.08' WHERE Name = 'CITY_GROWTH_EXPONENT';
...
UPDATE Defines SET Value = '1.30' WHERE Name = 'CULTURE_COST_LATER_PLOT_EXPONENT';
