...
-- Puppet Stuff
UPDATE Defines SET Value = '-40' WHERE Name = 'PUPPET_CULTURE_MODIFIER';
UPDATE Defines SET Value = '-40' WHERE Name = 'PUPPET_SCIENCE_MODIFIER';
UPDATE Defines SET Value = '-40' WHERE Name = 'PUPPET_TOURISM_MODIFIER';
...
UPDATE Defines SET Value = '2.15' WHERE Name = 'CITY_GROWTH_EXPONENT';
...
UPDATE Defines SET Value = '0.05' WHERE Name = 'UNIT_UPGRADE_COST_MULTIPLIER_PER_ERA';
