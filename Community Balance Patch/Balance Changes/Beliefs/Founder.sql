...
VALUES
	('BELIEF_CEREMONIAL_BURIAL', 'YIELD_FAITH', 40),
	('BELIEF_CEREMONIAL_BURIAL', 'YIELD_CULTURE', 40);
...
INSERT INTO Belief_YieldFromPolicyUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_CHURCH_PROPERTY', 'YIELD_FAITH', 100),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_SCIENCE', 100),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_GOLD', 100);

INSERT INTO Belief_YieldFromEraUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_INITIATION_RITES', 'YIELD_FAITH', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_SCIENCE', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLD', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_CULTURE', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_FOOD', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_PRODUCTION', 250),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLDEN_AGE_POINTS', 250);
