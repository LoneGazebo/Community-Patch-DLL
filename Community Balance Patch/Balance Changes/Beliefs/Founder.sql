...
INSERT INTO Belief_YieldBonusGoldenAge
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_PEACE_LOVING', 'YIELD_FOOD', 10),
	('BELIEF_PEACE_LOVING', 'YIELD_PRODUCTION', 10),
	('BELIEF_PEACE_LOVING', 'YIELD_GOLD', 10),
	('BELIEF_PEACE_LOVING', 'YIELD_CULTURE', 10),
	('BELIEF_PEACE_LOVING', 'YIELD_FAITH', 10),
	('BELIEF_PEACE_LOVING', 'YIELD_SCIENCE', 10);
...
INSERT INTO Belief_YieldFromConquest
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_INTERFAITH_DIALOGUE', 'YIELD_GOLDEN_AGE_POINTS', 40),
	('BELIEF_INTERFAITH_DIALOGUE', 'YIELD_FAITH', 40);

INSERT INTO Belief_YieldFromPolicyUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_CHURCH_PROPERTY', 'YIELD_FAITH', 4),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_SCIENCE', 4),
	('BELIEF_CHURCH_PROPERTY', 'YIELD_GOLD', 4);

INSERT INTO Belief_YieldFromEraUnlock
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_INITIATION_RITES', 'YIELD_FAITH', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_SCIENCE', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLD', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_CULTURE', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_FOOD', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_PRODUCTION', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_TOURISM', 30),
	('BELIEF_INITIATION_RITES', 'YIELD_GOLDEN_AGE_POINTS', 30);

INSERT INTO Belief_YieldFromConversion
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_PAPAL_PRIMACY', 'YIELD_SCIENCE', 10),
	('BELIEF_PAPAL_PRIMACY', 'YIELD_PRODUCTION', 10);

INSERT INTO Belief_YieldFromWLTKD
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_WORLD_CHURCH', 'YIELD_FAITH', 10),
	('BELIEF_WORLD_CHURCH', 'YIELD_GOLD', 10),
	('BELIEF_WORLD_CHURCH', 'YIELD_CULTURE', 10);
