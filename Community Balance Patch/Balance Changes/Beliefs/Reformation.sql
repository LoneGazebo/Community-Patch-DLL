...
UPDATE Beliefs
SET CombatVersusOtherReligionOwnLands = '30'
WHERE Type = 'BELIEF_DEFENDER_FAITH' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_RELIGION' AND Value= 1 );
...
VALUES
	('BELIEF_JESUIT_EDUCATION', 'BUILDINGCLASS_UNIVERSITY', 'YIELD_SCIENCE', 5),
	('BELIEF_JESUIT_EDUCATION', 'BUILDINGCLASS_PUBLIC_SCHOOL', 'YIELD_SCIENCE', 5),
	('BELIEF_JESUIT_EDUCATION', 'BUILDINGCLASS_LABORATORY', 'YIELD_SCIENCE', 5);
...
INSERT INTO Belief_BuildingClassYieldChanges
	(BeliefType, BuildingClassType, YieldType, YieldChange)
VALUES
	('BELIEF_UNDERGROUND_SECT', 'BUILDINGCLASS_OPERA_HOUSE', 'YIELD_CULTURE', 5),
	('BELIEF_UNDERGROUND_SECT', 'BUILDINGCLASS_MUSEUM', 'YIELD_CULTURE', 5),
	('BELIEF_UNDERGROUND_SECT', 'BUILDINGCLASS_BROADCAST_TOWER', 'YIELD_CULTURE', 5);
...
VALUES
	...
	('BELIEF_UNITY_OF_PROPHETS', 'IMPROVEMENT_CUSTOMS_HOUSE_VENICE', 'YIELD_FAITH', 3),
	...
	('BELIEF_UNITY_OF_PROPHETS', 'IMPROVEMENT_CUSTOMS_HOUSE_VENICE', 'YIELD_CULTURE', 1),
...
VALUES
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_SCIENTIST', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_SCIENTIST', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_SCIENTIST', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_SCIENTIST', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ENGINEER', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ENGINEER', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ENGINEER', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ENGINEER', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_PROPHET', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_PROPHET', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_PROPHET', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_PROPHET', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_GENERAL', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_GENERAL', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_GENERAL', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_GENERAL', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ADMIRAL', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ADMIRAL', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ADMIRAL', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ADMIRAL', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MERCHANT', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MERCHANT', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MERCHANT', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MERCHANT', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ARTIST', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ARTIST', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ARTIST', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_ARTIST', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MUSICIAN', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MUSICIAN', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MUSICIAN', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_MUSICIAN', 'YIELD_FAITH', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_WRITER', 'YIELD_SCIENCE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_WRITER', 'YIELD_GOLD', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_WRITER', 'YIELD_CULTURE', 30),
	('BELIEF_TO_GLORY_OF_GOD', 'GREATPERSON_WRITER', 'YIELD_FAITH', 30);
...
INSERT INTO Belief_YieldFromProposal
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_CHARITABLE_MISSIONS', 'YIELD_CULTURE', 20),
