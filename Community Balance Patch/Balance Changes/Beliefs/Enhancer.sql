...
VALUES
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_IRON', 25),
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_HORSE', 25),
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_OIL', 25),
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_COAL', 25),
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_ALUMINUM', 25),
	('BELIEF_HEATHEN_CONVERSION', 'RESOURCE_URANIUM', 25);
...
UPDATE Beliefs
SET SciencePerOtherReligionFollower = '5'
...
UPDATE Beliefs
SET PressureChangeTradeRoute = '300'
WHERE Type = 'BELIEF_HOLY_ORDER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_RELIGION' AND Value= 1 );
...
VALUES
	...
	('BELIEF_RELIQUARY', 'YIELD_FAITH', 4),
	('BELIEF_RELIQUARY', 'YIELD_GOLD', 4);
