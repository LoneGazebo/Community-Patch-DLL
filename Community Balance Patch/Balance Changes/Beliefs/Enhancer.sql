...
VALUES
	('BELIEF_RELIGIOUS_TEXTS', 'YIELD_GOLD', 300);
...
VALUES
	('BELIEF_RELIQUARY', 'DOMAIN_LAND', 'YIELD_FOOD', 4),
	('BELIEF_RELIQUARY', 'DOMAIN_LAND', 'YIELD_PRODUCTION', 4),
	('BELIEF_RELIQUARY', 'DOMAIN_SEA', 'YIELD_FOOD', 4),
	('BELIEF_RELIQUARY', 'DOMAIN_SEA', 'YIELD_PRODUCTION', 4);
...
UPDATE Beliefs
SET IgnorePolicyRequirements = '1'
WHERE Type = 'BELIEF_ITINERANT_PREACHERS' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_RELIGION' AND Value= 1 );
