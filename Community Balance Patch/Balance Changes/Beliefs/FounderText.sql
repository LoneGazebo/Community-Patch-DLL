...
SET Text = 'Unlocks the Heavenly Throne National Wonder (+4 [ICON_PEACE] Faith, +3 [ICON_CULTURE] Culture, [ICON_FOOD] Food, [ICON_RESEARCH] Science, [ICON_GOLD] Gold, and [ICON_PRODUCTION] Production). Holy City produces +25% of its yields during a [ICON_GOLDEN_AGE] Golden Age.'
...
UPDATE Language_en_US
SET Text = 'Unlocks Divine Court National Wonder (+4 [ICON_PEACE] Faith, and +15% [ICON_GOLD] Gold in the City). Receive [ICON_PEACE] Faith, [ICON_RESEARCH] Science, and [ICON_GOLD] Gold when you purchase a Policy. Bonus scales with Era.'
...
UPDATE Language_en_US
SET Text = 'Unlocks Sacred Garden National Wonder (+4 [ICON_PEACE] Faith, and +15% [ICON_CULTURE] Culture in the City). Receive a large boost to all national yields when you enter a new Era. Bonus scales with Era.'
...
UPDATE Language_en_US
SET Text = 'Unlocks Holy Council National Wonder (+4 [ICON_PEACE] Faith, and +15% [ICON_FOOD] Food in the City). Receive a boost to current [ICON_RESEARCH] Science research when a city adopts your Religion. Bonus scales with Era.'
...
UPDATE Language_en_US
SET Text = 'Unlocks Basilica National Wonder (+5 [ICON_PEACE] Faith, and +3 [ICON_GOLDEN_AGE] Golden Age points). Receive [ICON_GOLDEN_AGE] Golden Age points when you spread your Religion to cities other than your Holy City. Bonus scales with Era.'
