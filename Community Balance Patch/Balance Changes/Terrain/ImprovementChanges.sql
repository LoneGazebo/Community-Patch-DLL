...
VALUES
	...
	('IMPROVEMENT_PLANTATION', 'RESOURCE_NUTMEG', 'YIELD_FOOD', 1),
...
VALUES
	...
	('IMPROVEMENT_FORT', 'TECH_STEALTH', 'YIELD_SCIENCE', 1),
	('IMPROVEMENT_FORT', 'TECH_MOBILE_TACTICS', 'YIELD_PRODUCTION', 1),
...
UPDATE Improvements
SET PillageGold = '17'
WHERE Type = 'IMPROVEMENT_CUSTOMS_HOUSE_VENICE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_TERRAIN' AND Value= 1 );
