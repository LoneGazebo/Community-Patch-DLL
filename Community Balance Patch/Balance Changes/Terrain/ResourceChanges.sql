...
VALUES
	...
	('RESOURCE_NUTMEG', 'YIELD_GOLD', 3),
	('RESOURCE_PEARLS', 'YIELD_GOLD', 2),
	('RESOURCE_PEPPER', 'YIELD_FOOD', 2),
...
VALUES
	...
	('RESOURCE_PEPPER', 'YIELD_CULTURE', 10),
	('RESOURCE_NUTMEG', 'YIELD_PRODUCTION', 10),
	('RESOURCE_CLOVES', 'YIELD_FAITH', 20),
...
-- Mod Text
	...
	WHERE Type = 'RESOURCE_WHALE';
		...
		UPDATE Resources
	SET Help = 'TXT_KEY_RESOURCE_MONOPOLY_MOD_PRODUCTION_INDO'
	WHERE Type = 'RESOURCE_NUTMEG';

	UPDATE Resources
	SET Help = 'TXT_KEY_RESOURCE_MONOPOLY_MOD_FAITH_INDO'
	WHERE Type = 'RESOURCE_CLOVES';

	UPDATE Resources
	SET Help = 'TXT_KEY_RESOURCE_MONOPOLY_MOD_CULTURE_INDO'
	WHERE Type = 'RESOURCE_PEPPER';
