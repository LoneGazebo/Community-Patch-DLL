...
UPDATE Leader_MajorCivApproachBiases SET Bias = 8 	WHERE LeaderType = 'LEADER_ELIZABETH' 	AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_NEUTRAL';
...
UPDATE Leaders SET DoFWillingness = 6 				WHERE Type = 'LEADER_HARALD';
