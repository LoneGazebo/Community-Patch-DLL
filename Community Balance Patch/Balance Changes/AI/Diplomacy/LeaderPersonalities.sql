...
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_ASHURBANIPAL';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_HARALD';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_ATTILA';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_ODA_NOBUNAGA';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_GENGHIS_KHAN';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_NAPOLEON';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_GUSTAVUS_ADOLPHUS';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_MONTEZUMA';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_AUGUSTUS';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_ASKIA';
UPDATE Leaders SET Personality='PERSONALITY_CONQUEROR'    , WonderCompetitiveness=4, MinorCivCompetitiveness=3, Boldness=6, WarmongerHate=5, DenounceWillingness=7, DoFWillingness=2, VictoryCompetitiveness=8, DiploBalance=4, Loyalty=5, Neediness=6, Forgiveness=2, Chattiness=4, Meanness=9 WHERE Type = 'LEADER_SHAKA';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    6 WHERE LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_WAR';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    6 WHERE LeaderType = 'LEADER_HARALD'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_HOSTILE';
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_HARALD'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_DECEPTIVE';
UPDATE Leader_MajorCivApproachBiases SET Bias =    5 WHERE LeaderType = 'LEADER_HARALD'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_GUARDED';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_HARALD'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    6 WHERE LeaderType = 'LEADER_ATTILA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_HOSTILE';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_ATTILA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_FRIENDLY';
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_ATTILA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_NEUTRAL';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    5 WHERE LeaderType = 'LEADER_SHAKA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_HOSTILE';
UPDATE Leader_MajorCivApproachBiases SET Bias =    5 WHERE LeaderType = 'LEADER_SHAKA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_DECEPTIVE';
UPDATE Leader_MajorCivApproachBiases SET Bias =    5 WHERE LeaderType = 'LEADER_SHAKA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_GUARDED';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    1 WHERE LeaderType = 'LEADER_SHAKA'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_NEUTRAL';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    8 WHERE LeaderType = 'LEADER_SEJONG'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_DECEPTIVE';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    6 WHERE LeaderType = 'LEADER_GENGHIS_KHAN'         AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_GUARDED';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_PACHACUTI'            AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_AFRAID';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    8 WHERE LeaderType = 'LEADER_AUGUSTUS'            AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_HOSTILE';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    4 WHERE LeaderType = 'LEADER_AUGUSTUS'            AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_AFRAID';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    1 WHERE LeaderType = 'LEADER_BISMARCK'            AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_WAR';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    8 WHERE LeaderType = 'LEADER_BISMARCK'            AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_NEUTRAL';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    2 WHERE LeaderType = 'LEADER_PEDRO'                AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MajorCivApproachBiases SET Bias =    8 WHERE LeaderType = 'LEADER_NAPOLEON'           AND MajorCivApproachType = 'MAJOR_CIV_APPROACH_NEUTRAL';
