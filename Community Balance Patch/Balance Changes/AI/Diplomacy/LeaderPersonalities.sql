...
UPDATE Leader_MinorCivApproachBiases SET Bias = 9 	WHERE LeaderType = 'LEADER_ELIZABETH' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 5 		WHERE Type = 'LEADER_ENRICO_DANDOLO';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 7 	WHERE LeaderType = 'LEADER_GAJAH_MADA' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 7 	WHERE LeaderType = 'LEADER_GANDHI' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_GENGHIS_KHAN';
...
UPDATE Leaders SET VictoryCompetitiveness = 10 		WHERE Type = 'LEADER_GUSTAVUS_ADOLPHUS';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 6 	WHERE LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 6 	WHERE LeaderType = 'LEADER_SELASSIE' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_HARALD';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 4 	WHERE LeaderType = 'LEADER_HARALD' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 7 		WHERE Type = 'LEADER_KAMEHAMEHA';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 6 	WHERE LeaderType = 'LEADER_KAMEHAMEHA' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 6 		WHERE Type = 'LEADER_MARIA_I';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 9 	WHERE LeaderType = 'LEADER_MARIA_I' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 6 		WHERE Type = 'LEADER_MARIA';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 10 	WHERE LeaderType = 'LEADER_MARIA' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 10 		WHERE Type = 'LEADER_NAPOLEON';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 5 	WHERE LeaderType = 'LEADER_NAPOLEON' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 7 	WHERE LeaderType = 'LEADER_NEBUCHADNEZZAR' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_ODA_NOBUNAGA';
...
UPDATE Leaders SET VictoryCompetitiveness = 7 		WHERE Type = 'LEADER_PACAL';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 5 	WHERE LeaderType = 'LEADER_PACAL' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 5 	WHERE LeaderType = 'LEADER_PACHACUTI' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 7 	WHERE LeaderType = 'LEADER_PEDRO' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_POCATELLO';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 8 	WHERE LeaderType = 'LEADER_POCATELLO' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_RAMESSES';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 5 	WHERE LeaderType = 'LEADER_RAMESSES' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 6 		WHERE Type = 'LEADER_RAMKHAMHAENG';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 12 	WHERE LeaderType = 'LEADER_RAMKHAMHAENG' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 10 		WHERE Type = 'LEADER_SHAKA';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 2 	WHERE LeaderType = 'LEADER_SHAKA' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 9 		WHERE Type = 'LEADER_SULEIMAN';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 7 	WHERE LeaderType = 'LEADER_SULEIMAN' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 10 		WHERE Type = 'LEADER_WASHINGTON';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 10 	WHERE LeaderType = 'LEADER_WASHINGTON' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
...
UPDATE Leaders SET VictoryCompetitiveness = 12 		WHERE Type = 'LEADER_WU_ZETIAN';
...
UPDATE Leader_MinorCivApproachBiases SET Bias = 9 	WHERE LeaderType = 'LEADER_WU_ZETIAN' 	AND MinorCivApproachType = 'MINOR_CIV_APPROACH_FRIENDLY';
