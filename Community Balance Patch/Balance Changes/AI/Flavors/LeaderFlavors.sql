...
INSERT OR REPLACE INTO Leader_Flavors(Flavor, FlavorType , LeaderType) SELECT   6, 'FLAVOR_AIR',                      Type FROM Leaders WHERE Personality = 'PERSONALITY_EXPANSIONIST';
...
UPDATE Leader_Flavors SET Flavor =  16 WHERE FlavorType = 'FLAVOR_RELIGION'                  AND LeaderType = 'LEADER_ISABELLA';
...
UPDATE Leader_Flavors SET Flavor =  12 WHERE FlavorType = 'FLAVOR_GREAT_PEOPLE'              AND LeaderType = 'LEADER_WU_ZETIAN';
UPDATE Leader_Flavors SET Flavor =   8 WHERE FlavorType = 'FLAVOR_EXPANSION'				 AND LeaderType = 'LEADER_WU_ZETIAN';
UPDATE Leader_Flavors SET Flavor =  12 WHERE FlavorType = 'FLAVOR_GROWTH'                    AND LeaderType = 'LEADER_WU_ZETIAN';
...
UPDATE Leader_Flavors SET Flavor =   6 WHERE FlavorType = 'FLAVOR_RELIGION'					 AND LeaderType = 'LEADER_GAJAH_MADA';
UPDATE Leader_Flavors SET Flavor =   8 WHERE FlavorType = 'FLAVOR_EXPANSION'                 AND LeaderType = 'LEADER_GAJAH_MADA';
...
UPDATE Leader_Flavors SET Flavor =   4 WHERE FlavorType = 'FLAVOR_DIPLOMACY'                 AND LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS';
UPDATE Leader_Flavors SET Flavor =	 4 WHERE FlavorType = 'FLAVOR_GREAT_PEOPLE'              AND LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS';
UPDATE Leader_Flavors SET Flavor =   5 WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'         AND LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS';
...
UPDATE Leader_Flavors SET Flavor =  16 WHERE FlavorType = 'FLAVOR_DIPLOMACY'				 AND LeaderType = 'LEADER_MARIA';
...
UPDATE Leader_Flavors SET Flavor =  16 WHERE FlavorType = 'FLAVOR_CULTURE'		             AND LeaderType = 'LEADER_SELASSIE';
...
UPDATE Leader_Flavors SET Flavor =  12 WHERE FlavorType = 'FLAVOR_CULTURE'                   AND LeaderType = 'LEADER_NAPOLEON';
UPDATE Leader_Flavors SET Flavor =  10 WHERE FlavorType = 'FLAVOR_OFFENSE'                   AND LeaderType = 'LEADER_NAPOLEON';
UPDATE Leader_Flavors SET Flavor =   6 WHERE FlavorType = 'FLAVOR_RANGED'                    AND LeaderType = 'LEADER_NAPOLEON';
...
UPDATE Leader_Flavors SET Flavor =  12 WHERE FlavorType = 'FLAVOR_RANGED'                    AND LeaderType = 'LEADER_SULEIMAN';
UPDATE Leader_Flavors SET Flavor =  12 WHERE FlavorType = 'FLAVOR_MILITARY_TRAINING'         AND LeaderType = 'LEADER_SULEIMAN';
