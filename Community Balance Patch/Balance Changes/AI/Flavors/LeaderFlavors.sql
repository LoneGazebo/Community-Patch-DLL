...
UPDATE Leader_Flavors SET Flavor =  16 WHERE FlavorType = 'FLAVOR_DIPLOMACY'                 AND LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS';
UPDATE Leader_Flavors SET Flavor =	 8 WHERE FlavorType = 'FLAVOR_GREAT_PEOPLE'              AND LeaderType = 'LEADER_GUSTAVUS_ADOLPHUS';
