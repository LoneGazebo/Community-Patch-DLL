...
UPDATE Language_en_US
SET Text = 'This National Wonder provides +1 [ICON_CULTURE] Culture and reduces [ICON_HAPPINESS_3] Boredom by 2. A city must have a Colosseum before it can construct a Circus Maximus. Requires a national population of at least 25 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'The East India Company increases the amount of [ICON_GOLD] Gold a city generates and reduces [ICON_HAPPINESS_3] Poverty by 2. Trade routes other players make to a city with an East India Company will generate an extra 4 [ICON_GOLD] Gold for the city owner and the trade route owner gains an additional 2 [ICON_GOLD] Gold for the trade route. Requires a national population of at least 40 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'The National College National Wonder produces +1 [ICON_RESEARCH] Science for every 4 [ICON_CITIZEN] Citizens in the City, and it provides +1 [ICON_CULTURE] Culture. A city must have a library before it can construct a National College. Requires a national population of at least 30 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'With its massive boost to [ICON_TOURISM] Tourism, the National Visitor Center is an excellent choice for civilizations that are trying to achieve a Culture victory, or attempting to increase your ideological impact on other civilizations. Build it in your top [ICON_TOURISM] Tourism city it has a Hotel. Requires a national population of at least 80 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Disorder. Must have built a Colosseum in the city. The cost goes up the more cities there are in the empire. Requires a national population of at least 25 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Disorder. Provides an additional spy and levels up all your existing spies. Also provides a 15% reduction in enemy spy effectiveness. Must have a Police Station in the city. Requires a national population of at least 70 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Must have built a Hotel in the city. The cost goes up the more cities there are in the empire. 100% of the [ICON_CULTURE] Culture from World Wonders, Natural Wonders, and Improvements (Landmarks, Moai, Chateau) is added to the [ICON_TOURISM] Tourism output of the city. [ICON_TOURISM] Tourism output from Great Works +100%. Requires a national population of at least 80 before it can be constructed.'
