...
SELECT 'BUILDING_HEROIC_EPIC' , 'UNIT_WRITER' , '1'
...
WHERE Type = 'BUILDING_PALACE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );
...
VALUES
	...
	('BUILDING_WHITE_TOWER', 'YIELD_SCIENCE', 20),
	('BUILDING_WHITE_TOWER', 'YIELD_GOLD', 20);
