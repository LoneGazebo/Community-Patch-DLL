...
UPDATE Buildings SET GoldMaintenance = '2' WHERE Type = 'BUILDING_WELL' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
UPDATE Buildings SET GoldMaintenance = '2' WHERE Type = 'BUILDING_MISSION' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
