...
UPDATE Buildings
SET Cost = '200'
WHERE Type = 'BUILDING_CONSTABULARY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
UPDATE Buildings
SET Cost = '325'
WHERE Type = 'BUILDING_THEATER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
