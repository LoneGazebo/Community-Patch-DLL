...
UPDATE Buildings
SET NoUnhappfromXSpecialists = '1'
WHERE Type = 'BUILDING_LIBRARY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
INSERT INTO Building_InstantYield
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_STADIUM', 'YIELD_GOLDEN_AGE_POINTS', 1000),
	('BUILDING_THEATRE', 'YIELD_TOURISM', 400),
...
INSERT INTO Building_YieldFromInternalTR
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_MARKET', 'YIELD_FOOD', 2),
	('BUILDING_BAZAAR', 'YIELD_FOOD', 2),
	('BUILDING_WORKSHOP', 'YIELD_PRODUCTION', 2),
	('BUILDING_STOCKYARD', 'YIELD_FOOD', 4),
