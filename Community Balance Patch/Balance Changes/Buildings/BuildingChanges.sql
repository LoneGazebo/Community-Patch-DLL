...
UPDATE Buildings
SET PrereqTech = 'TECH_ECOLOGY'
WHERE Type = 'BUILDING_WIND_PLANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
INSERT INTO Building_SeaPlotYieldChanges
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_HYDRO_PLANT', 'YIELD_PRODUCTION', 2),
	('BUILDING_HYDRO_PLANT', 'YIELD_SCIENCE', 2),
	('BUILDING_HYDRO_PLANT', 'YIELD_GOLD', 2);
...
INSERT INTO Building_YieldFromProcessModifier
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_SOLAR_PLANT', 'YIELD_FOOD', 15),
	('BUILDING_SOLAR_PLANT', 'YIELD_GOLD', 15),
	('BUILDING_SOLAR_PLANT', 'YIELD_SCIENCE', 15),
	('BUILDING_SOLAR_PLANT', 'YIELD_CULTURE', 15),
	('BUILDING_SOLAR_PLANT', 'YIELD_FAITH', 15);
...
VALUES
	...
	('BUILDING_THEATRE', 'FEATURE_FOREST', 'YIELD_TOURISM', 2),
	('BUILDING_THEATRE', 'FEATURE_JUNGLE', 'YIELD_TOURISM', 2),
...
VALUES
	...
	('BUILDING_NUCLEAR_PLANT', 'YIELD_PRODUCTION', 25),
