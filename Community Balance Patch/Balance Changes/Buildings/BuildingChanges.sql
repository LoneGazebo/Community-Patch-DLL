...
WHERE Type = 'BUILDING_GARDEN' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
UPDATE Buildings
SET NoUnhappfromXSpecialists = '1'
WHERE Type = 'BUILDING_WORKSHOP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
WHERE Type = 'BUILDING_HYDRO_PLANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );

UPDATE Buildings
SET NoUnhappfromXSpecialists = '2'
WHERE Type = 'BUILDING_WIND_PLANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );

UPDATE Buildings
SET NoUnhappfromXSpecialists = '2'
WHERE Type = 'BUILDING_SOLAR_PLANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );

UPDATE Buildings
SET NoUnhappfromXSpecialists = '2'
WHERE Type = 'BUILDING_NUCLEAR_PLANT' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
UPDATE Buildings
SET NoUnhappfromXSpecialists = '2'
WHERE Type = 'BUILDING_FACTORY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
INSERT INTO Building_YieldFromInternalTREnd
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_MARKET', 'YIELD_FOOD', 25),
	('BUILDING_BAZAAR', 'YIELD_FOOD', 25),
	('BUILDING_WORKSHOP', 'YIELD_PRODUCTION', 25),
	('BUILDING_STOCKYARD', 'YIELD_FOOD', 50),
	('BUILDING_FACTORY', 'YIELD_PRODUCTION', 50);
...
VALUES
	...
	('BUILDING_STOCKYARD', 'IMPROVEMENT_FARM', 'YIELD_FOOD', 3),
	('BUILDING_STOCKYARD', 'IMPROVEMENT_PASTURE', 'YIELD_FOOD', 3),
