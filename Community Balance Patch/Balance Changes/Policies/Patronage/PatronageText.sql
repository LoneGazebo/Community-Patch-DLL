...
-- Philanthropy
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Philanthropy[ENDCOLOR][NEWLINE]Receive +50% [ICON_INFLUENCE] Influence from Quests completed for City-States. Minmum [ICON_INFLUENCE] Influence with all City-States raised by 10.'
