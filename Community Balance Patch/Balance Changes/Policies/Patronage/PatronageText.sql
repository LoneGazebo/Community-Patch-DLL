...
-- Philanthropy
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Philanthropy[ENDCOLOR][NEWLINE]Receive +33% [ICON_INFLUENCE] Influence from Quests completed for City-States.'
...
-- Consulates
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Consulates[ENDCOLOR][NEWLINE]Gain an additional Delegate in the World Congress for every 8 City-States in the game, and the chance of rigging elections in City-States is increased by 33%.'
