...
VALUES
	('POLICY_PATRONAGE', 'YIELD_FOOD', 25),
	('POLICY_PATRONAGE', 'YIELD_GOLD', 25),
	('POLICY_PATRONAGE', 'YIELD_CULTURE', 25),
	('POLICY_PATRONAGE', 'YIELD_SCIENCE', 25),
	('POLICY_PATRONAGE', 'YIELD_FAITH', 25),
	('POLICY_PATRONAGE', 'YIELD_PRODUCTION', 25);
...
VALUES
	('POLICY_SCHOLASTICISM', 'BUILDINGCLASS_CONSTABLE', 'YIELD_SCIENCE', 5),
	('POLICY_SCHOLASTICISM', 'BUILDINGCLASS_POLICE_STATION', 'YIELD_SCIENCE', 5);
...
UPDATE Policies
SET HappinessPerActiveTradeRoute = '2'
WHERE Type = 'POLICY_CULTURAL_DIPLOMACY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );
...
UPDATE Policies
SET InternalTradeRouteYieldModifierCapital = '25'
WHERE Type = 'POLICY_MERCHANT_CONFEDERACY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );

UPDATE Policies
SET TradeRouteYieldModifierCapital = '25'
WHERE Type = 'POLICY_MERCHANT_CONFEDERACY' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );
