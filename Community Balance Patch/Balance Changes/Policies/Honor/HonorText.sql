...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Might[ENDCOLOR] will greatly benefit expansionists.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Adopting Might grants:[ENDCOLOR] [NEWLINE] [ICON_BULLET] +25% combat bonus VS Barbarians, and gain [ICON_CULTURE] Culture when you kill Barbarians or clear Camps. [NEWLINE] [ICON_BULLET] +5% [ICON_PRODUCTION] Production towards land units.[NEWLINE] [ICON_BULLET] Unlocks building the [COLOR_CYAN]Terracotta Army[ENDCOLOR].[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Each Might policy unlocked grants:[ENDCOLOR] [NEWLINE] [ICON_BULLET] +4% [ICON_PRODUCTION] Production towards land units.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Adopting all policies in Might grants:[ENDCOLOR] [NEWLINE] [ICON_BULLET] Grants [ICON_GOLDEN_AGE] Golden Age Points and [ICON_CULTURE] Culture from City conquest. [NEWLINE] [ICON_BULLET] Grants access to Medieval Era Policy Branches, ignoring Era requirement.[NEWLINE] [ICON_BULLET] Provides [COLOR_CYAN]1[ENDCOLOR] point (of [COLOR_CYAN]4[ENDCOLOR] required in total) towards unlocking access to Ideologies.[NEWLINE] [ICON_BULLET] Allows for the purchase of [ICON_GREAT_GENERAL] Great Generals with [ICON_PEACE] Faith starting in the Industrial Era.'
...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Logistics[ENDCOLOR][NEWLINE]Killing a military unit generates [ICON_RESEARCH] Science based on the [ICON_STRENGTH] Strength of the defeated unit. All Melee units heal for 20 points after killing a military unit.'
