...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Empiricism[ENDCOLOR][NEWLINE]+1 [ICON_HAPPINESS_1] Happiness for every city [ICON_CONNECTED] Connection with the [ICON_CAPITAL] Capital.'
...
-- Free Thought
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Free Thought[ENDCOLOR][NEWLINE]+1 [ICON_RESEARCH] Science from every Village, and -50% [ICON_HAPPINESS_3] Religious Unrest in all cities.'
