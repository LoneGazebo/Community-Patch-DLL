...
-- Organized Religion
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Organized Religion[ENDCOLOR][NEWLINE] -25% [ICON_PEACE] Faith purchase costs. [ICON_RELIGION] Religions spread to owned Cities without a majority [ICON_RELIGION] Religion from 50% further away. Spread bonus applies exclusively to your [ICON_RELIGION] Religion if you are a founder.'
