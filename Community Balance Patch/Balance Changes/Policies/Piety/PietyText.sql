...
SET Text = '[COLOR_POSITIVE_TEXT]Piety[ENDCOLOR] capitalizes on your investment in religion and trade.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Adopting Piety grants:[ENDCOLOR] [NEWLINE] [ICON_BULLET] +1 [ICON_PEACE] Faith in your [ICON_CAPITAL] Capital. [NEWLINE] [ICON_BULLET] Shrines produce +1 [ICON_CULTURE] Culture. [NEWLINE] [ICON_BULLET] Temples produce +2 [ICON_CULTURE] Culture. [NEWLINE] [ICON_BULLET] -5% [ICON_PEACE] Faith needed for [ICON_PEACE] Faith purchases, and an additional -4% [ICON_PEACE] Faith needed for every Piety policy unlocked. [NEWLINE] [ICON_BULLET] Unlocks building Stonehenge.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Adopting all Policies in Piety grants:[ENDCOLOR] [NEWLINE] [ICON_BULLET] Holy Sites produce +2 [ICON_GOLD] Gold and +3 [ICON_CULTURE] Culture. [NEWLINE] [ICON_BULLET] Cities with a majority [ICON_RELIGION] Religion also get the Pantheon belief bonus of the second most popular [ICON_RELIGION] Religion. [NEWLINE] [ICON_BULLET] Allows for the purchase of [ICON_GREAT_ARTIST] Great Artists with [ICON_PEACE] Faith starting in the Industrial Era.'
