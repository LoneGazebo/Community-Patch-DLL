...
VALUES
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_MINE', 'YIELD_PRODUCTION', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_MINE', 'YIELD_GOLD', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_QUARRY', 'YIELD_PRODUCTION', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_QUARRY', 'YIELD_GOLD', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_LUMBERMILL', 'YIELD_PRODUCTION', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_LUMBERMILL', 'YIELD_GOLD', 1),
	('POLICY_ENTREPRENEURSHIP', 'IMPROVEMENT_LUMBERMILL_JUNGLE', 'YIELD_PRODUCTION', 1),
...
VALUES
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_WINDMILL', 'YIELD_PRODUCTION', 5),
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_WORKSHOP', 'YIELD_PRODUCTION', 5),
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_FACTORY', 'YIELD_PRODUCTION', 5),
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_WINDMILL', 'YIELD_GOLD', 5),
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_WORKSHOP', 'YIELD_GOLD', 5),
	('POLICY_MERCANTILISM', 'BUILDINGCLASS_FACTORY', 'YIELD_GOLD', 5),
