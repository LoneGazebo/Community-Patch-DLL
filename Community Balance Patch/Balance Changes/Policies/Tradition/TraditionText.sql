...
-- Monarchy
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Devotion[ENDCOLOR][NEWLINE] Specialists in [ICON_CAPITAL] Capital consume half the normal amount of [ICON_FOOD] Food. [COLOR_CYAN]Court Chapel[ENDCOLOR] built in [ICON_CAPITAL] Capital (1 Musician Specialist, 1 [ICON_GREAT_WORK] Great Work of Music slot, +2 [ICON_PEACE] Faith).'
