...
UPDATE Policies
SET MonopolyModFlat = '1'
WHERE Type = 'POLICY_NAVAL_TRADITION' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );

UPDATE Policies
SET MonopolyModPercent = '1'
WHERE Type = 'POLICY_NAVAL_TRADITION' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_POLICIES' AND Value= 1 );
...
VALUES
	...
	('POLICY_EXPLORATION', 'UNITCOMBAT_MELEE', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_ARMOR', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_HELICOPTER', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_GUN', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_SIEGE', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_MOUNTED', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_ARCHER', 5),
	('POLICY_EXPLORATION', 'UNITCOMBAT_RECON', 5),
...
VALUES
	...
	('POLICY_MERCHANT_NAVY', 'IMPROVEMENT_CAMP', 'YIELD_FOOD', 1),
	('POLICY_NAVIGATION_SCHOOL', 'IMPROVEMENT_FORT', 'YIELD_SCIENCE', 5),
	('POLICY_NAVIGATION_SCHOOL', 'IMPROVEMENT_CITADEL', 'YIELD_SCIENCE', 5),
	('POLICY_NAVIGATION_SCHOOL', 'IMPROVEMENT_FORT', 'YIELD_CULTURE', 2),
	('POLICY_NAVIGATION_SCHOOL', 'IMPROVEMENT_CITADEL', 'YIELD_CULTURE', 2);
...
VALUES
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_BARRACKS', 'YIELD_SCIENCE', 5),
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_ARMORY', 'YIELD_SCIENCE', 5),
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_MILITARY_ACADEMY', 'YIELD_SCIENCE', 5);

INSERT INTO Policy_BuildingClassCultureChanges
	(PolicyType, BuildingClassType, CultureChange)
VALUES
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_BARRACKS', 2),
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_ARMORY', 2),
	('POLICY_NAVIGATION_SCHOOL', 'BUILDINGCLASS_MILITARY_ACADEMY', 2);
...
VALUES
	...
	('POLICY_MARITIME_INFRASTRUCTURE', 'PROMOTION_NAVAL_DEFENSE_BOOST'),
