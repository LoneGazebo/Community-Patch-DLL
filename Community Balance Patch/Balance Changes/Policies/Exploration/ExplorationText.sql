...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Imperialism[ENDCOLOR] enhances your ability to spread your empire through military power, particularly naval (and later air) supremacy.[NEWLINE][NEWLINE]Adopting Imperialism gives +1 [ICON_MOVES] Movement for Naval units and +1 Sight for Naval combat units. Receive a +5% [ICON_PRODUCTION] production modifier for all Naval and Air military units, and +4% for each additional policy unlocked in Imperialism. Unlocks building the Louvre.[NEWLINE][NEWLINE]Adopting all policies grants you 1 additional [ICON_HAPPINESS_1] Happiness for every owned Luxury, and all Air units start with either the [COLOR_POSITIVE_TEXT]Siege I[ENDCOLOR] or the [COLOR_POSITIVE_TEXT]Sortie[ENDCOLOR] Promotion. Lastly, it grants all Ocean, Coast and Lake tiles +1 [ICON_RESEARCH] Science, and allows for the purchase of Great Admirals with [ICON_PEACE] Faith starting in the Industrial Era.'
