...
UPDATE SmallAwards SET Gold = '100' WHERE Type = 'MINOR_CIV_QUEST_BULLY_CITY_STATE';
UPDATE SmallAwards SET GlobalExperience = '8' WHERE Type = 'MINOR_CIV_QUEST_BULLY_CITY_STATE';
