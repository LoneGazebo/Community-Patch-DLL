...
UPDATE SmallAwards SET RandomMod = '30' WHERE Type = 'MINOR_CIV_QUEST_ROUTE';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_KILL_CAMP';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_CONNECT_RESOURCE';
...
UPDATE SmallAwards SET RandomMod = '50' WHERE Type = 'MINOR_CIV_QUEST_CONSTRUCT_WONDER';
...
UPDATE SmallAwards SET RandomMod = '50' WHERE Type = 'MINOR_CIV_QUEST_GREAT_PERSON';
...
UPDATE SmallAwards SET RandomMod = '70' WHERE Type = 'MINOR_CIV_QUEST_KILL_CITY_STATE';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_FIND_PLAYER';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_FIND_NATURAL_WONDER';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_GIVE_GOLD';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_PLEDGE_TO_PROTECT';
...
UPDATE SmallAwards SET RandomMod = '30' WHERE Type = 'MINOR_CIV_QUEST_CONTEST_CULTURE';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_CONTEST_FAITH';
...
UPDATE SmallAwards SET RandomMod = '50' WHERE Type = 'MINOR_CIV_QUEST_CONTEST_TECHS';

-- Bully
UPDATE SmallAwards SET Influence = '30' WHERE Type = 'MINOR_CIV_QUEST_BULLY_CITY_STATE';
...
UPDATE SmallAwards SET RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_BULLY_CITY_STATE';
...
UPDATE SmallAwards SET RandomMod = '50' WHERE Type = 'MINOR_CIV_QUEST_DENOUNCE_MAJOR';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_SPREAD_RELIGION';
...
UPDATE SmallAwards SET RandomMod = '50' WHERE Type = 'MINOR_CIV_QUEST_TRADE_ROUTE';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER';

-- Find a CS
UPDATE SmallAwards SET Influence = '5' WHERE Type = 'MINOR_CIV_QUEST_FIND_CITY_STATE';
UPDATE SmallAwards SET Production = '50' WHERE Type = 'MINOR_CIV_QUEST_FIND_CITY_STATE';
UPDATE SmallAwards SET RandomMod = '30' WHERE Type = 'MINOR_CIV_QUEST_FIND_CITY_STATE';
...
UPDATE SmallAwards SET RandomMod = '40' WHERE Type = 'MINOR_CIV_QUEST_CONTEST_TOURISM';
...
UPDATE SmallAwards SET RandomMod = '80' WHERE Type = 'MINOR_CIV_QUEST_ARCHAEOLOGY';
...
UPDATE SmallAwards SET RandomMod = '70' WHERE Type = 'MINOR_CIV_QUEST_LIBERATION';
...
UPDATE SmallAwards SET RandomMod = '90' WHERE Type = 'MINOR_CIV_QUEST_DISCOVER_PLOT';
...
UPDATE SmallAwards SET RandomMod = '80' WHERE Type = 'MINOR_CIV_QUEST_UNIT_STEAL_FROM';
...
UPDATE SmallAwards SET RandomMod = '100' WHERE Type = 'MINOR_CIV_QUEST_UNIT_COUP_CITY';

-- Conquest
UPDATE SmallAwards SET Influence = '40' WHERE Type = 'MINOR_CIV_QUEST_UNIT_GET_CITY';
UPDATE SmallAwards SET GlobalExperience = '5' WHERE Type = 'MINOR_CIV_QUEST_UNIT_GET_CITY';
