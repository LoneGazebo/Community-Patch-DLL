...
UPDATE Language_en_US
SET Text = 'Has a unique set of Pantheon Beliefs that no one else can benefit from. Cities with your Religion generate nor receive foreign Religious Pressure. +3 [ICON_PEACE] Faith in owned Cities where your Religion is the majority.'
