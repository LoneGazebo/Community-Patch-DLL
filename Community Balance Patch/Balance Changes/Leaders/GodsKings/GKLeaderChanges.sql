...
VALUES
	('BELIEF_MORRIGAN', 'YIELD_GOLD', 50),
	('BELIEF_MORRIGAN', 'YIELD_CULTURE', 50),
	('BELIEF_MORRIGAN', 'YIELD_GOLDEN_AGE_POINTS', 40);
...
INSERT INTO Belief_YieldPerBorderGrowth
	(BeliefType, YieldType, Yield)
VALUES
	('BELIEF_EPONA', 'YIELD_SCIENCE', 12),
	('BELIEF_EPONA', 'YIELD_CULTURE', 12),
	('BELIEF_EPONA', 'YIELD_FOOD', 12);
...
VALUES
	...
	('BELIEF_RHIANNON', 'YIELD_PRODUCTION', 2),
