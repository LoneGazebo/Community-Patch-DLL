...
WHERE TraitType = 'TRAIT_GATEWAY_AFRICA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
WHERE Type = 'TRAIT_GATEWAY_AFRICA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
UPDATE Buildings
SET TrainedFreePromotion = 'PROMOTION_BUFFALO_LOINS'
WHERE Type = 'BUILDING_IKANDA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
VALUES
	('IMPROVEMENT_CUSTOMS_HOUSE_VENICE', 'TXT_KEY_IMPROVEMENT_CUSTOMS_HOUSE_VENICE', 'TXT_KEY_CIV5_IMPROVEMENT_CUSTOMS_HOUSE_VENICE_TEXT', 'ART_DEF_IMPROVEMENT_CUSTOMS_HOUSE', 1, 17, 1, 1, 1, 33, 'TERRAIN_ATLAS');
...
VALUES
	('BUILD_CUSTOMS_HOUSE_VENICE', 'FEATURE_FOREST', 'TECH_BRONZE_WORKING', 30, 1),
	('BUILD_CUSTOMS_HOUSE_VENICE', 'FEATURE_JUNGLE', 'TECH_CALENDAR', 20, 1);
...
INSERT INTO Trait_YieldFromRouteMovement
	(TraitType, YieldType, Yield)
VALUES
	('TRAIT_EXTRA_TRADE', 'YIELD_GREAT_ADMIRAL_POINTS', 5),
	('TRAIT_EXTRA_TRADE', 'YIELD_GREAT_GENERAL_POINTS', 5),
	('TRAIT_EXTRA_TRADE', 'YIELD_SCIENCE', 5),
	('TRAIT_EXTRA_TRADE', 'YIELD_GOLD', 5);
...
VALUES -- GitHub #4097 fix
	...
	('BUILD_ENCAMPMENT_SHOSHONE', 'FEATURE_FOREST', 'TECH_BRONZE_WORKING', 300, 30, 1),
