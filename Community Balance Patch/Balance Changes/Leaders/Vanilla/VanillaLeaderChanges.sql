...
VALUES		('BUILDINGCLASS_AMERICA_SMITHSONIAN',		'BUILDING_AMERICA_SMITHSONIAN',			1),
			...
			('BUILDINGCLASS_AMERICA_SMITHSONIAN_DUMMY',	'BUILDING_AMERICA_SMITHSONIAN_DUMMY',	-1),
			('BUILDINGCLASS_AMERICA_HOOVERDAM_DUMMY',	'BUILDING_AMERICA_HOOVERDAM_DUMMY',		-1),
			('BUILDINGCLASS_AMERICA_WESTPOINT_DUMMY',	'BUILDING_AMERICA_WESTPOINT_DUMMY',		-1);
...
VALUES		('BUILDING_AMERICA_SMITHSONIAN_DUMMY', 	'BUILDINGCLASS_AMERICA_SMITHSONIAN_DUMMY', 	'TXT_KEY_BUILDING_AMERICA_SMITHSONIAN_DUMMY', 	0, 				0,					-1,		-1,			-1,				1,				1,			0,				-1,					'CIV_COLOR_ATLAS',	0, 				1),
			('BUILDING_AMERICA_HOOVERDAM_DUMMY', 	'BUILDINGCLASS_AMERICA_HOOVERDAM_DUMMY', 	'TXT_KEY_BUILDING_AMERICA_HOOVERDAM_DUMMY', 	0, 				0,					-1,		-1,			-1,				1,				1,			0,				-1,					'CIV_COLOR_ATLAS',	0, 				1),
			('BUILDING_AMERICA_WESTPOINT_DUMMY', 	'BUILDINGCLASS_AMERICA_WESTPOINT_DUMMY', 	'TXT_KEY_BUILDING_AMERICA_WESTPOINT_DUMMY', 	0, 				0,					-1,		-1,			-1,				1,				1,			0,				-1,					'CIV_COLOR_ATLAS',	0, 				1);

UPDATE Buildings SET
	FreeBuildingThisCity = 'BUILDINGCLASS_MUSEUM' 
WHERE Type = 'BUILDING_AMERICA_SMITHSONIAN_DUMMY';
...
DELETE FROM Civilization_Start_Region_Priority
WHERE CivilizationType = 'CIVILIZATION_SIAM' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );
...
WHERE Type = 'BUILDING_PAPER_MAKER' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_WONDERS' AND Value= 1 );
...
VALUES
	('BUILDING_INDUS_CANAL', 'FLAVOR_GROWTH', 25),
	('BUILDING_INDUS_CANAL', 'FLAVOR_SCIENCE', 15),
	('BUILDING_INDUS_CANAL', 'FLAVOR_PRODUCTION', 25),
...
VALUES
	...
	('BUILDING_AMERICA_SMITHSONIAN_DUMMY', 	'YIELD_GOLD', 	'YIELD_CULTURE', 	10),
	('BUILDING_AMERICA_HOOVERDAM_DUMMY', 	'YIELD_GOLD', 	'YIELD_PRODUCTION', 10),
	('BUILDING_AMERICA_WESTPOINT_DUMMY', 	'YIELD_GOLD', 	'YIELD_SCIENCE', 	10);
...
VALUES
	...
	('BUILDING_AMERICA_INDEPENDENCEHALL',	'FLAVOR_CULTURE',			80),
	('BUILDING_AMERICA_INDEPENDENCEHALL',	'FLAVOR_WONDER',			40),
	('BUILDING_AMERICA_SMITHSONIAN',		'FLAVOR_SCIENCE',			80),
	('BUILDING_AMERICA_SMITHSONIAN',		'FLAVOR_WONDER',			20),
	...
	('BUILDING_AMERICA_WESTPOINT',			'FLAVOR_WONDER',			20),
	('BUILDING_AMERICA_HOOVERDAM',			'FLAVOR_GOLD',				50),
	('BUILDING_AMERICA_HOOVERDAM',			'FLAVOR_PRODUCTION',		60),
	('BUILDING_AMERICA_HOOVERDAM',			'FLAVOR_WONDER',			20);
