...
VALUES		('GREAT_WORK_THE_CROWN_JEWELS', 'GREAT_WORK_ART',	'TXT_KEY_GREAT_WORK_THE_CROWN_JEWELS',		'TXT_KEY_GREAT_WORK_THE_CROWN_JEWELS_QUOTE',		null,	'TheJewelSplash.dds');
...
UPDATE Buildings
SET CityStateTradeRouteProductionModifier = '4'
WHERE Type = 'BUILDING_HANSE' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
...
VALUES
	('BUILDING_INDUS_CANAL', 'FEATURE_OASIS', 'YIELD_PRODUCTION', 2);
...
VALUES
	...
	('CIVILIZATION_ENGLAND', 'BUILDINGCLASS_INTELLIGENCE_AGENCY', 'BUILDING_WHITE_TOWER'),
