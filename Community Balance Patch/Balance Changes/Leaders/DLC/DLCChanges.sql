...
UPDATE Traits
SET GoldenAgeGreatArtistRateModifier = '25'
WHERE Type = 'TRAIT_SCHOLARS_JADE_HALL' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Traits
SET GoldenAgeGreatMusicianRateModifier = '25'
WHERE Type = 'TRAIT_SCHOLARS_JADE_HALL' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

UPDATE Traits
SET GoldenAgeGreatWriterRateModifier = '25'
WHERE Type = 'TRAIT_SCHOLARS_JADE_HALL' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_LEADERS' AND Value= 1 );

INSERT INTO Trait_GoldenAgeGreatPersonRateModifier
	(TraitType, GreatPersonType, Modifier)
VALUES
	('TRAIT_SCHOLARS_JADE_HALL', 'GREATPERSON_ENGINEER', 25),
	('TRAIT_SCHOLARS_JADE_HALL', 'GREATPERSON_SCIENTIST', 25),
	('TRAIT_SCHOLARS_JADE_HALL', 'GREATPERSON_MERCHANT', 25);
