...
VALUES
	('BUILDING_PYRAMID', 'YIELD_GOLDEN_AGE_POINTS', 250),
...
INSERT INTO Building_YieldFromVictoryGlobal (BuildingType, YieldType, Yield)
SELECT  'BUILDING_TERRACOTTA_ARMY' , 'YIELD_CULTURE' , '10'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_BUILDINGS' AND Value= 1 );
