...
-- Text for city view tooltip.
	...
	Text, Tag)
	SELECT '[NEWLINE][ICON_BULLET][COLOR_POSITIVE_TEXT][ICON_HAPPINESS_1] Happiness Modifier: {1_Num}%[ENDCOLOR]', 'TXT_KEY_FOODMOD_HAPPY'
	WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_NATIONAL_HAPPINESS' AND Value= 0 );
