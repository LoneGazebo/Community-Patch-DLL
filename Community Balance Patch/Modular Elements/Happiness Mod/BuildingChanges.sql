...
SET Text = 'Requires Patronage. Grants 2 additional Delegates in the World Congress. Reduces [ICON_HAPPINESS_3] Illiteracy threshold by 1 in every City.'
...
UPDATE Language_en_US
SET Text = '+3 [ICON_GOLD] Gold, +2 [ICON_CULTURE] Culture, and +1 [ICON_HAPPINESS_1] Happiness from every Castle.[NEWLINE][NEWLINE]City must be built within 2 tiles of a Mountain that is inside your territory. Reduces [ICON_HAPPINESS_3] Boredom threshold by 1 in the City where it is built.'
...
UPDATE Language_en_US
SET Text = 'The empire enters a [ICON_GOLDEN_AGE] Golden Age. Reduces [ICON_HAPPINESS_3] Illiteracy threshold by 1 in every City.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Disorder threshold by 1 in the City where it is built. Each source of [ICON_RES_MARBLE] Marble and [ICON_RES_STONE] Stone worked by this City produce +1 [ICON_PRODUCTION] Production.[NEWLINE][NEWLINE]City must have at least one of these resources improved with a Quarry.[NEWLINE][NEWLINE]City must not be in Plains.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Boredom threshold by 1 in the City where it is built. City must have an improved source of [ICON_RES_HORSE] Horses or [ICON_RES_IVORY] Ivory nearby.'
...
UPDATE Language_en_US
SET Text = 'Length of [ICON_GOLDEN_AGE] Golden Ages increased by 50%. Reduces [ICON_HAPPINESS_3] Poverty threshold by 1 in every City.'
...
UPDATE Language_en_US
SET Text = 'City must have a Market. Reduces [ICON_HAPPINESS_3] Disorder threshold by 1 the City where it is built.'
...
UPDATE Language_en_US
SET Text = 'Requires no [ICON_GOLD] Gold maintenance. Reduces [ICON_HAPPINESS_3] Illiteracy threshold by 1 the City where it is built.[NEWLINE][NEWLINE]Should this city be captured, the amount of [ICON_GOLD] Gold plundered by the enemy is doubled.'
...
INSERT INTO Language_en_US (
Tag, Text)
SELECT 'TXT_KEY_WONDER_NOTRE_DAME_HELP', 'Reduces [ICON_HAPPINESS_3] Boredom and Illiteracy thresholds by 1 in the City where it is built.'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_CITY_HAPPINESS' AND Value= 1 );
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Illiteracy threshold in all cities by 1. The Eiffel Tower also provides +12 [ICON_TOURISM] Tourism.'
...
UPDATE Language_en_US
SET Text = 'Reduces [ICON_HAPPINESS_3] Poverty and Disorder thresholds by 1 in this city. Reduces enemy spy stealing rate by 25%.'
