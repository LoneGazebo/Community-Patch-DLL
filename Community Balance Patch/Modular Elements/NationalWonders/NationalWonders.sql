...
UPDATE Language_en_US
SET Text = 'This National Wonder reduces Unhappiness from Poverty and Vulnerability by 1 in all cities. It also provides +1 [ICON_CULTURE] Culture. A city must have a Colosseum before it can construct a Circus Maximus. Requires a national population of at least 15 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'This National Wonder increases the cultural output of the city in which it is constructed by 50%. It cannot be constructed unless the city has an Opera House. Requires a national population of at least 45 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'With its massive boost to [ICON_TOURISM] Tourism, the National Visitor Center is an excellent choice for civilizations that are trying to achieve a Culture victory, or attempting to increase your ideological impact on other civilizations. Build it in your top [ICON_TOURISM] Tourism city it has a Hotel. Requires a national population of at least 55 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Must have built a Colosseum in the city. The cost goes up the more cities there are in the empire. Requires a national population of at least 15 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = '+50% [ICON_CULTURE] Culture in this City. Contains 3 slots for Great Works of Art.[NEWLINE][NEWLINE]Must have built an Opera House in the city. The cost goes up the more cities there are in the empire. Requires a national population of at least 45 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Provides an additional spy and levels up all your existing spies. Also provides a 15% reduction in enemy spy effectiveness. Must have a Police Station in the city. Requires a national population of at least 50 before it can be constructed.'
...
UPDATE Language_en_US
SET Text = 'Must have built a Hotel in the city. The cost goes up the more cities there are in the empire. 100% of the [ICON_CULTURE] Culture from World Wonders, Natural Wonders, and Improvements (Landmarks, Moai, Chateau) is added to the [ICON_TOURISM] Tourism output of the city. [ICON_TOURISM] Tourism output from Great Works +100%. Requires a national population of at least 55 before it can be constructed.'
