...
INSERT INTO Defines (
Name, Value)
SELECT 'BALANCE_CULTURE_PERCENTAGE_VALUE', '50'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_WONDER_CONSOLATION_TWEAK_ENABLER' AND Value= 1 );
INSERT INTO Defines (
Name, Value)
SELECT 'BALANCE_GA_PERCENTAGE_VALUE', '50'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_WONDER_CONSOLATION_TWEAK_ENABLER' AND Value= 1 );
INSERT INTO Defines (
Name, Value)
SELECT 'BALANCE_SCIENCE_PERCENTAGE_VALUE', '25'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_WONDER_CONSOLATION_TWEAK_ENABLER' AND Value= 1 );
INSERT INTO Defines (
Name, Value)
SELECT 'BALANCE_FAITH_PERCENTAGE_VALUE', '25'
WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='COMMUNITY_CORE_BALANCE_WONDER_CONSOLATION_TWEAK_ENABLER' AND Value= 1 );