...
-- Science
UPDATE Language_en_US
SET Text = 'Each City adds +{1_Str}% to the [ICON_RESEARCH] Technology cost.'
...
UPDATE Language_en_US
SET Text = 'Each [ICON_PUPPET] non-Puppet City other than the Capital adds +{1_Str}% to the [ICON_CULTURE] Policy cost.'
