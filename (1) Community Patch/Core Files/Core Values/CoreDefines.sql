...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_HAPPINESS_POP_MULTIPLIER', '0'; -- Base modifier to needs based on # of citizens in cities you own (-100 = -1% per citizen, 100 = +1% per citizen). Modifier increases as cities grow. Disabled by default.
