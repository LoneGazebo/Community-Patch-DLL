...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_BOREDOM', '60'; -- Value by which yield/threshold difference is modified based on the remaining population
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_ILLITERACY', '60'; -- Value by which yield/threshold difference is modified based on the remaining population
...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_POVERTY', '120'; -- Value by which yield/threshold difference is modified based on the remaining population
