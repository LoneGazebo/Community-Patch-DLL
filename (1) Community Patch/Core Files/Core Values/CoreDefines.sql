...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_BOREDOM', '100'; -- Value by which yield/threshold difference is modified based on the remaining population
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_ILLITERACY', '100'; -- Value by which yield/threshold difference is modified based on the remaining population
...
INSERT INTO Defines (Name, Value) SELECT 'BALANCE_UNHAPPY_CITY_BASE_VALUE_POVERTY', '150'; -- Value by which yield/threshold difference is modified based on the remaining population
