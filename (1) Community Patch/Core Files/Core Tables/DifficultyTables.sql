...
ALTER TABLE HandicapInfos ADD COLUMN 'FreeXPPercentVSHuman' INTEGER DEFAULT 0;
...
ALTER TABLE HandicapInfos ADD COLUMN 'AIFreeXPPercentVSHuman' INTEGER DEFAULT 0;
