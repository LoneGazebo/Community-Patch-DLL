...
VALUES	
		('PROMOTION_PROMISED_LAND',		'TXT_KEY_PROMOTION_PROMISED_LAND',		'TXT_KEY_PROMOTION_PROMISED_LAND_HELP',		1,				'AS2D_IF_LEVELUP',	13,					'PROMOTION_ATLAS',	'PEDIA_SHARED',	'TXT_KEY_PROMOTION_PROMISED_LAND',		0, 					0, 					25);
--------------------------------	
-- Unit_FreePromotions
--------------------------------	
