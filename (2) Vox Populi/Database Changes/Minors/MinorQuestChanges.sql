...
-- PERSONAL QUESTS
-- Construct Route
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_ROUTE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE';
...
UPDATE Helper SET Weight = 50 WHERE QuestType = 'MINOR_CIV_QUEST_ROUTE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Connect Resource
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_CONNECT_RESOURCE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE';
...
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_CONNECT_RESOURCE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Build Wonder
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_CONSTRUCT_WONDER' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_CONSTRUCT_WONDER' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';

-- Generate Great Person
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_GREAT_PERSON' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_GREAT_PERSON' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Find Natural Wonder
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_FIND_NATURAL_WONDER' AND MinorCivTraitType IN ('MINOR_TRAIT_MARITIME', 'MINOR_TRAIT_RELIGIOUS');
...
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_BULLY_CITY_STATE' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC';
...
UPDATE Helper SET Weight = 50 WHERE QuestType = 'MINOR_CIV_QUEST_BULLY_CITY_STATE' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';

-- Denounce Player
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_DENOUNCE_MAJOR' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';

-- Spread Religion
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_SPREAD_RELIGION' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_SPREAD_RELIGION' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Establish Trade Route
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_TRADE_ROUTE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE';
...
UPDATE Helper SET Weight = 50 WHERE QuestType = 'MINOR_CIV_QUEST_TRADE_ROUTE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_TRADE_ROUTE' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';

-- Find City
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_FIND_CITY' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME';

-- Start War against Player
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_WAR' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_WAR' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Build National Wonder
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';
...
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC';

-- Find City-State
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_FIND_CITY_STATE' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME';

-- Liberate City-State
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_LIBERATION' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_LIBERATION' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';

-- Discover Land
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_EXPLORE_AREA' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_EXPLORE_AREA' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME' AND MinorCivPersonalityType IN ('MINOR_CIV_PERSONALITY_FRIENDLY', 'MINOR_CIV_PERSONALITY_NEUTRAL');

-- Conduct Spy Mission
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_SPY_MISSION' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE';
...
UPDATE Helper SET Weight = 50 WHERE QuestType = 'MINOR_CIV_QUEST_SPY_MISSION' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';
...
UPDATE Helper SET Weight = 0 WHERE QuestType = 'MINOR_CIV_QUEST_ACQUIRE_CITY' AND MinorCivTraitType <> 'MINOR_TRAIT_MILITARISTIC';
...
-- Faith Contest
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_FAITH' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS';
UPDATE Helper SET Weight = 45 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_FAITH' AND MinorCivTraitType = 'MINOR_TRAIT_RELIGIOUS' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';

-- Artsy Units Contest
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_ARTSY_UNITS' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED';
UPDATE Helper SET Weight = 45 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_ARTSY_UNITS' AND MinorCivTraitType = 'MINOR_TRAIT_CULTURED' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';

-- Sciencey Units Contest
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_SCIENCEY_UNITS' AND MinorCivTraitType = 'MINOR_TRAIT_MERCANTILE';
UPDATE Helper SET Weight = 45 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_SCIENCEY_UNITS' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_NEUTRAL';

-- Tech Contest
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_CONTEST_TECHS' AND MinorCivTraitType = 'MINOR_TRAIT_MILITARISTIC';
...
-- Archaeology
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_ARCHAEOLOGY' AND MinorCivTraitType IN ('MINOR_TRAIT_CULTURED', 'MINOR_TRAIT_MILITARISTIC', 'MINOR_TRAIT_RELIGIOUS');

-- Circumnavigation
UPDATE Helper SET Weight = 20 WHERE QuestType = 'MINOR_CIV_QUEST_CIRCUMNAVIGATION' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME';
UPDATE Helper SET Weight = 45 WHERE QuestType = 'MINOR_CIV_QUEST_CIRCUMNAVIGATION' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_FRIENDLY';

-- Quell Horde
UPDATE Helper SET Weight = 30 WHERE QuestType = 'MINOR_CIV_QUEST_HORDE';
UPDATE Helper SET Weight = 60 WHERE QuestType = 'MINOR_CIV_QUEST_HORDE' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';

-- Quell Rebellion
UPDATE Helper SET Weight = 50 WHERE QuestType = 'MINOR_CIV_QUEST_REBELLION';
UPDATE Helper SET Weight = 80 WHERE QuestType = 'MINOR_CIV_QUEST_REBELLION' AND MinorCivTraitType = 'MINOR_TRAIT_MARITIME' AND MinorCivPersonalityType = 'MINOR_CIV_PERSONALITY_HOSTILE';
