...
INSERT INTO CityEvent_ParentEvents
	(CityEventChoiceType, CityEventType)
VALUES
	('ESPIONAGE_EVENT_CHOICE_POISON_WATER', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	...
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DOUBLE_CROSS', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_FOCUS');

-- counterspy mission blocking. CheckForActive=0 means check the eventchoicelinker *is not active*
INSERT INTO CityEventChoice_EventLinks
	(CityEventChoiceType, CityEventChoiceLinker, CheckOnlyEventCity, CheckForActive)
VALUES
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_STEAL_FROM_TREASURY', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_ECONOMIC_TILES', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 1, 0),

	('ESPIONAGE_EVENT_CHOICE_CITY_DEFENSES', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_POISON_WATER', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_SABOTAGE_PRODUCTION', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 1, 0),

	('ESPIONAGE_EVENT_CHOICE_HIJACK', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_TOURISM', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_URBAN_UNREST', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_TOURISM', 1, 0),

	('ESPIONAGE_EVENT_CHOICE_STEAL_FAITH', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_RELIGION', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_STEAL_GW', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_RELIGION', 1, 0),
	('ESPIONAGE_EVENT_CHOICE_LEAFLETS', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_RELIGION', 1, 0);
...
INSERT INTO CityEventChoice_CityYieldModifier
	(CityEventChoiceType, YieldType, Yield)
VALUES
	('ESPIONAGE_EVENT_CHOICE_POISON_WATER', 'YIELD_FOOD', -50);

INSERT INTO CityEventChoice_YieldSiphon
	(CityEventChoiceType, YieldType, Yield)
VALUES
	('ESPIONAGE_EVENT_CHOICE_CITY_INFILTRATE', 'YIELD_GOLD', 10),
	('ESPIONAGE_EVENT_CHOICE_CITY_INFILTRATE', 'YIELD_SCIENCE', 10),
	('ESPIONAGE_EVENT_CHOICE_CITY_INFILTRATE', 'YIELD_CULTURE', 10);

CREATE TEMP TABLE SpyYieldHelper (
	CityEventChoiceType TEXT,
	YieldType TEXT
);

INSERT INTO SpyYieldHelper
VALUES
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 'YIELD_SCIENCE'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 'YIELD_CULTURE'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 'YIELD_PRODUCTION'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 'YIELD_CULTURE'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_RELIGION', 'YIELD_FAITH'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_RELIGION', 'YIELD_CULTURE'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_TOURISM', 'YIELD_TOURISM'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_TOURISM', 'YIELD_CULTURE'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DOUBLE_CROSS', 'YIELD_GOLD');

INSERT INTO CityEventChoice_YieldOnSpyIdentified
	(CityEventChoiceType, YieldType, Yield)
SELECT
	CityEventChoiceType, YieldType, 50
FROM SpyYieldHelper;

INSERT INTO CityEventChoice_YieldOnSpyKilled
	(CityEventChoiceType, YieldType, Yield)
SELECT
	CityEventChoiceType, YieldType, 150
FROM SpyYieldHelper;

DROP TABLE SpyYieldHelper;

-- Double-Cross Foreign Agents is an exception for identification
UPDATE CityEventChoice_YieldOnSpyIdentified SET Yield = 100 WHERE CityEventChoiceType = 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DOUBLE_CROSS';

INSERT INTO CityEventChoice_SpecialistYieldChange
	(CityEventChoiceType, SpecialistType, YieldType, YieldChange)
VALUES
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 'SPECIALIST_CIVIL_SERVANT', 'YIELD_GOLD', -1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 'SPECIALIST_CIVIL_SERVANT', 'YIELD_SCIENCE', -1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_NETWORK', 'SPECIALIST_CIVIL_SERVANT', 'YIELD_CULTURE', -1);
...
INSERT INTO CityEventChoice_ImprovementYieldChange
	(CityEventChoiceType, ImprovementType, YieldType, YieldChange)
SELECT
	'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', i.Type, y.Type, 2
FROM Improvements i, Yields y
WHERE i.NoFollowUp = 1 AND y.Type IN ('YIELD_PRODUCTION', 'YIELD_CULTURE_LOCAL');
