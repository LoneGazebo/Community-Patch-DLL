...
INSERT INTO CityEvent_ParentEvents
	(CityEventChoiceType, CityEventType)
VALUES
	('ESPIONAGE_EVENT_CHOICE_ESTABLISH_SURVEILLANCE', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_REVEAL_AREA', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_GOLD', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_FAITH', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_STOKE', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_TOURISM', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_SCIENCE', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	...
	('ESPIONAGE_EVENT_CHOICE_MILITARY_GARRISON', 'ESPIONAGE_EVENT_CHOICE_SELECT_FOCUS'),
	...
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_BASIC', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_QUELL', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_DEFENSE', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_FOCUS'),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'ESPIONAGE_EVENT_CHOICE_COUNTERSPY_FOCUS');

INSERT INTO CityEventChoice_YieldSiphon
	(CityEventChoiceType, YieldType, Yield)
VALUES
	('ESPIONAGE_EVENT_CHOICE_SIPHON_GOLD', 'YIELD_GOLD', 50),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_SCIENCE', 'YIELD_SCIENCE', 50),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_FAITH', 'YIELD_FAITH', 75),
	('ESPIONAGE_EVENT_CHOICE_SIPHON_TOURISM', 'YIELD_TOURISM', 75);

INSERT INTO CityEventChoice_ImprovementDestructionRandom
	(CityEventChoiceType, ImprovementType, Number)
VALUES
	('ESPIONAGE_EVENT_CHOICE_ECONOMIC_TILES', 'IMPROVEMENT_FARM', 1),
	('ESPIONAGE_EVENT_CHOICE_ECONOMIC_TILES', 'IMPROVEMENT_MINE', 1),
	('ESPIONAGE_EVENT_CHOICE_ECONOMIC_TILES', 'IMPROVEMENT_PLANTATION', 1),
	('ESPIONAGE_EVENT_CHOICE_ECONOMIC_TILES', 'IMPROVEMENT_TRADING_POST', 1);

INSERT INTO CityEventChoice_SpecialistYieldChange
	(CityEventChoiceType, SpecialistType, YieldType, YieldChange)
VALUES
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_ENGINEER', 'YIELD_PRODUCTION', -1),
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_MERCHANT', 'YIELD_GOLD', -1),
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_SCIENTIST', 'YIELD_SCIENCE', -1),
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_WRITER', 'YIELD_CULTURE', -1),
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_ARTIST', 'YIELD_CULTURE', -1),
	('ESPIONAGE_EVENT_CHOICE_SCIENTIFIC_GREATPEOPLE', 'SPECIALIST_MUSICIAN', 'YIELD_CULTURE', -1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_ENGINEER', 'YIELD_PRODUCTION', 1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_MERCHANT', 'YIELD_GOLD', 1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_SCIENTIST', 'YIELD_SCIENCE', 1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_WRITER', 'YIELD_CULTURE', 1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_ARTIST', 'YIELD_CULTURE', 1),
	('ESPIONAGE_EVENT_CHOICE_COUNTERSPY_SPECIALIST', 'SPECIALIST_MUSICIAN', 'YIELD_CULTURE', 1);

INSERT INTO CityEventChoice_Notification
	(CityEventChoiceType, NotificationType, Description, ShortDescription, EspionageEvent, NeedCityCoordinates)
SELECT
	Type, 'NOTIFICATION_SPY_RIG_ELECTION_SUCCESS', 'TXT_KEY_ESPIONAGE_EVENT_CHOICE_SUCCESS', 'TXT_KEY_ESPIONAGE_EVENT_CHOICE_SUCCESS_S', 1, 1
FROM CityEventChoices
WHERE IsEspionageEffect = 1 AND IsSurveillance = 0 AND ExpiresOnCounterSpyExit = 0;
