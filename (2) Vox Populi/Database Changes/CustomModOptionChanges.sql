...
SET Value = 0
WHERE Name = 'BALANCE_CITY_STATE_TRAITS';

UPDATE CustomModOptions
SET Value = 0
WHERE Name = 'BALANCE_CITY_STATE_PERSONALITIES';
...
UPDATE CustomModOptions
SET Value = 1
WHERE Name = 'BALANCE_CORE_HAPPINESS_NATIONAL';

UPDATE CustomModOptions
SET Value = 0
WHERE Name = 'BALANCE_CORE_UNCAPPED_UNHAPPINESS';
...
UPDATE CustomModOptions
SET Value = 0
WHERE Name = 'BALANCE_CORE_SETTLER_RESET_FOOD';
...
UPDATE CustomModOptions
SET Value = 1
WHERE Name = 'BALANCE_CORE_HAPPINESS_MODIFIERS';
