...
UPDATE Beliefs
SET
	SciencePerOtherReligionFollower = 0,
	CityScalerLimiter = 25
WHERE Type = 'BELIEF_INTERFAITH_DIALOGUE';

INSERT INTO Belief_GreatPersonRateModifier
	(BeliefType, GreatPersonType, Modifier)
VALUES
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_GENERAL', 33),
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_ADMIRAL', 33);

INSERT INTO Belief_GreatPersonBornYield
	(BeliefType, GreatPersonType, YieldType, Yield)
VALUES
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_GENERAL', 'YIELD_GOLD', 75),
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_GENERAL', 'YIELD_FAITH', 75),
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_ADMIRAL', 'YIELD_GOLD', 75),
	('BELIEF_INTERFAITH_DIALOGUE', 'GREATPERSON_ADMIRAL', 'YIELD_FAITH', 75);
...
VALUES
	...
	('BELIEF_INITIATION_RITES', 'BUILDINGCLASS_HEAVENLY_GROTTO'),
