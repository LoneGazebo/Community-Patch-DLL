...
SET
	...
	DefaultUnitAI = 'UNITAI_FAST_ATTACK', -- fixme: this should be changed to UNITAI_FAST_ATTACK once a solution is found for the AI spamming Conquistadors that upgrade into exploration units
	Found = 1,
	FoundMid = 1,
	NoMinorCivGift = 1
