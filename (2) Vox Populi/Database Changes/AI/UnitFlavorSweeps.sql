...
-----------------------------------------
	...
	('UNIT_ASAMU', 'FLAVOR_EXPANSION', 50),
...
-----------------------------------------
	...
	('UNIT_OTOMI', 'FLAVOR_OFFENSE', 3),
	('UNIT_OTOMI', 'FLAVOR_DEFENSE', 5),
	('UNIT_OTOMI', 'FLAVOR_RECON', 1),
	...
	('UNIT_SABUM_KIBITUM', 'FLAVOR_OFFENSE', 5),
	('UNIT_SABUM_KIBITUM', 'FLAVOR_DEFENSE', 7),
	...
	('UNIT_GOEDENDAG', 'FLAVOR_OFFENSE', 10),
	('UNIT_GOEDENDAG', 'FLAVOR_DEFENSE', 12),

	('UNIT_FREE_COMPANY', 'FLAVOR_OFFENSE', 9),
	('UNIT_FREE_COMPANY', 'FLAVOR_DEFENSE', 9),

	-- Swordsman
	('UNIT_SWORDSMAN', 'FLAVOR_OFFENSE', 5),
	('UNIT_SWORDSMAN', 'FLAVOR_DEFENSE', 5),
	...
	('UNIT_BARBARIAN_SWORDSMAN', 'FLAVOR_OFFENSE', 4),
	('UNIT_BARBARIAN_SWORDSMAN', 'FLAVOR_DEFENSE', 4),

	-- Longswordsman
	('UNIT_LONGSWORDSMAN', 'FLAVOR_OFFENSE', 8),
	('UNIT_LONGSWORDSMAN', 'FLAVOR_DEFENSE', 8),

	('UNIT_AZTEC_JAGUAR', 'FLAVOR_OFFENSE', 11),
	('UNIT_AZTEC_JAGUAR', 'FLAVOR_DEFENSE', 11),

	('UNIT_CHEWA', 'FLAVOR_OFFENSE', 11),
	('UNIT_CHEWA', 'FLAVOR_DEFENSE', 11),

	('UNIT_INTI_MACEMAN', 'FLAVOR_OFFENSE', 11),
	('UNIT_INTI_MACEMAN', 'FLAVOR_DEFENSE', 11),

	('UNIT_JAPANESE_SAMURAI', 'FLAVOR_OFFENSE', 11),
	('UNIT_JAPANESE_SAMURAI', 'FLAVOR_DEFENSE', 11),

	-- Tercio
	('UNIT_SPANISH_TERCIO', 'FLAVOR_OFFENSE', 10),
	('UNIT_SPANISH_TERCIO', 'FLAVOR_DEFENSE', 10),

	('UNIT_ZULU_IMPI', 'FLAVOR_OFFENSE', 14),
	...
	('UNIT_YELLOW_BROW', 'FLAVOR_OFFENSE', 13),
	('UNIT_YELLOW_BROW', 'FLAVOR_DEFENSE', 14),

	-- Fusilier
	('UNIT_RIFLEMAN', 'FLAVOR_OFFENSE', 12),
	('UNIT_RIFLEMAN', 'FLAVOR_DEFENSE', 12),

	('UNIT_SWEDISH_CAROLEAN', 'FLAVOR_OFFENSE', 16),
	('UNIT_SWEDISH_CAROLEAN', 'FLAVOR_DEFENSE', 15),

	('UNIT_GRENZER', 'FLAVOR_OFFENSE', 15),
	('UNIT_GRENZER', 'FLAVOR_DEFENSE', 15),

	('UNIT_REDCOAT', 'FLAVOR_OFFENSE', 15),
	('UNIT_REDCOAT', 'FLAVOR_DEFENSE', 15),
	...
	('UNIT_MERCENARY', 'FLAVOR_OFFENSE', 19),
	('UNIT_MERCENARY', 'FLAVOR_DEFENSE', 19),
...
-----------------------------------------
	...
	('UNIT_CARTHAGINIAN_FOREST_ELEPHANT', 'FLAVOR_OFFENSE', 10), -- Atlas Elephant
	('UNIT_CARTHAGINIAN_FOREST_ELEPHANT', 'FLAVOR_DEFENSE', 4),
	('UNIT_CARTHAGINIAN_FOREST_ELEPHANT', 'FLAVOR_MOBILE', 6),

	('UNIT_TARKHAN', 'FLAVOR_OFFENSE', 10),
	('UNIT_TARKHAN', 'FLAVOR_DEFENSE', 4),
	('UNIT_TARKHAN', 'FLAVOR_MOBILE', 7),
	...
	-- Iron Chariot
	('UNIT_IRON_CHARIOT', 'FLAVOR_OFFENSE', 11),
	('UNIT_IRON_CHARIOT', 'FLAVOR_DEFENSE', 5),
	('UNIT_IRON_CHARIOT', 'FLAVOR_MOBILE', 7),
	...
	('UNIT_BYZANTINE_CATAPHRACT', 'FLAVOR_DEFENSE', 8),
	('UNIT_BYZANTINE_CATAPHRACT', 'FLAVOR_MOBILE', 8),
	...
	('UNIT_SIAMESE_WARELEPHANT', 'FLAVOR_OFFENSE', 13),
	('UNIT_SIAMESE_WARELEPHANT', 'FLAVOR_DEFENSE', 8),
	('UNIT_SIAMESE_WARELEPHANT', 'FLAVOR_MOBILE', 8),

	('UNIT_BLACK_TUG', 'FLAVOR_OFFENSE', 12),
	('UNIT_BLACK_TUG', 'FLAVOR_DEFENSE', 6),
	('UNIT_BLACK_TUG', 'FLAVOR_MOBILE', 9),
	...
	('UNIT_POLISH_WINGED_HUSSAR', 'FLAVOR_MOBILE', 12),

	('UNIT_MAMLUK', 'FLAVOR_OFFENSE', 17),
	('UNIT_MAMLUK', 'FLAVOR_DEFENSE', 15),
	('UNIT_MAMLUK', 'FLAVOR_MOBILE', 11),

	('UNIT_QIZILBASH', 'FLAVOR_OFFENSE', 17),
	('UNIT_QIZILBASH', 'FLAVOR_DEFENSE', 15),
	('UNIT_QIZILBASH', 'FLAVOR_MOBILE', 11),
...
-----------------------------------------
	...
	-- Slinger
	('UNIT_INCAN_SLINGER', 'FLAVOR_OFFENSE', 1),
	('UNIT_INCAN_SLINGER', 'FLAVOR_DEFENSE', 1),
	('UNIT_INCAN_SLINGER', 'FLAVOR_RANGED', 3),

	('UNIT_WARAKAQ', 'FLAVOR_OFFENSE', 2),
	('UNIT_WARAKAQ', 'FLAVOR_DEFENSE', 2),
	('UNIT_WARAKAQ', 'FLAVOR_RANGED', 6),

	('UNIT_BARBARIAN_AXMAN', 'FLAVOR_OFFENSE', 1),
	('UNIT_BARBARIAN_AXMAN', 'FLAVOR_DEFENSE', 1),
	('UNIT_BARBARIAN_AXMAN', 'FLAVOR_RANGED', 3),

	-- Archer
	('UNIT_ARCHER', 'FLAVOR_OFFENSE', 2),
	('UNIT_ARCHER', 'FLAVOR_DEFENSE', 2),
	...
	('UNIT_DHANURDHARA', 'FLAVOR_OFFENSE', 4),
	('UNIT_DHANURDHARA', 'FLAVOR_DEFENSE', 4),
	('UNIT_DHANURDHARA', 'FLAVOR_RANGED', 7),

	('UNIT_BARBARIAN_ARCHER', 'FLAVOR_OFFENSE', 2),
	...
	('UNIT_SOFA', 'FLAVOR_OFFENSE', 10),
	('UNIT_SOFA', 'FLAVOR_DEFENSE', 10),
	('UNIT_SOFA', 'FLAVOR_RANGED', 11),

	('UNIT_ENGLISH_LONGBOWMAN', 'FLAVOR_OFFENSE', 10),
	('UNIT_ENGLISH_LONGBOWMAN', 'FLAVOR_DEFENSE', 10),
	('UNIT_ENGLISH_LONGBOWMAN', 'FLAVOR_RANGED', 12),
	...
	('UNIT_PROWLER', 'FLAVOR_OFFENSE', 12),
	('UNIT_PROWLER', 'FLAVOR_DEFENSE', 12),
	('UNIT_PROWLER', 'FLAVOR_RANGED', 13),
	('UNIT_PROWLER', 'FLAVOR_MOBILE', 4),
	...
	('UNIT_CACADOR', 'FLAVOR_OFFENSE', 14),
	('UNIT_CACADOR', 'FLAVOR_DEFENSE', 14),
	('UNIT_CACADOR', 'FLAVOR_RANGED', 15),
...
-----------------------------------------
	...
	-- Chariot Archer
	('UNIT_CHARIOT_ARCHER', 'FLAVOR_OFFENSE', 2),
	('UNIT_CHARIOT_ARCHER', 'FLAVOR_DEFENSE', 2),
	('UNIT_CHARIOT_ARCHER', 'FLAVOR_RANGED', 2),
	('UNIT_CHARIOT_ARCHER', 'FLAVOR_MOBILE', 2),
	...
	('UNIT_EGYPTIAN_WARCHARIOT', 'FLAVOR_MOBILE', 6),
	...
	('UNIT_HUN_HORSE_ARCHER', 'FLAVOR_OFFENSE', 6),
	('UNIT_HUN_HORSE_ARCHER', 'FLAVOR_DEFENSE', 6),
	('UNIT_HUN_HORSE_ARCHER', 'FLAVOR_RANGED', 7),
	('UNIT_HUN_HORSE_ARCHER', 'FLAVOR_MOBILE', 9),

	('UNIT_SCYTHED_CHARIOT', 'FLAVOR_OFFENSE', 6),
	('UNIT_SCYTHED_CHARIOT', 'FLAVOR_DEFENSE', 6),
	('UNIT_SCYTHED_CHARIOT', 'FLAVOR_RANGED', 9),
	('UNIT_SCYTHED_CHARIOT', 'FLAVOR_MOBILE', 8),

	-- Heavy Skirmisher
	('UNIT_HEAVY_SKIRMISHER', 'FLAVOR_OFFENSE', 5),
	('UNIT_HEAVY_SKIRMISHER', 'FLAVOR_DEFENSE', 5),
	('UNIT_HEAVY_SKIRMISHER', 'FLAVOR_RANGED', 6),
	('UNIT_HEAVY_SKIRMISHER', 'FLAVOR_MOBILE', 8),
	...
	('UNIT_PANCERNY', 'FLAVOR_OFFENSE', 10),
	('UNIT_PANCERNY', 'FLAVOR_DEFENSE', 11),
	('UNIT_PANCERNY', 'FLAVOR_RANGED', 9),
	('UNIT_PANCERNY', 'FLAVOR_MOBILE', 11),
	...
	('UNIT_OROMO_CAVALRY', 'FLAVOR_OFFENSE', 12),
	('UNIT_OROMO_CAVALRY', 'FLAVOR_DEFENSE', 12),
	('UNIT_OROMO_CAVALRY', 'FLAVOR_RANGED', 11),
	('UNIT_OROMO_CAVALRY', 'FLAVOR_MOBILE', 13),

	('UNIT_INDIAN_WARELEPHANT', 'FLAVOR_OFFENSE', 14),
	('UNIT_INDIAN_WARELEPHANT', 'FLAVOR_DEFENSE', 14),
	('UNIT_INDIAN_WARELEPHANT', 'FLAVOR_RANGED', 11),
	('UNIT_INDIAN_WARELEPHANT', 'FLAVOR_MOBILE', 12),

	('UNIT_SWEDISH_HAKKAPELIITTA', 'FLAVOR_OFFENSE', 12),
	('UNIT_SWEDISH_HAKKAPELIITTA', 'FLAVOR_DEFENSE', 12),
	('UNIT_SWEDISH_HAKKAPELIITTA', 'FLAVOR_RANGED', 11),
	('UNIT_SWEDISH_HAKKAPELIITTA', 'FLAVOR_MOBILE', 13),
	...
	('UNIT_BERBER_CAVALRY', 'FLAVOR_RECON', 14),
	...
	('UNIT_SHOSHONE_COMANCHE_RIDERS', 'FLAVOR_MOBILE', 16),
	...
	('UNIT_HASHEMITE_RAIDER', 'FLAVOR_OFFENSE', 20),
	('UNIT_HASHEMITE_RAIDER', 'FLAVOR_DEFENSE', 18),
	('UNIT_HASHEMITE_RAIDER', 'FLAVOR_RANGED', 15),
	('UNIT_HASHEMITE_RAIDER', 'FLAVOR_MOBILE', 17),
...
-----------------------------------------
	...
	('UNIT_ROMAN_BALLISTA', 'FLAVOR_DEFENSE', 5),
	...
	('UNIT_KOREAN_HWACHA', 'FLAVOR_OFFENSE', 10),
	('UNIT_KOREAN_HWACHA', 'FLAVOR_DEFENSE', 8),
	('UNIT_KOREAN_HWACHA', 'FLAVOR_RANGED', 12),
	...
	-- Great Bombard
	('UNIT_GREAT_BOMBARD', 'FLAVOR_OFFENSE', 15),
	('UNIT_GREAT_BOMBARD', 'FLAVOR_DEFENSE', 6),
	('UNIT_GREAT_BOMBARD', 'FLAVOR_RANGED', 12),
	...
	('UNIT_LICORNE', 'FLAVOR_OFFENSE', 17),
	('UNIT_LICORNE', 'FLAVOR_DEFENSE', 13),
	('UNIT_LICORNE', 'FLAVOR_RANGED', 15),
	('UNIT_LICORNE', 'FLAVOR_MOBILE', 2),

	('UNIT_SUEA_MOP', 'FLAVOR_OFFENSE', 14),
	('UNIT_SUEA_MOP', 'FLAVOR_DEFENSE', 16),
	('UNIT_SUEA_MOP', 'FLAVOR_RANGED', 15),
	...
	('UNIT_KRUPP_GUN', 'FLAVOR_OFFENSE', 22),
	('UNIT_KRUPP_GUN', 'FLAVOR_DEFENSE', 18),
	('UNIT_KRUPP_GUN', 'FLAVOR_RANGED', 18),
...
-----------------------------------------
	...
	('UNIT_BANDEIRANTE', 'FLAVOR_RECON', 18),

	('UNIT_SPANISH_CONQUISTADOR', 'FLAVOR_RECON', 14),
	...
	('UNIT_KLEPHT', 'FLAVOR_RECON', 17),
	('UNIT_KLEPHT', 'FLAVOR_OFFENSE', 14),
	('UNIT_KLEPHT', 'FLAVOR_DEFENSE', 12),
...
-----------------------------------------
	...
	('UNIT_VP_GALLEY', 'FLAVOR_NAVAL_RECON', 7),

	('UNIT_VAKA_NUI', 'FLAVOR_NAVAL', 13),
	('UNIT_VAKA_NUI', 'FLAVOR_NAVAL_RECON', 16),

	-- Trireme
	('UNIT_TRIREME', 'FLAVOR_NAVAL', 12),
	('UNIT_TRIREME', 'FLAVOR_NAVAL_RECON', 10),

	('UNIT_CARTHAGINIAN_QUINQUEREME', 'FLAVOR_NAVAL', 16),
	('UNIT_CARTHAGINIAN_QUINQUEREME', 'FLAVOR_NAVAL_RECON', 15),
	...
	('UNIT_PORTUGUESE_NAU', 'FLAVOR_NAVAL_RECON', 30),
	('UNIT_PORTUGUESE_NAU', 'FLAVOR_GOLD', 10),

	('UNIT_KOREAN_TURTLE_SHIP', 'FLAVOR_NAVAL', 21),
	('UNIT_KOREAN_TURTLE_SHIP', 'FLAVOR_NAVAL_RECON', 26),

	('UNIT_LONGSHIP', 'FLAVOR_NAVAL', 20),
	('UNIT_LONGSHIP', 'FLAVOR_NAVAL_RECON', 27),

	-- Corvette
	('UNIT_PRIVATEER', 'FLAVOR_NAVAL', 19),
	('UNIT_PRIVATEER', 'FLAVOR_NAVAL_RECON', 26),

	('UNIT_DUTCH_SEA_BEGGAR', 'FLAVOR_NAVAL', 24),
	('UNIT_DUTCH_SEA_BEGGAR', 'FLAVOR_NAVAL_RECON', 29),

	('UNIT_CORSAIR', 'FLAVOR_NAVAL', 23),
	('UNIT_CORSAIR', 'FLAVOR_NAVAL_RECON', 30),

	('UNIT_ARMADA', 'FLAVOR_NAVAL', 24),
	('UNIT_ARMADA', 'FLAVOR_NAVAL_RECON', 29),

	-- Ironclad
	('UNIT_IRONCLAD', 'FLAVOR_NAVAL', 22),
	('UNIT_IRONCLAD', 'FLAVOR_NAVAL_RECON', 28),

	('UNIT_MONITOR', 'FLAVOR_NAVAL', 30),
	('UNIT_MONITOR', 'FLAVOR_NAVAL_RECON', 34),

	('UNIT_AMAZONAS', 'FLAVOR_NAVAL', 30),
	('UNIT_AMAZONAS', 'FLAVOR_NAVAL_RECON', 34),

	-- Destroyer
	('UNIT_DESTROYER', 'FLAVOR_NAVAL', 28),
	('UNIT_DESTROYER', 'FLAVOR_NAVAL_RECON', 32),

	-- Fleet Destroyer
	('UNIT_FLEET_DESTROYER', 'FLAVOR_NAVAL', 34),
	('UNIT_FLEET_DESTROYER', 'FLAVOR_NAVAL_RECON', 36),

	-- Sensor Combat Ship
	('UNIT_SENSOR_COMBAT_SHIP', 'FLAVOR_NAVAL', 40),
	('UNIT_SENSOR_COMBAT_SHIP', 'FLAVOR_NAVAL_RECON', 40),
	('UNIT_SENSOR_COMBAT_SHIP', 'FLAVOR_NUKE', 3),
...
-----------------------------------------
	...
	('UNIT_LIBURNA', 'FLAVOR_NAVAL_RECON', 5),

	('UNIT_BYZANTINE_DROMON', 'FLAVOR_NAVAL', 20),
	('UNIT_BYZANTINE_DROMON', 'FLAVOR_NAVAL_RECON', 9),

	-- Fusta
	('UNIT_FUSTA', 'FLAVOR_NAVAL', 14),
	('UNIT_FUSTA', 'FLAVOR_NAVAL_RECON', 12),

	-- Galleass
	('UNIT_GALLEASS', 'FLAVOR_NAVAL', 16),
	('UNIT_GALLEASS', 'FLAVOR_NAVAL_RECON', 9),

	('UNIT_VENETIAN_GALLEASS', 'FLAVOR_NAVAL', 22),
	('UNIT_VENETIAN_GALLEASS', 'FLAVOR_NAVAL_RECON', 12),

	('UNIT_DJONG', 'FLAVOR_NAVAL', 25),
	('UNIT_DJONG', 'FLAVOR_NAVAL_RECON', 15),
	...
	('UNIT_TREASURE_SHIP', 'FLAVOR_NAVAL', 34),
	('UNIT_TREASURE_SHIP', 'FLAVOR_NAVAL_RECON', 19),
	...
	('UNIT_MIKASA', 'FLAVOR_NAVAL', 45),
	('UNIT_MIKASA', 'FLAVOR_NAVAL_RECON', 23),

	-- Battleship
	('UNIT_BATTLESHIP', 'FLAVOR_NAVAL', 42),
	('UNIT_BATTLESHIP', 'FLAVOR_NAVAL_RECON', 22),

	('UNIT_YAMATO', 'FLAVOR_NAVAL', 54),
	('UNIT_YAMATO', 'FLAVOR_NAVAL_RECON', 25),

	-- Missile Cruiser
	('UNIT_MISSILE_CRUISER', 'FLAVOR_NAVAL', 48),
	('UNIT_MISSILE_CRUISER', 'FLAVOR_NAVAL_RECON', 24),
	('UNIT_MISSILE_CRUISER', 'FLAVOR_NUKE', 3),
...
-----------------------------------------
	...
	('UNIT_SPAD', 'FLAVOR_OFFENSE', 9),
	('UNIT_SPAD', 'FLAVOR_DEFENSE', 15),
	('UNIT_SPAD', 'FLAVOR_AIR', 15),
	('UNIT_SPAD', 'FLAVOR_ANTIAIR', 18),
