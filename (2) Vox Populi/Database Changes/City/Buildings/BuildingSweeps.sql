...
VALUES
	...
	('BUILDING_GYMNASION', 'TXT_KEY_THEMING_BONUS_AMPHITHEATER_GLOBAL', 6, 2),
	('BUILDING_NALANDA', 'TXT_KEY_THEMING_BONUS_BUILDING_NALANDA', 6, 2),
	...
	('BUILDING_CHARTARIUM', 'TXT_KEY_THEMING_BONUS_RELIGIOUS_LIBRARY', 8, 3), -- Has 3 slots with no specified era requirement, can wait
	...
	('BUILDING_MURANO_GLASSWORKS', 'TXT_KEY_THEMING_BONUS_MURANO_GLASSWORKS', 8, 2), -- Lax requirement
	('BUILDING_NOTRE_DAME', 'TXT_KEY_THEMING_BONUS_BUILDING_NOTRE_DAME', 8, 3),
	('BUILDING_INDEPENDENCE_HALL', 'TXT_KEY_THEMING_BONUS_INDEPENDENCEHALL', 8, 3),
	('BUILDING_SISTINE_CHAPEL', 'TXT_KEY_THEMING_BONUS_SISTINE_CHAPEL', 10, 4),
	('BUILDING_HERMITAGE', 'TXT_KEY_THEMING_BONUS_HERMITAGE', 15, 4),
	('BUILDING_UFFIZI', 'TXT_KEY_THEMING_BONUS_UFFIZI', 15, 5),
	('BUILDING_LOUVRE', 'TXT_KEY_THEMING_BONUS_LOUVRE', 15, 6), -- Not ideal, but Louvre often can't be themed if we theme Uffizi first
