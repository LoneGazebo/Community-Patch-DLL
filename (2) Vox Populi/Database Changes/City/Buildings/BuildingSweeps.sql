...
VALUES
	-- Literature
	('BUILDING_PALACE', 'TXT_KEY_THEMING_BONUS_PALACE', 6, 1), -- Has 3 slots with no requirements and a modest bonus, should be low priority
	...
	('BUILDING_UNIVERSITY_OF_COIMBRA', 'TXT_KEY_THEMING_BONUS_OXFORD_UNIVERSITY', 10, 5),
