...
UPDATE Builds
SET Time = 300
WHERE Type IN ('BUILD_ROAD', 'BUILD_RAILROAD');

UPDATE Builds
SET Time = 500
WHERE Type IN ('BUILD_PLANTATION', 'BUILD_ARCHAEOLOGY_DIG');
...
UPDATE Builds
SET Time = 700
WHERE Type IN ('BUILD_PASTURE', 'BUILD_QUARRY');
