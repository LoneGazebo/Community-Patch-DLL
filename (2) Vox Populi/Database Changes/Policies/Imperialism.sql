...
VALUES
	...
	('POLICY_MARITIME_INFRASTRUCTURE', 'POLICY_NAVIGATION_SCHOOL'),
	('POLICY_MARITIME_INFRASTRUCTURE', 'POLICY_TREASURE_FLEETS'),
...
VALUES
	...
	('POLICY_EXPLORATION', 'PROMOTION_IMPERIALISM'),
...
INSERT INTO Policy_FreePromotions
	(PolicyType, PromotionType)
VALUES
	('POLICY_NAVIGATION_SCHOOL', 'PROMOTION_REGIMENTAL_TRADITIONS');
...
VALUES
	('POLICY_NAVAL_TRADITION', 'BUILDINGCLASS_BASTION_FORT', 'YIELD_SCIENCE', 2),
...
VALUES
	('POLICY_NAVAL_TRADITION', 'BUILDINGCLASS_BASTION_FORT', 1),
...
VALUES
	...
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_CITADEL', 'YIELD_SCIENCE', 4),
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_CITADEL', 'YIELD_CULTURE', 4),
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_ORDO', 'YIELD_SCIENCE', 4),
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_ORDO', 'YIELD_CULTURE', 4),
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_ISIBAYA', 'YIELD_SCIENCE', 4),
	('POLICY_NAVAL_TRADITION', 'IMPROVEMENT_ISIBAYA', 'YIELD_CULTURE', 4);
...
SELECT
	'POLICY_MERCHANT_NAVY', a.Type, b.YieldType, b.Yield
FROM Resources a, Helper b
WHERE a.ResourceUsage = 2;
...
INSERT INTO Policy_FreePromotions
	(PolicyType, PromotionType)
VALUES
	('POLICY_EXPLORATION_FINISHER', 'PROMOTION_BANZAI');
