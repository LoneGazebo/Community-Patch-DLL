...
VALUES
	...
	('DEPTH_CHARGES', 'UNITCOMBAT_NAVALMELEE'),
	...
	-- Submarine tree
	('WOLFPACK', 'UNITCOMBAT_SUBMARINE'),
	('HULL', 'UNITCOMBAT_SUBMARINE'),
	('TARGETING', 'UNITCOMBAT_SUBMARINE'),
	-- Carrier tree
...
VALUES
	...
	('PROMOTION_SENTRY', 'UNITCOMBAT_SUBMARINE'),
	('PROMOTION_MOBILITY', 'UNITCOMBAT_SUBMARINE'),
	('PROMOTION_SUPPLY', 'UNITCOMBAT_SUBMARINE'),
	('PROMOTION_LOGISTICS', 'UNITCOMBAT_SUBMARINE'),
	-- Carrier tree
...
INSERT INTO UnitPromotions_UnitCombats
	(PromotionType, UnitCombatType)
SELECT
	'PROMOTION_NAVIGATOR_2', Type
FROM UnitCombatInfos
WHERE IsNaval = 1 AND IsRanged = 1;
...
OR Type IN (
	...
	'PROMOTION_PRIZE_RULES', -- Commerce Raiders
