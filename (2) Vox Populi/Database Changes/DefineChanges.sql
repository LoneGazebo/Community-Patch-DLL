...
UPDATE Defines SET Value = 3 WHERE Name = 'BALANCE_MOD_POLICY_BRANCHES_NEEDED_IDEOLOGY';
UPDATE Defines SET Value = 18 WHERE Name = 'BALANCE_MOD_POLICIES_NEEDED_IDEOLOGY';
