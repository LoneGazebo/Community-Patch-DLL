...
-- Route Quest Max Distance
UPDATE Defines SET Value = 11 WHERE Name = 'MINOR_CIV_QUEST_ROUTE_MAXIMUM_DISTANCE';

-- Disable City-State gold gifting
UPDATE Defines SET Value = 1 WHERE Name = 'CSD_GOLD_GIFT_DISABLED';
UPDATE Defines SET Value = 0 WHERE Name IN ('MINOR_GOLD_GIFT_SMALL', 'MINOR_GOLD_GIFT_MEDIUM', 'MINOR_GOLD_GIFT_LARGE');
...
UPDATE Defines SET Value = 1 WHERE Name = 'POLICY_COST_VISIBLE_DIVISOR';
