...
UPDATE Units SET Moves = 6 WHERE Class = 'UNITCLASS_HELICOPTER_GUNSHIP';
...
VALUES
	...
	('UNITCLASS_IRONCLAD', 60),
	('UNITCLASS_DESTROYER', 75),
	('UNITCLASS_MISSILE_CRUISER', 90);
...
VALUES
	...
	-- Submarine
	('UNITCLASS_SUBMARINE', 50, 65, 1),
	('UNITCLASS_NUCLEAR_SUBMARINE', 70, 80, 1),
	-- Carrier
	('UNITCLASS_CARRIER', 90, 45, 2),
	-- Fighter
	...
	-- Missile
	('UNITCLASS_GUIDED_MISSILE', 0, 150, 12),
	-- Nuke
...
VALUES
	...
	-- Naval Melee
	('UNITCLASS_IRONCLAD', 5),
	('UNITCLASS_DESTROYER', 30),
	('UNITCLASS_MISSILE_CRUISER', 35),
	-- Naval Ranged
	('UNITCLASS_CRUISER', 10),
	('UNITCLASS_BATTLESHIP', 25),
	-- Submarine
	('UNITCLASS_SUBMARINE', 5),
	('UNITCLASS_NUCLEAR_SUBMARINE', 10),
	-- Carrier
