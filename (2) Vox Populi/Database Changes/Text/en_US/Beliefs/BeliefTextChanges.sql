...
UPDATE Language_en_US
SET Text = 'Earn 33% more [ICON_GREAT_GENERAL] Great General and [ICON_GREAT_ADMIRAL] Great Admiral Points. When a [ICON_GREAT_GENERAL] Great General or [ICON_GREAT_ADMIRAL] Great Admiral is born, receive 75 [ICON_GOLD] Gold and [ICON_PEACE] Faith for every City following your [ICON_RELIGION] Religion (max 25 Cities).[NEWLINE]Unlocks [COLOR_POSITIVE_TEXT]Great Altar National Wonder[ENDCOLOR] (+5 [ICON_PEACE] Faith, +15% Military Unit [ICON_PRODUCTION] Production; +5 [ICON_PRODUCTION] Production from [ICON_RELIGION] Holy Sites; unlocks [COLOR_POSITIVE_TEXT]Reformation Belief[ENDCOLOR]).'
...
UPDATE Language_en_US
SET Text = '[ICON_INQUISITOR] Inquisitors cost 33% less [ICON_PEACE] Faith. If stationed in a City, your [ICON_SPY] Spies provide +2 [ICON_HAPPINESS_1] Happiness and reduce existing pressure from other religions by 26 per turn (Standard Speed). Spies stationed in a foreign City also gain +8 Network Points per turn.'
...
UPDATE Language_en_US
SET Text = 'Land Units gain +10% [ICON_STRENGTH] Combat Strength versus Land Units in friendly territory, and an additional +5% versus Land Units of players that do not follow your Religion. +1 [ICON_PEACE] Faith and +2 [ICON_CULTURE] Culture from all Defensive Buildings.'
...
-- To the Glory of God
UPDATE Language_en_US
SET Text = 'May use [ICON_PEACE] Faith to purchase any type of [ICON_GREAT_PEOPLE] Great Person (in Industrial Era), but at 150% the normal cost unless unlocked by the respective Policy.'
