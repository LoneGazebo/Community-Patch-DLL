...
SET Text = 'Possible Theming Bonuses:
  ...
  [NEWLINE][ICON_BULLET] +5 [ICON_CULTURE] and [ICON_TOURISM] for a pair of [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_GW_ART] Great Works of Art and [ICON_ARTIFACT] from the [COLOR_CYAN]same Era[ENDCOLOR].
