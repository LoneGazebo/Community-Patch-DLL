...
UPDATE Language_en_US 
SET Text = 'Possible Theming Bonuses:
  [NEWLINE][ICON_BULLET] +6 [ICON_CULTURE] and [ICON_TOURISM] for two [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or two [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_GW_ART] Great Works of Art from the [COLOR_CYAN]same Era[ENDCOLOR].
  [NEWLINE][ICON_BULLET] +6 [ICON_CULTURE] and [ICON_TOURISM] for two [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or two [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_ARTIFACT] Artifacts from the [COLOR_CYAN]same Era[ENDCOLOR].
  [NEWLINE][ICON_BULLET] +5 [ICON_CULTURE] and [ICON_TOURISM] for a [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_GW_ART] Great Work of Art and [ICON_ARTIFACT] Artifact pair from the [COLOR_CYAN]same Era[ENDCOLOR].
  [NEWLINE][ICON_BULLET] +5 [ICON_CULTURE] and [ICON_TOURISM] for two [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or two [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_GW_ART] Great Works of Art.
  [NEWLINE][ICON_BULLET] +5 [ICON_CULTURE] and [ICON_TOURISM] for two [COLOR_POSITIVE_TEXT]Domestic[ENDCOLOR] or two [COLOR_POSITIVE_TEXT]Foreign[ENDCOLOR] [ICON_ARTIFACT] Artifacts.'
