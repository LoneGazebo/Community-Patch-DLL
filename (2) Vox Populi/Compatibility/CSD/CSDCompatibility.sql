...
VALUES
	('BELIEF_MISSIONARY_ZEAL', 'GREATPERSON_DIPLOMAT', 33);
...
VALUES
	('POLICY_LEGALISM', 'BUILDINGCLASS_PRINTING_PRESS', 25),
	('POLICY_LEGALISM', 'BUILDINGCLASS_FOREIGN_OFFICE', 25),
	('POLICY_LEGALISM', 'BUILDINGCLASS_PALACE_SCIENCE_CULTURE', 25),
	('POLICY_LEGALISM', 'BUILDINGCLASS_FINANCE_CENTER', 25),
	('POLICY_LEGALISM', 'BUILDINGCLASS_EHRENHALLE', 25);
...
INSERT INTO Concepts
	(Type, Topic, Description, Summary, AdvisorQuestion, Advisor, CivilopediaHeaderType, InsertAfter, InsertBefore)
VALUES
	('CONCEPT_SPECIALISTS_AND_GREAT_PEOPLE_SPECIALISTS_CIVIL_SERVANT', 'TXT_KEY_TOPIC_SPECIALISTSANDGP', 'TXT_KEY_SPECIALISTSANDGP_CIVIL_SERVANT_HEADING3_TITLE', 'TXT_KEY_SPECIALISTSANDGP_CIVIL_SERVANT_HEADING3_BODY', 'TXT_KEY_SPECIALISTSANDGP_CIVIL_SERVANT_ADV_QUEST', 'SCIENCE', 'HEADER_PEOPLE','CONCEPT_SPECIALISTS_AND_GREAT_PEOPLE_SPECIALISTS_SCIENTIST','CONCEPT_SPECIALISTS_AND_GREAT_PEOPLE_SPECIALISTS_ASSIGNING');
