...
VALUES
	...
	('BUILDING_GURDWARA', 'YIELD_FOOD', 10), --Religion gone need to be re-added
	('BUILDING_PALACE_SCIENCE_CULTURE', 'YIELD_SCIENCE', 5), --CSD buildign gone, need to be re-added
