...
INSERT INTO Language_en_US (Tag, Text)
SELECT 'TXT_KEY_BUILDING_STUPA_TOOLTIP', '+3 [ICON_PEACE] Faith[NEWLINE]+3 [ICON_GOLDEN_AGE] Golden Age Points[NEWLINE]+5 [ICON_TOURISM] Tourism[NEWLINE][NEWLINE]{TXT_KEY_BUILDING_STUPA_HELP}';
