...
UPDATE Language_en_US
SET Text = '[COLOR_POSITIVE_TEXT]Dominance[ENDCOLOR][NEWLINE]Killing a military Unit generates [ICON_RESEARCH] Science based on the [ICON_STRENGTH] Strength of the defeated Unit. Melee, Recon, Mounted Melee, Naval Melee, Gunpowder, and Armor Units heal for 15 points after killing a military Unit. Unit Supply generated by [ICON_CITIZEN] Population increased by 10%.'
