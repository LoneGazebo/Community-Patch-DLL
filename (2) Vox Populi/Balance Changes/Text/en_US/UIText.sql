...
UPDATE Language_en_US
SET Text = 'Happiness in your empire can come from the following sources:[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Starting Happiness[ENDCOLOR]: The amount of Happiness that your civilization begins with is determined by the game''s difficulty setting. Starting Happiness will become less important over time as Happiness and Unhappiness from other sources grow. [NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Natural Wonders and Landmarks[ENDCOLOR]: Discovering Natural Wonders or using Archaeologists to build Landmarks (in your own or in other player''s lands) gives you a small Happiness bonus.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]City States[ENDCOLOR]: Mercantile City States provide you with a Happiness bonus if you are friends or allies with them.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Vassals[ENDCOLOR]: If you have vassalized other civilizations, they will provide you with some additional Happiness based on their own Happiness Level.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Luxury Resources[ENDCOLOR]: You receive Happiness for each type of Luxury Resource connected to your empire. The Happiness given by Luxuries scales with the total population in your empire. Luxuries are therefore less vital early on, but also not useless in the late game. Moreover, Monopolies on some Luxury Resources grant additional Happiness to your empire.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]Locally Generated Happiness[ENDCOLOR]: Certain Buildings increase your local Happiness in the Cities where they are built. Other sources of Local Happiness include Religious Beliefs, Policies, World Wonders and Events. Note that this does not apply to Puppet Cities and Occupied Cities, which can never generate Local Happiness.'
...
[COLOR_NEGATIVE_TEXT]Pillaged Tiles[ENDCOLOR]: A city gains 1 Unhappiness for every two pillaged tiles in its vicinity. People don''t like seeing their houses burning and will start generating Unhappiness until to do something about it.[NEWLINE]
