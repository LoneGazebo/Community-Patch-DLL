	...
	INSERT INTO Language_en_US (Tag, Text)
	SELECT 'TXT_KEY_BUILD_CONSUMED_HELP_ACADEMY', 'Unit will be consumed.[NEWLINE][NEWLINE]Great Tile Improvements will connect Strategic Resources on this tile to the trade network. Academies will improve a Great Scientist''s Discover Technology ability by 10%.';
