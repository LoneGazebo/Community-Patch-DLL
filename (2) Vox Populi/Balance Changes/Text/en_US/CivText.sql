...
--------------------
UPDATE Language_en_US
SET Text = 'Mounted Ranged Units gain +2 [ICON_MOVES] Movement and ignore [COLOR_POSITIVE_TEXT]Zone of Control[ENDCOLOR]. +50% Tribute Yields from [ICON_CITY_STATE] City-State bullying.'
