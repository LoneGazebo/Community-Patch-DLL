-- RANGED UNITS
	...
	UPDATE Units SET PrereqTech = 'TECH_CALENDAR', ObsoleteTech = 'TECH_MACHINERY' WHERE Type = 'UNIT_BABYLONIAN_BOWMAN';
	UPDATE Units SET PrereqTech = 'TECH_CALENDAR', ObsoleteTech = 'TECH_CURRENCY' WHERE Type = 'UNIT_BARBARIAN_ARCHER';
	...
	-- Siege
	UPDATE Units SET PrereqTech = 'TECH_CONSTRUCTION' WHERE Type = 'UNIT_CATAPULT';
	UPDATE Units SET PrereqTech = 'TECH_CONSTRUCTION', ObsoleteTech = 'TECH_PHYSICS' WHERE Type = 'UNIT_ROMAN_BALLISTA';
