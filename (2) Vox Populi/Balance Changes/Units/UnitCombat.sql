...
-----------------
-- Ancient --
UPDATE Units SET RangedCombat = '6' WHERE Type = 'UNIT_VP_SLINGER';
UPDATE Units SET RangedCombat = '7' WHERE Type = 'UNIT_INCAN_SLINGER';

UPDATE Units SET RangedCombat = '9' WHERE Type = 'UNIT_ARCHER';
UPDATE Units SET RangedCombat = '9' WHERE Type = 'UNIT_BARBARIAN_ARCHER';
UPDATE Units SET RangedCombat = '10' WHERE Type = 'UNIT_BABYLONIAN_BOWMAN';
...
UPDATE Units SET RangedCombat = '31' WHERE Type = 'UNIT_CAVALRY';
UPDATE Units SET RangedCombat = '34' WHERE Type = 'UNIT_BERBER_CAVALRY';
UPDATE Units SET RangedCombat = '35' WHERE Type = 'UNIT_SHOSHONE_COMANCHE_RIDERS';
UPDATE Units SET RangedCombat = '37' WHERE Type = 'UNIT_RUSSIAN_COSSACK';
...
-- Ranged
UPDATE Units SET Combat = '5' WHERE Type = 'UNIT_VP_SLINGER';
UPDATE Units SET Combat = '6' WHERE Type = 'UNIT_INCAN_SLINGER';

UPDATE Units SET Combat = '6' WHERE Type = 'UNIT_ARCHER';
UPDATE Units SET Combat = '5' WHERE Type = 'UNIT_BARBARIAN_ARCHER';
UPDATE Units SET Combat = '8' WHERE Type = 'UNIT_BABYLONIAN_BOWMAN';
...
UPDATE Units SET Combat = '16' WHERE Type = 'UNIT_SWORDSMAN';
...
-- Ranged
UPDATE Units SET Combat = '5' WHERE Type = 'UNIT_CATAPULT';
UPDATE Units SET Combat = '6' WHERE Type = 'UNIT_ROMAN_BALLISTA';

UPDATE Units SET Combat = '12' WHERE Type = 'UNIT_COMPOSITE_BOWMAN';
UPDATE Units SET Combat = '13' WHERE Type = 'UNIT_MAYAN_ATLATLIST';
...
UPDATE Units SET Combat = '23' WHERE Type = 'UNIT_SPANISH_CONQUISTADOR';
...
-- Ranged
UPDATE Units SET Combat = '8' WHERE Type = 'UNIT_TREBUCHET';
UPDATE Units SET Combat = '9' WHERE Type = 'UNIT_KOREAN_HWACHA';
...
UPDATE Units SET Combat = '39' WHERE Type = 'UNIT_OTTOMAN_SIPAHI';
UPDATE Units SET Combat = '40' WHERE Type = 'UNIT_POLISH_WINGED_HUSSAR';
-- Ranged
UPDATE Units SET Combat = '11' WHERE Type = 'UNIT_CANNON';
...
-- Ranged
UPDATE Units SET Combat = '17' WHERE Type = 'UNIT_FIELD_GUN';
...
UPDATE Units SET Combat = '44' WHERE Type = 'UNIT_RUSSIAN_COSSACK';
...
UPDATE Units SET Combat = '27' WHERE Type = 'UNIT_ARTILLERY';
...
UPDATE Units SET Combat = '37' WHERE Type = 'UNIT_ROCKET_ARTILLERY';
