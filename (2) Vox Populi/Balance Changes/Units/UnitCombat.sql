...
-- Ranged
UPDATE Units SET Combat = '6' WHERE Type = 'UNIT_VP_SLINGER';
UPDATE Units SET Combat = '7' WHERE Type = 'UNIT_INCAN_SLINGER';

UPDATE Units SET Combat = '7' WHERE Type = 'UNIT_ARCHER';
UPDATE Units SET Combat = '6' WHERE Type = 'UNIT_BARBARIAN_ARCHER';
UPDATE Units SET Combat = '9' WHERE Type = 'UNIT_BABYLONIAN_BOWMAN';
...
-- Renaissance --
-- Melee 
UPDATE Units SET Combat = '24' WHERE Type = 'UNIT_SPANISH_TERCIO';
UPDATE Units SET Combat = '26' WHERE Type = 'UNIT_GERMAN_LANDSKNECHT';
UPDATE Units SET Combat = '27' WHERE Type = 'UNIT_ZULU_IMPI';
UPDATE Units SET Combat = '29' WHERE Type = 'UNIT_FRENCH_MUSKETEER';
