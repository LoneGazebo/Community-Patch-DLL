...
VALUES		('BUILDINGCLASS_AMERICA_SMITHSONIAN',		'TXT_KEY_BUILDING_MOMA', 				'BUILDING_AMERICA_SMITHSONIAN',			1),
			...
			('BUILDINGCLASS_AMERICA_SLATERMILL',		'TXT_KEY_BUILDING_AMERICA_SLATERMILL',	'BUILDING_AMERICA_SLATERMILL',			1);
...
INSERT INTO Buildings
			(Type,								CivilizationRequired, 	BuildingClass,							Description,							Help, 											Civilopedia, 												Strategy, 											Quote, 							WonderSplashImage, 			DisplayPosition, 	ArtDefineTag, 					GlobalPlotBuyCostModifier, 	GoldMaintenance,	Cost,	FaithCost,	MutuallyExclusiveGroup, NukeImmune, ConquestProb,	HurryCostModifier,	MinAreaSize,	IconAtlas,				PortraitIndex)
VALUES		('BUILDING_AMERICA_SMITHSONIAN',	'CIVILIZATION_AMERICA', 'BUILDINGCLASS_AMERICA_SMITHSONIAN',	'TXT_KEY_BUILDING_MOMA',				'TXT_KEY_BUILDING_AMERICA_SMITHSONIAN_HELP',	'TXT_KEY_CIV5_BUILDINGS_MOMA_TEXT', 						'TXT_KEY_BUILDING_AMERICA_SMITHSONIAN_STRATEGY',	'TXT_KEY_WONDER_AMERICA_QUOTE', 'Murica_WonderSplash.dds', 	1, 					'ART_DEF_BUILDING_UNIVERSITY',	-25, 						0,					1000,	0,			15, 					1,			100,			-5,					-1,				'COMMUNITY_2_ATLAS',	10),
			('BUILDING_AMERICA_WESTPOINT',		'CIVILIZATION_AMERICA', 'BUILDINGCLASS_AMERICA_WESTPOINT',		'TXT_KEY_BUILDING_AMERICA_WESTPOINT',	'TXT_KEY_BUILDING_AMERICA_WESTPOINT_HELP',		'TXT_KEY_CIVILOPEDIA_BUILDINGS_AMERICA_WESTPOINT_TEXT', 	'TXT_KEY_BUILDING_AMERICA_WESTPOINT_STRATEGY',		'TXT_KEY_WONDER_AMERICA_QUOTE', 'Murica_WonderSplash.dds', 	1, 					'ART_DEF_BUILDING_UNIVERSITY',	-25, 						0,					1000,	0,			15, 					1,			100,			-5,					-1,				'COMMUNITY_2_ATLAS',	20),
			('BUILDING_AMERICA_SLATERMILL',		'CIVILIZATION_AMERICA', 'BUILDINGCLASS_AMERICA_SLATERMILL',		'TXT_KEY_BUILDING_AMERICA_SLATERMILL',	'TXT_KEY_BUILDING_AMERICA_SLATERMILL_HELP',		'TXT_KEY_CIVILOPEDIA_BUILDINGS_AMERICA_SLATERMILL_TEXT', 	'TXT_KEY_BUILDING_AMERICA_SLATERMILL_STRATEGY',		'TXT_KEY_WONDER_AMERICA_QUOTE', 'Murica_WonderSplash.dds', 	1, 					'ART_DEF_BUILDING_UNIVERSITY',	-25, 						0,					1000,	0,			15, 					1,			100,			-5,					-1,				'COMMUNITY_ATLAS',		14);
...
UPDATE Buildings SET
	...
	FreeBuildingThisCity 			= 'BUILDINGCLASS_MILITARY_ACADEMY',
...
WHERE Type = 'BUILDING_AMERICA_SLATERMILL';
...
INSERT INTO Building_ClassNeededNowhere
			(BuildingType, 						BuildingClassType)
VALUES		('BUILDING_AMERICA_SLATERMILL',		'BUILDINGCLASS_AMERICA_SMITHSONIAN'),
