...
VALUES
	('PROMOTION_MARSH_WALKER', 'TXT_KEY_PROMOTION_MARSH_WALKER', 'TXT_KEY_PROMOTION_MARSH_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 44, 1, 'PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_MARSH_WALKER', 0),
	('PROMOTION_WHITE_WALKER', 'TXT_KEY_PROMOTION_WHITE_WALKER', 'TXT_KEY_PROMOTION_WHITE_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 44, 1, 'PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_WHITE_WALKER', 0),
	('PROMOTION_WOODS_WALKER', 'TXT_KEY_PROMOTION_WOODS_WALKER', 'TXT_KEY_PROMOTION_WOODS_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 56, 1, 'PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_WOODS_WALKER', 0),
	('PROMOTION_DESERT_WALKER', 'TXT_KEY_PROMOTION_DESERT_WALKER', 'TXT_KEY_PROMOTION_DESERT_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 1, 1, 'EXPANSION2_PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_DESERT_WALKER', 0),
	('PROMOTION_COAST_WALKER', 'TXT_KEY_PROMOTION_COAST_WALKER', 'TXT_KEY_PROMOTION_COAST_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 22, 1, 'PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_COAST_WALKER', 1),
	('PROMOTION_HILL_WALKER', 'TXT_KEY_PROMOTION_HILL_WALKER', 'TXT_KEY_PROMOTION_HILL_WALKER_HELP', 'AS2D_IF_LEVELUP', 99, 0, 1, 'EXPANSION2_PROMOTION_ATLAS', 'PEDIA_BARBARIAN', 1, 'TXT_KEY_PROMOTION_HILL_WALKER', 0);
