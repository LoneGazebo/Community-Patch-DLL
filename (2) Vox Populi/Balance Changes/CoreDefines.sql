...
-- Spy Mission Durations
UPDATE GameSpeeds SET SpyRatePercent = '300' WHERE Type = 'GAMESPEED_MARATHON';
UPDATE GameSpeeds SET SpyRatePercent = '150' WHERE Type = 'GAMESPEED_EPIC';
UPDATE GameSpeeds SET SpyRatePercent = '100' WHERE Type = 'GAMESPEED_STANDARD';
UPDATE GameSpeeds SET SpyRatePercent = '67' WHERE Type = 'GAMESPEED_QUICK';
