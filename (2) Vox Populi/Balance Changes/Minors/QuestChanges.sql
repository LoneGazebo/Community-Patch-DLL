...
-- Route
UPDATE SmallAwards SET Influence = '40', Production = '70', RandomMod = '10'  WHERE Type = 'MINOR_CIV_QUEST_ROUTE';

-- Camp
UPDATE SmallAwards SET Influence = '25', GeneralPoints = '30', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_KILL_CAMP';

-- Resource
UPDATE SmallAwards SET Influence = '25', Gold = '90', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_CONNECT_RESOURCE';

-- Wonder
UPDATE SmallAwards SET Influence = '30', Faith = '65', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_CONSTRUCT_WONDER';

-- GP
UPDATE SmallAwards SET Influence = '25', Culture = '65', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_GREAT_PERSON';
...
-- Religion
UPDATE SmallAwards SET Influence = '30', Faith = '70', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_SPREAD_RELIGION';

-- Trade Route
UPDATE SmallAwards SET Influence = '30', Food = '50', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_TRADE_ROUTE';

-- War
UPDATE SmallAwards SET Influence = '75', Happiness = '1', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_WAR';

-- Build NW
UPDATE SmallAwards SET Influence = '30', GoldenAgePoints = '125', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_CONSTRUCT_NATIONAL_WONDER';

-- Send Unit
UPDATE SmallAwards SET Influence = '25', Gold = '60', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_GIFT_SPECIFIC_UNIT';

-- Find a CS
UPDATE SmallAwards SET Influence = '15', Production = '60', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_FIND_CITY_STATE';
...
-- Liberation
UPDATE SmallAwards SET Influence = '40', Happiness = '1', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_LIBERATION';

-- Discover Plot
UPDATE SmallAwards SET Influence = '30', Gold = '100', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_DISCOVER_PLOT';

-- Production
UPDATE SmallAwards SET Influence = '40', Production = '75', RandomMod = '10' WHERE Type = 'MINOR_CIV_QUEST_BUILD_X_BUILDINGS';
