...
function GetMapScriptInfo()
	...
	return {
		Name = "TXT_KEY_MAP_NORTH_VS_SOUTH",
...
function AssignStartingPlots:GenerateRegions(args)
	...
	if iNumTeams == 2 and team_setting == 1 then
		...
		teamNorthID = shuffled_team_list[1];						-- GLOBAL
		teamSouthID = shuffled_team_list[2]; 						-- GLOBAL
		iNumCivsInNorth = self.number_civs_per_team[teamNorthID];	-- GLOBAL
		iNumCivsInSouth = self.number_civs_per_team[teamSouthID];	-- GLOBAL
