...
function GetInactiveResolutions(league, activePlayerId)
	...
	for _, t in ipairs(league:GetInactiveResolutions()) do
		...
		-- Sort resolutions by their description. (COMMUNITY PATCH)
		table.sort(resolutionChoices, function(a,b) return Locale.Compare(a.Text, b.Text) < 0; end);
	...
	-- Sort resolutions by their description. (COMMUNITY PATCH)
		table.sort(resolutions, function(a,b) return Locale.Compare(a.Text, b.Text) < 0; end);
