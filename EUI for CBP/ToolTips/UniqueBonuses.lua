...
--]]
-------------------------------------------------
include( "EUI_tooltips" ); local IconLookup = EUI.IconLookup; local GetHelpTextForUnit = GetHelpTextForUnit; local GetHelpTextForBuilding = GetHelpTextForBuilding; local GetHelpTextForImprovement = GetHelpTextForImprovement
