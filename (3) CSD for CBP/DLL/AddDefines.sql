...
INSERT INTO Defines (
Name, Value)
SELECT 'WARMONGER_THREAT_PER_TURN_DECAY_INCREASED', '100';

INSERT INTO Defines (
Name, Value)
SELECT 'WARMONGER_THREAT_PER_TURN_DECAY_DECREASED', '-100';
...
INSERT INTO Defines (
Name, Value)
SELECT 'WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_PEACE', '50';
...
INSERT INTO Defines (
Name, Value)
SELECT 'SCHOLAR_MINOR_ALLY_MULTIPLIER', '2';
